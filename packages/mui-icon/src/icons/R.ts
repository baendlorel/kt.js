...
export const RMobiledataIcon = (props?: KTRawAttr) => {
  const s = _RMobiledataIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RMobiledataIcon = svg(
  svg('path', { d: 'M7.8 7.2 9 10H7L5.87 7.33H4V10H2V2h5c1.13 0 2 .87 2 2v1.33c0 .8-.53 1.54-1.2 1.87M7 4H4v1.33h3z' }),
  'RMobiledata',
);
export const RMobiledataOutlinedIcon = (props?: KTRawAttr) => {
  const s = _RMobiledataOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RMobiledataOutlinedIcon = svg(
  svg('path', { d: 'M7.8 7.2 9 10H7L5.87 7.33H4V10H2V2h5c1.13 0 2 .87 2 2v1.33c0 .8-.53 1.54-1.2 1.87M7 4H4v1.33h3z' }),
  'RMobiledataOutlined',
);
export const RMobiledataRoundedIcon = (props?: KTRawAttr) => {
  const s = _RMobiledataRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RMobiledataRoundedIcon = svg(
  svg('path', {
...
export const RMobiledataSharpIcon = (props?: KTRawAttr) => {
  const s = _RMobiledataSharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RMobiledataSharpIcon = svg(
  svg('path', { d: 'M7.8 7.2 9 10H7L5.87 7.33H4V10H2V2h7v5.2zM7 4H4v1.33h3z' }),
  'RMobiledataSharp',
);
export const RMobiledataTwoToneIcon = (props?: KTRawAttr) => {
  const s = _RMobiledataTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RMobiledataTwoToneIcon = svg(
  svg('path', { d: 'M7.8 7.2 9 10H7L5.87 7.33H4V10H2V2h5c1.13 0 2 .87 2 2v1.33c0 .8-.53 1.54-1.2 1.87M7 4H4v1.33h3z' }),
  'RMobiledataTwoTone',
);
export const RadarIcon = (props?: KTRawAttr) => {
  const s = _RadarIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RadarIcon = svg(
  svg('path', {
...
export const RadarOutlinedIcon = (props?: KTRawAttr) => {
  const s = _RadarOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RadarOutlinedIcon = svg(
  svg('path', {
    d: 'M19.74 18.33C21.15 16.6 22 14.4 22 12c0-5.52-4.48-10-10-10S2 6.48 2 12s4.48 10 10 10c2.4 0 4.6-.85 6.33-2.26.27-.22.53-.46.78-.71.03-.03.05-.06.07-.08.2-.2.39-.41.56-.62M12 20c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8c0 1.85-.63 3.54-1.69 4.9l-1.43-1.43c.69-.98 1.1-2.17 1.1-3.46 0-3.31-2.69-6-6-6s-6 2.69-6 6 2.69 6 6 6c1.3 0 2.51-.42 3.49-1.13l1.42 1.42C15.54 19.37 13.85 20 12 20m1.92-7.49c.17-.66.02-1.38-.49-1.9l-.02-.02c-.77-.77-2-.78-2.78-.04-.01.01-.03.02-.05.04-.78.78-.78 2.05 0 2.83l.02.02c.52.51 1.25.67 1.91.49l1.51 1.51c-.6.36-1.29.58-2.04.58-2.21 0-4-1.79-4-4s1.79-4 4-4 4 1.79 4 4c0 .73-.21 1.41-.56 2z',
  }),
  'RadarOutlined',
);
export const RadarRoundedIcon = (props?: KTRawAttr) => {
  const s = _RadarRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RadarRoundedIcon = svg(
  svg('path', {
    d: 'M19.74 18.33C21.15 16.6 22 14.4 22 12c0-5.52-4.48-10-10-10S2 6.48 2 12s4.48 10 10 10c2.4 0 4.6-.85 6.33-2.26.27-.22.53-.46.78-.71.03-.03.05-.06.07-.08.2-.2.39-.41.56-.62M12 20c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8c0 1.85-.63 3.54-1.69 4.9l-1.43-1.43c.69-.98 1.1-2.17 1.1-3.46 0-3.31-2.69-6-6-6s-6 2.69-6 6 2.69 6 6 6c1.3 0 2.51-.42 3.49-1.13l1.42 1.42C15.54 19.37 13.85 20 12 20m1.92-7.49c.17-.66.02-1.38-.49-1.9l-.02-.02c-.77-.77-2-.78-2.78-.04-.01.01-.03.02-.05.04-.78.78-.78 2.05 0 2.83l.02.02c.52.51 1.25.67 1.91.49l1.51 1.51c-.6.36-1.29.58-2.04.58-2.21 0-4-1.79-4-4s1.79-4 4-4 4 1.79 4 4c0 .73-.21 1.41-.56 2z',
  }),
  'RadarRounded',
);
export const RadarSharpIcon = (props?: KTRawAttr) => {
  const s = _RadarSharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RadarSharpIcon = svg(
  svg('path', {
    d: 'M19.74 18.33C21.15 16.6 22 14.4 22 12c0-5.52-4.48-10-10-10S2 6.48 2 12s4.48 10 10 10c2.4 0 4.6-.85 6.33-2.26.27-.22.53-.46.78-.71.03-.03.05-.06.07-.08.2-.2.39-.41.56-.62M12 20c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8c0 1.85-.63 3.54-1.69 4.9l-1.43-1.43c.69-.98 1.1-2.17 1.1-3.46 0-3.31-2.69-6-6-6s-6 2.69-6 6 2.69 6 6 6c1.3 0 2.51-.42 3.49-1.13l1.42 1.42C15.54 19.37 13.85 20 12 20m1.92-7.49c.17-.66.02-1.38-.49-1.9l-.02-.02c-.77-.77-2-.78-2.78-.04-.01.01-.03.02-.05.04-.78.78-.78 2.05 0 2.83l.02.02c.52.51 1.25.67 1.91.49l1.51 1.51c-.6.36-1.29.58-2.04.58-2.21 0-4-1.79-4-4s1.79-4 4-4 4 1.79 4 4c0 .73-.21 1.41-.56 2z',
  }),
  'RadarSharp',
);
export const RadarTwoToneIcon = (props?: KTRawAttr) => {
  const s = _RadarTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RadarTwoToneIcon = svg(
  svg('path', {
    d: 'M19.74 18.33C21.15 16.6 22 14.4 22 12c0-5.52-4.48-10-10-10S2 6.48 2 12s4.48 10 10 10c2.4 0 4.6-.85 6.33-2.26.27-.22.53-.46.78-.71.03-.03.05-.06.07-.08.2-.2.39-.41.56-.62M12 20c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8c0 1.85-.63 3.54-1.69 4.9l-1.43-1.43c.69-.98 1.1-2.17 1.1-3.46 0-3.31-2.69-6-6-6s-6 2.69-6 6 2.69 6 6 6c1.3 0 2.51-.42 3.49-1.13l1.42 1.42C15.54 19.37 13.85 20 12 20m1.92-7.49c.17-.66.02-1.38-.49-1.9l-.02-.02c-.77-.77-2-.78-2.78-.04-.01.01-.03.02-.05.04-.78.78-.78 2.05 0 2.83l.02.02c.52.51 1.25.67 1.91.49l1.51 1.51c-.6.36-1.29.58-2.04.58-2.21 0-4-1.79-4-4s1.79-4 4-4 4 1.79 4 4c0 .73-.21 1.41-.56 2z',
  }),
  'RadarTwoTone',
);
export const RadioIcon = (props?: KTRawAttr) => {
  const s = _RadioIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RadioIcon = svg(
  svg('path', {
...
export const RadioButtonCheckedIcon = (props?: KTRawAttr) => {
  const s = _RadioButtonCheckedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RadioButtonCheckedIcon = svg(
  svg('path', {
...
export const RadioButtonCheckedOutlinedIcon = (props?: KTRawAttr) => {
  const s = _RadioButtonCheckedOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RadioButtonCheckedOutlinedIcon = svg(
  [
    svg(
      'path',
      {
    ...
    svg('circle', { cx: '12', cy: '12', r: '5' }, '1'),
  ],
  'RadioButtonCheckedOutlined',
);
export const RadioButtonCheckedRoundedIcon = (props?: KTRawAttr) => {
  const s = _RadioButtonCheckedRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RadioButtonCheckedRoundedIcon = svg(
  [
    svg(
      'path',
      {
...
export const RadioButtonCheckedSharpIcon = (props?: KTRawAttr) => {
  const s = _RadioButtonCheckedSharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RadioButtonCheckedSharpIcon = svg(
  [
    svg(
      'path',
      {
...
export const RadioButtonCheckedTwoToneIcon = (props?: KTRawAttr) => {
  const s = _RadioButtonCheckedTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RadioButtonCheckedTwoToneIcon = svg(
  [
    svg(
      'path',
      {
...
export const RadioButtonUncheckedIcon = (props?: KTRawAttr) => {
  const s = _RadioButtonUncheckedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RadioButtonUncheckedIcon = svg(
  svg('path', {
    d: 'M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2m0 18c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8',
  }),
  'RadioButtonUnchecked',
);
export const RadioButtonUncheckedOutlinedIcon = (props?: KTRawAttr) => {
  const s = _RadioButtonUncheckedOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RadioButtonUncheckedOutlinedIcon = svg(
  svg('path', {
    d: 'M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2m0 18c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8',
  }),
  'RadioButtonUncheckedOutlined',
);
export const RadioButtonUncheckedRoundedIcon = (props?: KTRawAttr) => {
  const s = _RadioButtonUncheckedRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RadioButtonUncheckedRoundedIcon = svg(
  svg('path', {
    d: 'M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2m0 18c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8',
  }),
  'RadioButtonUncheckedRounded',
);
export const RadioButtonUncheckedSharpIcon = (props?: KTRawAttr) => {
  const s = _RadioButtonUncheckedSharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RadioButtonUncheckedSharpIcon = svg(
  svg('path', {
    d: 'M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2m0 18c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8',
  }),
  'RadioButtonUncheckedSharp',
);
export const RadioButtonUncheckedTwoToneIcon = (props?: KTRawAttr) => {
  const s = _RadioButtonUncheckedTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RadioButtonUncheckedTwoToneIcon = svg(
  svg('path', {
    d: 'M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2m0 18c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8',
  }),
  'RadioButtonUncheckedTwoTone',
);
export const RadioOutlinedIcon = (props?: KTRawAttr) => {
  const s = _RadioOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RadioOutlinedIcon = svg(
  [
    svg(
      'path',
      {
    ...
    svg('circle', { cx: '8', cy: '16.48', r: '2.5' }, '1'),
  ],
  'RadioOutlined',
);
export const RadioRoundedIcon = (props?: KTRawAttr) => {
  const s = _RadioRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RadioRoundedIcon = svg(
  svg('path', {
...
export const RadioSharpIcon = (props?: KTRawAttr) => {
  const s = _RadioSharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RadioSharpIcon = svg(
  svg('path', {
...
export const RadioTwoToneIcon = (props?: KTRawAttr) => {
  const s = _RadioTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RadioTwoToneIcon = svg(
  [
    svg(
      'path',
      {
    ...
    svg('circle', { cx: '8', cy: '16.48', r: '2.5' }, '2'),
  ],
  'RadioTwoTone',
);
export const RailwayAlertIcon = (props?: KTRawAttr) => {
  const s = _RailwayAlertIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RailwayAlertIcon = svg(
  svg('path', {
...
export const RailwayAlertOutlinedIcon = (props?: KTRawAttr) => {
  const s = _RailwayAlertOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RailwayAlertOutlinedIcon = svg(
  [
    svg('circle', { cx: '10', cy: '15.5', r: '1.5' }, '0'),
    svg(
      'path',
      {
    ...
    svg('path', { d: 'M18 1c-2.76 0-5 2.24-5 5s2.24 5 5 5 5-2.24 5-5-2.24-5-5-5m.5 8h-1V8h1zm0-2h-1V3h1z' }, '2'),
  ],
  'RailwayAlertOutlined',
);
export const RailwayAlertRoundedIcon = (props?: KTRawAttr) => {
  const s = _RailwayAlertRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RailwayAlertRoundedIcon = svg(
  [
    svg(
      'path',
      {
...
export const RailwayAlertSharpIcon = (props?: KTRawAttr) => {
  const s = _RailwayAlertSharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RailwayAlertSharpIcon = svg(
  [
    svg(
      'path',
      {
...
export const RailwayAlertTwoToneIcon = (props?: KTRawAttr) => {
  const s = _RailwayAlertTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RailwayAlertTwoToneIcon = svg(
  [
    svg(
      'path',
      {
    ...
    svg('circle', { cx: '10', cy: '15.5', r: '1.5' }, '2'),
    svg('path', { d: 'M18 1c-2.76 0-5 2.24-5 5s2.24 5 5 5 5-2.24 5-5-2.24-5-5-5m.5 8h-1V8h1zm0-2h-1V3h1z' }, '3'),
  ],
  'RailwayAlertTwoTone',
);
export const RamenDiningIcon = (props?: KTRawAttr) => {
  const s = _RamenDiningIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RamenDiningIcon = svg(
  svg('path', {
...
export const RamenDiningOutlinedIcon = (props?: KTRawAttr) => {
  const s = _RamenDiningOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RamenDiningOutlinedIcon = svg(
  svg('path', {
...
export const RamenDiningRoundedIcon = (props?: KTRawAttr) => {
  const s = _RamenDiningRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RamenDiningRoundedIcon = svg(
  svg('path', {
...
export const RamenDiningSharpIcon = (props?: KTRawAttr) => {
  const s = _RamenDiningSharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RamenDiningSharpIcon = svg(
  svg('path', {
...
export const RamenDiningTwoToneIcon = (props?: KTRawAttr) => {
  const s = _RamenDiningTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RamenDiningTwoToneIcon = svg(
  [
    svg(
      'path',
      {
...
export const RampLeftIcon = (props?: KTRawAttr) => {
  const s = _RampLeftIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RampLeftIcon = svg(
  svg('path', {
...
export const RampLeftOutlinedIcon = (props?: KTRawAttr) => {
  const s = _RampLeftOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RampLeftOutlinedIcon = svg(
  svg('path', {
    d: 'M13 21h-2V6.83L9.41 8.41 8 7l4-4 4 4-1.41 1.41L13 6.83V9c0 4.27 4.03 7.13 6 8.27l-1.46 1.46c-1.91-1.16-3.44-2.53-4.54-4.02z',
  }),
  'RampLeftOutlined',
);
export const RampLeftRoundedIcon = (props?: KTRawAttr) => {
  const s = _RampLeftRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RampLeftRoundedIcon = svg(
  svg('path', {
...
export const RampLeftSharpIcon = (props?: KTRawAttr) => {
  const s = _RampLeftSharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RampLeftSharpIcon = svg(
  svg('path', {
    d: 'M13 21h-2V6.83L9.41 8.41 8 7l4-4 4 4-1.41 1.41L13 6.83V9c0 4.27 4.03 7.13 6 8.27l-1.46 1.46c-1.91-1.16-3.44-2.53-4.54-4.02z',
  }),
  'RampLeftSharp',
);
export const RampLeftTwoToneIcon = (props?: KTRawAttr) => {
  const s = _RampLeftTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RampLeftTwoToneIcon = svg(
  svg('path', {
    d: 'M13 21h-2V6.83L9.41 8.41 8 7l4-4 4 4-1.41 1.41L13 6.83V9c0 4.27 4.03 7.13 6 8.27l-1.46 1.46c-1.91-1.16-3.44-2.53-4.54-4.02z',
  }),
  'RampLeftTwoTone',
);
export const RampRightIcon = (props?: KTRawAttr) => {
  const s = _RampRightIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RampRightIcon = svg(
  svg('path', {
...
export const RampRightOutlinedIcon = (props?: KTRawAttr) => {
  const s = _RampRightOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RampRightOutlinedIcon = svg(
  svg('path', {
    d: 'M11 21h2V6.83l1.59 1.59L16 7l-4-4-4 4 1.41 1.41L11 6.83V9c0 4.27-4.03 7.13-6 8.27l1.46 1.46C8.37 17.56 9.9 16.19 11 14.7z',
  }),
  'RampRightOutlined',
);
export const RampRightRoundedIcon = (props?: KTRawAttr) => {
  const s = _RampRightRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RampRightRoundedIcon = svg(
  svg('path', {
...
export const RampRightSharpIcon = (props?: KTRawAttr) => {
  const s = _RampRightSharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RampRightSharpIcon = svg(
  svg('path', {
    d: 'M11 21h2V6.83l1.59 1.59L16 7l-4-4-4 4 1.41 1.41L11 6.83V9c0 4.27-4.03 7.13-6 8.27l1.46 1.46C8.37 17.56 9.9 16.19 11 14.7z',
  }),
  'RampRightSharp',
);
export const RampRightTwoToneIcon = (props?: KTRawAttr) => {
  const s = _RampRightTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RampRightTwoToneIcon = svg(
  svg('path', {
    d: 'M11 21h2V6.83l1.59 1.59L16 7l-4-4-4 4 1.41 1.41L11 6.83V9c0 4.27-4.03 7.13-6 8.27l1.46 1.46C8.37 17.56 9.9 16.19 11 14.7z',
  }),
  'RampRightTwoTone',
);
export const RateReviewIcon = (props?: KTRawAttr) => {
  const s = _RateReviewIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RateReviewIcon = svg(
  svg('path', {
...
export const RateReviewOutlinedIcon = (props?: KTRawAttr) => {
  const s = _RateReviewOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RateReviewOutlinedIcon = svg(
  svg('path', {
...
export const RateReviewRoundedIcon = (props?: KTRawAttr) => {
  const s = _RateReviewRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RateReviewRoundedIcon = svg(
  svg('path', {
...
export const RateReviewSharpIcon = (props?: KTRawAttr) => {
  const s = _RateReviewSharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RateReviewSharpIcon = svg(
  svg('path', {
    d: 'M22 2H2v20l4-4h16zM6 14v-2.47l6.88-6.88c.2-.2.51-.2.71 0l1.77 1.77c.2.2.2.51 0 .71L8.47 14zm12 0h-7.5l2-2H18z',
  }),
  'RateReviewSharp',
);
export const RateReviewTwoToneIcon = (props?: KTRawAttr) => {
  const s = _RateReviewTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RateReviewTwoToneIcon = svg(
  [
    svg(
      'path',
      {
...
export const RawOffIcon = (props?: KTRawAttr) => {
  const s = _RawOffIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RawOffIcon = svg(
  svg('path', {
...
export const RawOffOutlinedIcon = (props?: KTRawAttr) => {
  const s = _RawOffOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RawOffOutlinedIcon = svg(
  svg('path', {
    d: 'm17.15 14.32.59-2.36.76 3.04h1.48l1.5-6h-1.5l-.74 3-.74-3h-1.52l-.74 3-.74-3H14l.72 2.9zM1.39 4.22 6.17 9H3v6h1.5v-2h1.1l.9 2H8l-.9-2.1c.5-.3.9-.8.9-1.4v-.67l1.43 1.43L8.75 15h1.5l.38-1.5h.04l9.11 9.11 1.41-1.41L2.81 2.81zM6.5 11.5h-2v-1h2z',
  }),
  'RawOffOutlined',
);
export const RawOffRoundedIcon = (props?: KTRawAttr) => {
  const s = _RawOffRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RawOffRoundedIcon = svg(
  svg('path', {
...
export const RawOffSharpIcon = (props?: KTRawAttr) => {
  const s = _RawOffSharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RawOffSharpIcon = svg(
  svg('path', {
    d: 'm17.15 14.32.59-2.36.76 3.04h1.48l1.5-6h-1.5l-.74 3-.74-3h-1.52l-.74 3-.74-3H14l.72 2.9zM1.39 4.22 6.17 9H3v6h1.5v-2h1.1l.9 2H8l-.9-2.1c.5-.3.9-.8.9-1.4v-.67l1.43 1.43L8.75 15h1.5l.38-1.5h.04l9.11 9.11 1.41-1.41L2.81 2.81zM6.5 11.5h-2v-1h2z',
  }),
  'RawOffSharp',
);
export const RawOffTwoToneIcon = (props?: KTRawAttr) => {
  const s = _RawOffTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RawOffTwoToneIcon = svg(
  svg('path', {
    d: 'm17.15 14.32.59-2.36.76 3.04h1.48l1.5-6h-1.5l-.74 3-.74-3h-1.52l-.74 3-.74-3H14l.72 2.9zM1.39 4.22 6.17 9H3v6h1.5v-2h1.1l.9 2H8l-.9-2.1c.5-.3.9-.8.9-1.4v-.67l1.43 1.43L8.75 15h1.5l.38-1.5h.04l9.11 9.11 1.41-1.41L2.81 2.81zM6.5 11.5h-2v-1h2z',
  }),
  'RawOffTwoTone',
);
export const RawOnIcon = (props?: KTRawAttr) => {
  const s = _RawOnIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RawOnIcon = svg(
  svg('path', {
...
export const RawOnOutlinedIcon = (props?: KTRawAttr) => {
  const s = _RawOnOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RawOnOutlinedIcon = svg(
  svg('path', {
    d: 'M6.5 9H3v6h1.5v-2h1.1l.9 2H8l-.9-2.1c.5-.3.9-.8.9-1.4v-1C8 9.7 7.3 9 6.5 9m0 2.5h-2v-1h2zM10.25 9l-1.5 6h1.5l.38-1.5h1.75l.37 1.5h1.5l-1.5-6zm.75 3 .25-1h.5l.25 1zm8.98-3-.74 3-.74-3h-1.52l-.74 3-.74-3H14l1.5 6h1.48l.76-3.04.76 3.04h1.48l1.5-6z',
  }),
  'RawOnOutlined',
);
export const RawOnRoundedIcon = (props?: KTRawAttr) => {
  const s = _RawOnRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RawOnRoundedIcon = svg(
  svg('path', {
...
export const RawOnSharpIcon = (props?: KTRawAttr) => {
  const s = _RawOnSharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RawOnSharpIcon = svg(
  svg('path', {
    d: 'M6.5 9H3v6h1.5v-2h1.1l.9 2H8l-.9-2.1c.5-.3.9-.8.9-1.4v-1C8 9.7 7.3 9 6.5 9m0 2.5h-2v-1h2zM10.25 9l-1.5 6h1.5l.38-1.5h1.75l.37 1.5h1.5l-1.5-6zm.75 3 .25-1h.5l.25 1zm8.98-3-.74 3-.74-3h-1.52l-.74 3-.74-3H14l1.5 6h1.48l.76-3.04.76 3.04h1.48l1.5-6z',
  }),
  'RawOnSharp',
);
export const RawOnTwoToneIcon = (props?: KTRawAttr) => {
  const s = _RawOnTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RawOnTwoToneIcon = svg(
  svg('path', {
    d: 'M6.5 9H3v6h1.5v-2h1.1l.9 2H8l-.9-2.1c.5-.3.9-.8.9-1.4v-1C8 9.7 7.3 9 6.5 9m0 2.5h-2v-1h2zM10.25 9l-1.5 6h1.5l.38-1.5h1.75l.37 1.5h1.5l-1.5-6zm.75 3 .25-1h.5l.25 1zm8.98-3-.74 3-.74-3h-1.52l-.74 3-.74-3H14l1.5 6h1.48l.76-3.04.76 3.04h1.48l1.5-6z',
  }),
  'RawOnTwoTone',
);
export const ReadMoreIcon = (props?: KTRawAttr) => {
  const s = _ReadMoreIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _ReadMoreIcon = svg(
  svg('path', { d: 'M13 7h9v2h-9zm0 8h9v2h-9zm3-4h6v2h-6zm-3 1L8 7v4H2v2h6v4z' }),
  'ReadMore',
);
export const ReadMoreOutlinedIcon = (props?: KTRawAttr) => {
  const s = _ReadMoreOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _ReadMoreOutlinedIcon = svg(
  svg('path', { d: 'M13 7h9v2h-9zm0 8h9v2h-9zm3-4h6v2h-6zm-3 1L8 7v4H2v2h6v4z' }),
  'ReadMoreOutlined',
);
export const ReadMoreRoundedIcon = (props?: KTRawAttr) => {
  const s = _ReadMoreRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _ReadMoreRoundedIcon = svg(
  svg('path', {
...
export const ReadMoreSharpIcon = (props?: KTRawAttr) => {
  const s = _ReadMoreSharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _ReadMoreSharpIcon = svg(
  svg('path', { d: 'M13 7h9v2h-9zm0 8h9v2h-9zm3-4h6v2h-6zm-3 1L8 7v4H2v2h6v4z' }),
  'ReadMoreSharp',
);
export const ReadMoreTwoToneIcon = (props?: KTRawAttr) => {
  const s = _ReadMoreTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _ReadMoreTwoToneIcon = svg(
  svg('path', { d: 'M13 7h9v2h-9zm0 8h9v2h-9zm3-4h6v2h-6zm-3 1L8 7v4H2v2h6v4z' }),
  'ReadMoreTwoTone',
);
export const RealEstateAgentIcon = (props?: KTRawAttr) => {
  const s = _RealEstateAgentIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RealEstateAgentIcon = svg(
  svg('path', {
...
export const RealEstateAgentOutlinedIcon = (props?: KTRawAttr) => {
  const s = _RealEstateAgentOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RealEstateAgentOutlinedIcon = svg(
  svg('path', {
...
export const RealEstateAgentRoundedIcon = (props?: KTRawAttr) => {
  const s = _RealEstateAgentRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RealEstateAgentRoundedIcon = svg(
  svg('path', {
...
export const RealEstateAgentSharpIcon = (props?: KTRawAttr) => {
  const s = _RealEstateAgentSharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RealEstateAgentSharpIcon = svg(
  svg('path', {
...
export const RealEstateAgentTwoToneIcon = (props?: KTRawAttr) => {
  const s = _RealEstateAgentTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RealEstateAgentTwoToneIcon = svg(
  [
    svg(
      'path',
      {
...
export const RebaseEditIcon = (props?: KTRawAttr) => {
  const s = _RebaseEditIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RebaseEditIcon = svg(
  [
    svg('circle', { cx: '19', cy: '5', r: '3' }, '0'),
    svg(
      'path',
      {
...
export const ReceiptIcon = (props?: KTRawAttr) => {
  const s = _ReceiptIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _ReceiptIcon = svg(
  svg('path', {
...
export const ReceiptLongIcon = (props?: KTRawAttr) => {
  const s = _ReceiptLongIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _ReceiptLongIcon = svg(
  [
    svg(
      'path',
      {
    ...
    svg('path', { d: 'M9 7h6v2H9zm7 0h2v2h-2zm-7 3h6v2H9zm7 0h2v2h-2z' }, '1'),
  ],
  'ReceiptLong',
);
export const ReceiptLongOutlinedIcon = (props?: KTRawAttr) => {
  const s = _ReceiptLongOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _ReceiptLongOutlinedIcon = svg(
  [
    svg(
      'path',
      {
...
export const ReceiptLongRoundedIcon = (props?: KTRawAttr) => {
  const s = _ReceiptLongRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _ReceiptLongRoundedIcon = svg(
  [
    svg(
      'path',
      {
    ...
    svg('circle', { cx: '17', cy: '8', r: '1' }, '2'),
    svg('circle', { cx: '17', cy: '11', r: '1' }, '3'),
  ],
  'ReceiptLongRounded',
);
export const ReceiptLongSharpIcon = (props?: KTRawAttr) => {
  const s = _ReceiptLongSharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _ReceiptLongSharpIcon = svg(
  [
    svg(
      'path',
      {
    ...
    svg('path', { d: 'M9 7h6v2H9zm0 3h6v2H9zm7-3h2v2h-2zm0 3h2v2h-2z' }, '1'),
  ],
  'ReceiptLongSharp',
);
export const ReceiptLongTwoToneIcon = (props?: KTRawAttr) => {
  const s = _ReceiptLongTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _ReceiptLongTwoToneIcon = svg(
  [
    svg('path', { d: 'M19 19c0 .55-.45 1-1 1s-1-.45-1-1v-3H8V5h11z', opacity: '.3' }, '0'),
    svg(
      'path',
      {
        d: 'M19.5 3.5 18 2l-1.5 1.5L15 2l-1.5 1.5L12 2l-1.5 1.5L9 2 7.5 3.5 6 2v14H3v3c0 1.66 1.34 3 3 3h12c1.66 0 3-1.34 3-3V2zM19 19c0 .55-.45 1-1 1s-1-.45-1-1v-3H8V5h11z',
    ...
    svg('path', { d: 'M9 7h6v2H9zm7 0h2v2h-2zm-7 3h6v2H9zm7 0h2v2h-2z' }, '2'),
  ],
  'ReceiptLongTwoTone',
);
export const ReceiptOutlinedIcon = (props?: KTRawAttr) => {
  const s = _ReceiptOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _ReceiptOutlinedIcon = svg(
  svg('path', {
...
export const ReceiptRoundedIcon = (props?: KTRawAttr) => {
  const s = _ReceiptRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _ReceiptRoundedIcon = svg(
  svg('path', {
...
export const ReceiptSharpIcon = (props?: KTRawAttr) => {
  const s = _ReceiptSharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _ReceiptSharpIcon = svg(
  svg('path', {
    d: 'M18 17H6v-2h12zm0-4H6v-2h12zm0-4H6V7h12zM3 22l1.5-1.5L6 22l1.5-1.5L9 22l1.5-1.5L12 22l1.5-1.5L15 22l1.5-1.5L18 22l1.5-1.5L21 22V2l-1.5 1.5L18 2l-1.5 1.5L15 2l-1.5 1.5L12 2l-1.5 1.5L9 2 7.5 3.5 6 2 4.5 3.5 3 2z',
  }),
  'ReceiptSharp',
);
export const ReceiptTwoToneIcon = (props?: KTRawAttr) => {
  const s = _ReceiptTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _ReceiptTwoToneIcon = svg(
  [
    svg('path', { d: 'M5 19.09h14V4.91H5zM6 7h12v2H6zm0 4h12v2H6zm0 4h12v2H6z', opacity: '.3' }, '0'),
    svg(
      'path',
      {
        d: 'M19.5 3.5 18 2l-1.5 1.5L15 2l-1.5 1.5L12 2l-1.5 1.5L9 2 7.5 3.5 6 2 4.5 3.5 3 2v20l1.5-1.5L6 22l1.5-1.5L9 22l1.5-1.5L12 22l1.5-1.5L15 22l1.5-1.5L18 22l1.5-1.5L21 22V2zM19 19.09H5V4.91h14zM6 15h12v2H6zm0-4h12v2H6zm0-4h12v2H6z',
...
export const RecentActorsIcon = (props?: KTRawAttr) => {
  const s = _RecentActorsIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RecentActorsIcon = svg(
  svg('path', {
...
export const RecentActorsOutlinedIcon = (props?: KTRawAttr) => {
  const s = _RecentActorsOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RecentActorsOutlinedIcon = svg(
  [
    svg(
      'path',
      {
    ...
    svg('circle', { cx: '8', cy: '9.94', r: '1.95' }, '1'),
    svg('path', { d: 'M11.89 15.35c0-1.3-2.59-1.95-3.89-1.95s-3.89.65-3.89 1.95V16h7.78z' }, '2'),
  ],
  'RecentActorsOutlined',
);
export const RecentActorsRoundedIcon = (props?: KTRawAttr) => {
  const s = _RecentActorsRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RecentActorsRoundedIcon = svg(
  svg('path', {
...
export const RecentActorsSharpIcon = (props?: KTRawAttr) => {
  const s = _RecentActorsSharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RecentActorsSharpIcon = svg(
  svg('path', {
...
export const RecentActorsTwoToneIcon = (props?: KTRawAttr) => {
  const s = _RecentActorsTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RecentActorsTwoToneIcon = svg(
  [
    svg(
      'path',
      {
    ...
    svg('circle', { cx: '8', cy: '9.94', r: '1.95' }, '2'),
    svg('path', { d: 'M8 13.4c-1.3 0-3.89.65-3.89 1.95V16h7.78v-.65c0-1.3-2.59-1.95-3.89-1.95' }, '3'),
  ],
  'RecentActorsTwoTone',
);
export const RecommendIcon = (props?: KTRawAttr) => {
  const s = _RecommendIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RecommendIcon = svg(
  svg('path', {
...
export const RecommendOutlinedIcon = (props?: KTRawAttr) => {
  const s = _RecommendOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RecommendOutlinedIcon = svg(
  [
    svg(
      'path',
      {
...
export const RecommendRoundedIcon = (props?: KTRawAttr) => {
  const s = _RecommendRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RecommendRoundedIcon = svg(
  svg('path', {
...
export const RecommendSharpIcon = (props?: KTRawAttr) => {
  const s = _RecommendSharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RecommendSharpIcon = svg(
  svg('path', {
    d: 'M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2m6 10.05L15.46 18H7v-7.56L12 5l1 1v.53L12.41 10H18z',
  }),
  'RecommendSharp',
);
export const RecommendTwoToneIcon = (props?: KTRawAttr) => {
  const s = _RecommendTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RecommendTwoToneIcon = svg(
  [
    svg(
      'path',
      {
...
export const RecordVoiceOverIcon = (props?: KTRawAttr) => {
  const s = _RecordVoiceOverIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RecordVoiceOverIcon = svg(
  [
    svg('circle', { cx: '9', cy: '9', r: '4' }, '0'),
    svg(
      'path',
      {
...
export const RecordVoiceOverOutlinedIcon = (props?: KTRawAttr) => {
  const s = _RecordVoiceOverOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RecordVoiceOverOutlinedIcon = svg(
  svg('path', {
...
export const RecordVoiceOverRoundedIcon = (props?: KTRawAttr) => {
  const s = _RecordVoiceOverRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RecordVoiceOverRoundedIcon = svg(
  [
    svg('circle', { cx: '9', cy: '9', r: '4' }, '0'),
    svg(
      'path',
...
export const RecordVoiceOverSharpIcon = (props?: KTRawAttr) => {
  const s = _RecordVoiceOverSharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RecordVoiceOverSharpIcon = svg(
  [
    svg('circle', { cx: '9', cy: '9', r: '4' }, '0'),
    svg(
      'path',
...
export const RecordVoiceOverTwoToneIcon = (props?: KTRawAttr) => {
  const s = _RecordVoiceOverTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RecordVoiceOverTwoToneIcon = svg(
  [
    svg(
      'g',
      {
        ...
        children: [
          ...
          svg('path', { d: 'M9 17c-2.69 0-5.77 1.28-6 2h12c-.2-.71-3.3-2-6-2' }),
        ],
      },
      '0',
    ),
...
export const RectangleIcon = (props?: KTRawAttr) => {
  const s = _RectangleIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RectangleIcon = svg(svg('path', { d: 'M2 4h20v16H2z' }), 'Rectangle');
export const RectangleOutlinedIcon = (props?: KTRawAttr) => {
  const s = _RectangleOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RectangleOutlinedIcon = svg(svg('path', { d: 'M2 4v16h20V4zm18 14H4V6h16z' }), 'RectangleOutlined');
export const RectangleRoundedIcon = (props?: KTRawAttr) => {
  const s = _RectangleRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RectangleRoundedIcon = svg(
  svg('path', { d: 'M2 6v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2H4c-1.1 0-2 .9-2 2' }),
  'RectangleRounded',
);
export const RectangleSharpIcon = (props?: KTRawAttr) => {
  const s = _RectangleSharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RectangleSharpIcon = svg(svg('path', { d: 'M2 4h20v16H2z' }), 'RectangleSharp');
export const RectangleTwoToneIcon = (props?: KTRawAttr) => {
  const s = _RectangleTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RectangleTwoToneIcon = svg(
  [svg('path', { d: 'M4 6h16v12H4z', opacity: '.3' }, '0'), svg('path', { d: 'M2 4v16h20V4zm18 14H4V6h16z' }, '1')],
  'RectangleTwoTone',
);
export const RecyclingIcon = (props?: KTRawAttr) => {
  const s = _RecyclingIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RecyclingIcon = svg(
  svg('path', {
...
export const RecyclingOutlinedIcon = (props?: KTRawAttr) => {
  const s = _RecyclingOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RecyclingOutlinedIcon = svg(
  svg('path', {
    d: 'M5.77 7.15 7.2 4.78l1.03-1.71c.39-.65 1.33-.65 1.72 0l1.48 2.46-1.23 2.06-1 1.62zm15.95 5.82-1.6-2.66-3.46 2L18.87 16H20c.76 0 1.45-.43 1.79-1.11.14-.28.21-.58.21-.89 0-.36-.1-.71-.28-1.03M16 21h1.5c.76 0 1.45-.43 1.79-1.11L20.74 17H16v-2l-4 4 4 4zm-6-4H5.7l-.84 1.41c-.3.5-.32 1.12-.06 1.65.28.57.87.94 1.52.94H10zm-3.88-2.65 1.73 1.04L6.48 9.9 1 11.27l1.7 1.02-.41.69c-.35.59-.38 1.31-.07 1.92l1.63 3.26zm10.9-9.21-1.3-2.17C15.35 2.37 14.7 2 14 2h-3.53l3.12 5.2-1.72 1.03 5.49 1.37 1.37-5.49z',
  }),
  'RecyclingOutlined',
);
export const RecyclingRoundedIcon = (props?: KTRawAttr) => {
  const s = _RecyclingRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RecyclingRoundedIcon = svg(
  svg('path', {
...
export const RecyclingSharpIcon = (props?: KTRawAttr) => {
  const s = _RecyclingSharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RecyclingSharpIcon = svg(
  svg('path', {
    d: 'M5.77 7.15 7.2 4.78l1.03-1.71c.39-.65 1.33-.65 1.72 0l1.48 2.46-1.23 2.06-1 1.62zm15.95 5.82-1.6-2.66-3.46 2L18.87 16H20c.76 0 1.45-.43 1.79-1.11.14-.28.21-.58.21-.89 0-.36-.1-.71-.28-1.03M16 21h1.5c.76 0 1.45-.43 1.79-1.11L20.74 17H16v-2l-4 4 4 4zm-6-4H5.7l-.84 1.41c-.3.5-.32 1.12-.06 1.65.28.57.87.94 1.52.94H10zm-3.88-2.65 1.73 1.04L6.48 9.9 1 11.27l1.7 1.02-.41.69c-.35.59-.38 1.31-.07 1.92l1.63 3.26zm10.9-9.21-1.3-2.17C15.35 2.37 14.7 2 14 2h-3.53l3.12 5.2-1.72 1.03 5.49 1.37 1.37-5.49z',
  }),
  'RecyclingSharp',
);
export const RecyclingTwoToneIcon = (props?: KTRawAttr) => {
  const s = _RecyclingTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RecyclingTwoToneIcon = svg(
  svg('path', {
    d: 'M5.77 7.15 7.2 4.78l1.03-1.71c.39-.65 1.33-.65 1.72 0l1.48 2.46-1.23 2.06-1 1.62zm15.95 5.82-1.6-2.66-3.46 2L18.87 16H20c.76 0 1.45-.43 1.79-1.11.14-.28.21-.58.21-.89 0-.36-.1-.71-.28-1.03M16 21h1.5c.76 0 1.45-.43 1.79-1.11L20.74 17H16v-2l-4 4 4 4zm-6-4H5.7l-.84 1.41c-.3.5-.32 1.12-.06 1.65.28.57.87.94 1.52.94H10zm-3.88-2.65 1.73 1.04L6.48 9.9 1 11.27l1.7 1.02-.41.69c-.35.59-.38 1.31-.07 1.92l1.63 3.26zm10.9-9.21-1.3-2.17C15.35 2.37 14.7 2 14 2h-3.53l3.12 5.2-1.72 1.03 5.49 1.37 1.37-5.49z',
  }),
  'RecyclingTwoTone',
);
export const RedditIcon = (props?: KTRawAttr) => {
  const s = _RedditIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RedditIcon = svg(
  svg('path', {
...
export const RedeemIcon = (props?: KTRawAttr) => {
  const s = _RedeemIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RedeemIcon = svg(
  svg('path', {
    d: 'M20 6h-2.18c.11-.31.18-.65.18-1 0-1.66-1.34-3-3-3-1.05 0-1.96.54-2.5 1.35l-.5.67-.5-.68C10.96 2.54 10.05 2 9 2 7.34 2 6 3.34 6 5c0 .35.07.69.18 1H4c-1.11 0-1.99.89-1.99 2L2 19c0 1.11.89 2 2 2h16c1.11 0 2-.89 2-2V8c0-1.11-.89-2-2-2m-5-2c.55 0 1 .45 1 1s-.45 1-1 1-1-.45-1-1 .45-1 1-1M9 4c.55 0 1 .45 1 1s-.45 1-1 1-1-.45-1-1 .45-1 1-1m11 15H4v-2h16zm0-5H4V8h5.08L7 10.83 8.62 12 11 8.76l1-1.36 1 1.36L15.38 12 17 10.83 14.92 8H20z',
  }),
  'Redeem',
);
export const RedeemOutlinedIcon = (props?: KTRawAttr) => {
  const s = _RedeemOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RedeemOutlinedIcon = svg(
  svg('path', {
    d: 'M20 6h-2.18c.11-.31.18-.65.18-1 0-1.66-1.34-3-3-3-1.05 0-1.96.54-2.5 1.35l-.5.67-.5-.68C10.96 2.54 10.05 2 9 2 7.34 2 6 3.34 6 5c0 .35.07.69.18 1H4c-1.11 0-1.99.89-1.99 2L2 19c0 1.11.89 2 2 2h16c1.11 0 2-.89 2-2V8c0-1.11-.89-2-2-2m-5-2c.55 0 1 .45 1 1s-.45 1-1 1-1-.45-1-1 .45-1 1-1M9 4c.55 0 1 .45 1 1s-.45 1-1 1-1-.45-1-1 .45-1 1-1m11 15H4v-2h16zm0-5H4V8h5.08L7 10.83 8.62 12 11 8.76l1-1.36 1 1.36L15.38 12 17 10.83 14.92 8H20z',
  }),
  'RedeemOutlined',
);
export const RedeemRoundedIcon = (props?: KTRawAttr) => {
  const s = _RedeemRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RedeemRoundedIcon = svg(
  svg('path', {
...
export const RedeemSharpIcon = (props?: KTRawAttr) => {
  const s = _RedeemSharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RedeemSharpIcon = svg(
  svg('path', {
...
export const RedeemTwoToneIcon = (props?: KTRawAttr) => {
  const s = _RedeemTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RedeemTwoToneIcon = svg(
  [
    svg(
      'path',
      {
...
export const RedoIcon = (props?: KTRawAttr) => {
  const s = _RedoIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RedoIcon = svg(
  svg('path', {
...
export const RedoOutlinedIcon = (props?: KTRawAttr) => {
  const s = _RedoOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RedoOutlinedIcon = svg(
  svg('path', {
    d: 'M18.4 10.6C16.55 8.99 14.15 8 11.5 8c-4.65 0-8.58 3.03-9.96 7.22L3.9 16c1.05-3.19 4.05-5.5 7.6-5.5 1.95 0 3.73.72 5.12 1.88L13 16h9V7z',
  }),
  'RedoOutlined',
);
export const RedoRoundedIcon = (props?: KTRawAttr) => {
  const s = _RedoRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RedoRoundedIcon = svg(
  svg('path', {
...
export const RedoSharpIcon = (props?: KTRawAttr) => {
  const s = _RedoSharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RedoSharpIcon = svg(
  svg('path', {
    d: 'M18.4 10.6C16.55 8.99 14.15 8 11.5 8c-4.65 0-8.58 3.03-9.96 7.22L3.9 16c1.05-3.19 4.05-5.5 7.6-5.5 1.95 0 3.73.72 5.12 1.88L13 16h9V7z',
  }),
  'RedoSharp',
);
export const RedoTwoToneIcon = (props?: KTRawAttr) => {
  const s = _RedoTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RedoTwoToneIcon = svg(
  svg('path', {
    d: 'M18.4 10.6C16.55 8.99 14.15 8 11.5 8c-4.65 0-8.58 3.03-9.96 7.22L3.9 16c1.05-3.19 4.05-5.5 7.6-5.5 1.95 0 3.73.72 5.12 1.88L13 16h9V7z',
  }),
  'RedoTwoTone',
);
export const ReduceCapacityIcon = (props?: KTRawAttr) => {
  const s = _ReduceCapacityIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _ReduceCapacityIcon = svg(
  svg('path', {
...
export const ReduceCapacityOutlinedIcon = (props?: KTRawAttr) => {
  const s = _ReduceCapacityOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _ReduceCapacityOutlinedIcon = svg(
  svg('path', {
    d: 'M16 4c0-1.1.9-2 2-2s2 .9 2 2-.9 2-2 2-2-.9-2-2m4.78 3.58C19.93 7.21 18.99 7 18 7c-.67 0-1.31.1-1.92.28.58.55.92 1.32.92 2.15V10h5v-.57c0-.81-.48-1.53-1.22-1.85M6 6c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2m1.92 1.28C7.31 7.1 6.67 7 6 7c-.99 0-1.93.21-2.78.58C2.48 7.9 2 8.62 2 9.43V10h5v-.57c0-.83.34-1.6.92-2.15M10 4c0-1.1.9-2 2-2s2 .9 2 2-.9 2-2 2-2-.9-2-2m6 6H8v-.57c0-.81.48-1.53 1.22-1.85C10.07 7.21 11.01 7 12 7s1.93.21 2.78.58C15.52 7.9 16 8.62 16 9.43zm-1 6c0-1.1.9-2 2-2s2 .9 2 2-.9 2-2 2-2-.9-2-2m6 6h-8v-.57c0-.81.48-1.53 1.22-1.85.85-.37 1.79-.58 2.78-.58s1.93.21 2.78.58c.74.32 1.22 1.04 1.22 1.85zM5 16c0-1.1.9-2 2-2s2 .9 2 2-.9 2-2 2-2-.9-2-2m6 6H3v-.57c0-.81.48-1.53 1.22-1.85C5.07 19.21 6.01 19 7 19s1.93.21 2.78.58c.74.32 1.22 1.04 1.22 1.85zm1.75-9v-2h-1.5v2H9l3 3 3-3z',
  }),
  'ReduceCapacityOutlined',
);
export const ReduceCapacityRoundedIcon = (props?: KTRawAttr) => {
  const s = _ReduceCapacityRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _ReduceCapacityRoundedIcon = svg(
  svg('path', {
...
export const ReduceCapacitySharpIcon = (props?: KTRawAttr) => {
  const s = _ReduceCapacitySharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _ReduceCapacitySharpIcon = svg(
  svg('path', {
    d: 'M16 4c0-1.1.9-2 2-2s2 .9 2 2-.9 2-2 2-2-.9-2-2m4.78 3.58C19.93 7.21 18.99 7 18 7c-.67 0-1.31.1-1.92.28.58.55.92 1.32.92 2.15V10h5v-.57c0-.81-.48-1.53-1.22-1.85M6 6c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2m1.92 1.28C7.31 7.1 6.67 7 6 7c-.99 0-1.93.21-2.78.58C2.48 7.9 2 8.62 2 9.43V10h5v-.57c0-.83.34-1.6.92-2.15M10 4c0-1.1.9-2 2-2s2 .9 2 2-.9 2-2 2-2-.9-2-2m6 6H8v-.57c0-.81.48-1.53 1.22-1.85C10.07 7.21 11.01 7 12 7s1.93.21 2.78.58C15.52 7.9 16 8.62 16 9.43zm-1 6c0-1.1.9-2 2-2s2 .9 2 2-.9 2-2 2-2-.9-2-2m6 6h-8v-.57c0-.81.48-1.53 1.22-1.85.85-.37 1.79-.58 2.78-.58s1.93.21 2.78.58c.74.32 1.22 1.04 1.22 1.85zM5 16c0-1.1.9-2 2-2s2 .9 2 2-.9 2-2 2-2-.9-2-2m6 6H3v-.57c0-.81.48-1.53 1.22-1.85C5.07 19.21 6.01 19 7 19s1.93.21 2.78.58c.74.32 1.22 1.04 1.22 1.85zm1.75-9v-2h-1.5v2H9l3 3 3-3z',
  }),
  'ReduceCapacitySharp',
);
export const ReduceCapacityTwoToneIcon = (props?: KTRawAttr) => {
  const s = _ReduceCapacityTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _ReduceCapacityTwoToneIcon = svg(
  svg('path', {
    d: 'M16 4c0-1.1.9-2 2-2s2 .9 2 2-.9 2-2 2-2-.9-2-2m4.78 3.58C19.93 7.21 18.99 7 18 7c-.67 0-1.31.1-1.92.28.58.55.92 1.32.92 2.15V10h5v-.57c0-.81-.48-1.53-1.22-1.85M6 6c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2m1.92 1.28C7.31 7.1 6.67 7 6 7c-.99 0-1.93.21-2.78.58C2.48 7.9 2 8.62 2 9.43V10h5v-.57c0-.83.34-1.6.92-2.15M10 4c0-1.1.9-2 2-2s2 .9 2 2-.9 2-2 2-2-.9-2-2m6 6H8v-.57c0-.81.48-1.53 1.22-1.85C10.07 7.21 11.01 7 12 7s1.93.21 2.78.58C15.52 7.9 16 8.62 16 9.43zm-1 6c0-1.1.9-2 2-2s2 .9 2 2-.9 2-2 2-2-.9-2-2m6 6h-8v-.57c0-.81.48-1.53 1.22-1.85.85-.37 1.79-.58 2.78-.58s1.93.21 2.78.58c.74.32 1.22 1.04 1.22 1.85zM5 16c0-1.1.9-2 2-2s2 .9 2 2-.9 2-2 2-2-.9-2-2m6 6H3v-.57c0-.81.48-1.53 1.22-1.85C5.07 19.21 6.01 19 7 19s1.93.21 2.78.58c.74.32 1.22 1.04 1.22 1.85zm1.75-9v-2h-1.5v2H9l3 3 3-3z',
  }),
  'ReduceCapacityTwoTone',
);
export const RefreshIcon = (props?: KTRawAttr) => {
  const s = _RefreshIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RefreshIcon = svg(
  svg('path', {
    d: 'M17.65 6.35C16.2 4.9 14.21 4 12 4c-4.42 0-7.99 3.58-7.99 8s3.57 8 7.99 8c3.73 0 6.84-2.55 7.73-6h-2.08c-.82 2.33-3.04 4-5.65 4-3.31 0-6-2.69-6-6s2.69-6 6-6c1.66 0 3.14.69 4.22 1.78L13 11h7V4z',
  }),
  'Refresh',
);
export const RefreshOutlinedIcon = (props?: KTRawAttr) => {
  const s = _RefreshOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RefreshOutlinedIcon = svg(
  svg('path', {
    d: 'M17.65 6.35C16.2 4.9 14.21 4 12 4c-4.42 0-7.99 3.58-7.99 8s3.57 8 7.99 8c3.73 0 6.84-2.55 7.73-6h-2.08c-.82 2.33-3.04 4-5.65 4-3.31 0-6-2.69-6-6s2.69-6 6-6c1.66 0 3.14.69 4.22 1.78L13 11h7V4z',
  }),
  'RefreshOutlined',
);
export const RefreshRoundedIcon = (props?: KTRawAttr) => {
  const s = _RefreshRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RefreshRoundedIcon = svg(
  svg('path', {
    d: 'M17.65 6.35c-1.63-1.63-3.94-2.57-6.48-2.31-3.67.37-6.69 3.35-7.1 7.02C3.52 15.91 7.27 20 12 20c3.19 0 5.93-1.87 7.21-4.56.32-.67-.16-1.44-.9-1.44-.37 0-.72.2-.88.53-1.13 2.43-3.84 3.97-6.8 3.31-2.22-.49-4.01-2.3-4.48-4.52C5.31 9.44 8.26 6 12 6c1.66 0 3.14.69 4.22 1.78l-1.51 1.51c-.63.63-.19 1.71.7 1.71H19c.55 0 1-.45 1-1V6.41c0-.89-1.08-1.34-1.71-.71z',
  }),
  'RefreshRounded',
);
export const RefreshSharpIcon = (props?: KTRawAttr) => {
  const s = _RefreshSharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RefreshSharpIcon = svg(
  svg('path', {
    d: 'M17.65 6.35C16.2 4.9 14.21 4 12 4c-4.42 0-7.99 3.58-7.99 8s3.57 8 7.99 8c3.73 0 6.84-2.55 7.73-6h-2.08c-.82 2.33-3.04 4-5.65 4-3.31 0-6-2.69-6-6s2.69-6 6-6c1.66 0 3.14.69 4.22 1.78L13 11h7V4z',
  }),
  'RefreshSharp',
);
export const RefreshTwoToneIcon = (props?: KTRawAttr) => {
  const s = _RefreshTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RefreshTwoToneIcon = svg(
  svg('path', {
    d: 'M17.65 6.35C16.2 4.9 14.21 4 12 4c-4.42 0-7.99 3.58-7.99 8s3.57 8 7.99 8c3.73 0 6.84-2.55 7.73-6h-2.08c-.82 2.33-3.04 4-5.65 4-3.31 0-6-2.69-6-6s2.69-6 6-6c1.66 0 3.14.69 4.22 1.78L13 11h7V4z',
  }),
  'RefreshTwoTone',
);
export const RememberMeIcon = (props?: KTRawAttr) => {
  const s = _RememberMeIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RememberMeIcon = svg(
  [
    svg(
      'path',
      {
    ...
    svg('circle', { cx: '12', cy: '10', r: '3' }, '1'),
  ],
  'RememberMe',
);
export const RememberMeOutlinedIcon = (props?: KTRawAttr) => {
  const s = _RememberMeOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RememberMeOutlinedIcon = svg(
  [
    svg(
      'path',
      {
...
export const RememberMeRoundedIcon = (props?: KTRawAttr) => {
  const s = _RememberMeRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RememberMeRoundedIcon = svg(
  [
    svg(
      'path',
      {
...
export const RememberMeSharpIcon = (props?: KTRawAttr) => {
  const s = _RememberMeSharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RememberMeSharpIcon = svg(
  [
    svg('path', { d: 'M19 1H5v22h14zm-2 14.21c-1.5-.77-3.2-1.21-5-1.21s-3.5.44-5 1.21V6h10z' }, '0'),
    svg('circle', { cx: '12', cy: '10', r: '3' }, '1'),
  ],
  'RememberMeSharp',
);
export const RememberMeTwoToneIcon = (props?: KTRawAttr) => {
  const s = _RememberMeTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RememberMeTwoToneIcon = svg(
  [
    svg(
      'path',
      { d: 'M7 20h10v1H7zm0-2.48V18h10v-.48c-1.47-.99-3.22-1.52-5-1.52s-3.53.53-5 1.52', opacity: '.3' },
      '0',
    ),
    svg('circle', { cx: '12', cy: '10', r: '1', opacity: '.3' }, '1'),
    svg('path', { d: 'M7 3h10v1H7z', opacity: '.3' }, '2'),
    svg(
      'path',
      {
        d: 'M17 1H7c-1.1 0-2 .9-2 2v18c0 1.1.9 2 2 2h10c1.1 0 2-.9 2-2V3c0-1.1-.9-2-2-2m0 20H7v-1h10zm0-3H7v-.48c1.47-.99 3.22-1.52 5-1.52s3.53.53 5 1.52zm0-2.79c-1.5-.77-3.2-1.21-5-1.21s-3.5.44-5 1.21V6h10zM17 4H7V3h10z',
...
export const RemoveIcon = (props?: KTRawAttr) => {
  const s = _RemoveIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RemoveIcon = svg(svg('path', { d: 'M19 13H5v-2h14z' }), 'Remove');
export const RemoveCircleIcon = (props?: KTRawAttr) => {
  const s = _RemoveCircleIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RemoveCircleIcon = svg(
  svg('path', { d: 'M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2m5 11H7v-2h10z' }),
  'RemoveCircle',
);
export const RemoveCircleOutlineIcon = (props?: KTRawAttr) => {
  const s = _RemoveCircleOutlineIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RemoveCircleOutlineIcon = svg(
  svg('path', {
...
export const RemoveCircleOutlineOutlinedIcon = (props?: KTRawAttr) => {
  const s = _RemoveCircleOutlineOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RemoveCircleOutlineOutlinedIcon = svg(
  svg('path', {
    d: 'M7 11v2h10v-2zm5-9C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2m0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8',
  }),
  'RemoveCircleOutlineOutlined',
);
export const RemoveCircleOutlineRoundedIcon = (props?: KTRawAttr) => {
  const s = _RemoveCircleOutlineRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RemoveCircleOutlineRoundedIcon = svg(
  svg('path', {
...
export const RemoveCircleOutlineSharpIcon = (props?: KTRawAttr) => {
  const s = _RemoveCircleOutlineSharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RemoveCircleOutlineSharpIcon = svg(
  svg('path', {
    d: 'M7 11v2h10v-2zm5-9C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2m0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8',
  }),
  'RemoveCircleOutlineSharp',
);
export const RemoveCircleOutlineTwoToneIcon = (props?: KTRawAttr) => {
  const s = _RemoveCircleOutlineTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RemoveCircleOutlineTwoToneIcon = svg(
  svg('path', {
...
export const RemoveCircleOutlinedIcon = (props?: KTRawAttr) => {
  const s = _RemoveCircleOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RemoveCircleOutlinedIcon = svg(
  svg('path', { d: 'M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2m5 11H7v-2h10z' }),
  'RemoveCircleOutlined',
);
export const RemoveCircleRoundedIcon = (props?: KTRawAttr) => {
  const s = _RemoveCircleRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RemoveCircleRoundedIcon = svg(
  svg('path', {
...
export const RemoveCircleSharpIcon = (props?: KTRawAttr) => {
  const s = _RemoveCircleSharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RemoveCircleSharpIcon = svg(
  svg('path', { d: 'M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2m5 11H7v-2h10z' }),
  'RemoveCircleSharp',
);
export const RemoveCircleTwoToneIcon = (props?: KTRawAttr) => {
  const s = _RemoveCircleTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RemoveCircleTwoToneIcon = svg(
  [
...
export const RemoveDoneIcon = (props?: KTRawAttr) => {
  const s = _RemoveDoneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RemoveDoneIcon = svg(
  svg('path', {
...
export const RemoveDoneOutlinedIcon = (props?: KTRawAttr) => {
  const s = _RemoveDoneOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RemoveDoneOutlinedIcon = svg(
  svg('path', {
...
export const RemoveDoneRoundedIcon = (props?: KTRawAttr) => {
  const s = _RemoveDoneRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RemoveDoneRoundedIcon = svg(
  svg('path', {
...
export const RemoveDoneSharpIcon = (props?: KTRawAttr) => {
  const s = _RemoveDoneSharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RemoveDoneSharpIcon = svg(
  svg('path', {
    d: 'M4.84 1.98 3.43 3.39l10.38 10.38-1.41 1.41-4.24-4.24-1.41 1.41 5.66 5.66 2.83-2.83 6.6 6.6 1.41-1.41zm13.21 10.38L23 7.4 21.57 6l-4.94 4.94zm-.71-4.96-1.41-1.41-2.12 2.12 1.41 1.41zM1.08 12.35l5.66 5.66 1.41-1.41-5.66-5.66z',
  }),
  'RemoveDoneSharp',
);
export const RemoveDoneTwoToneIcon = (props?: KTRawAttr) => {
  const s = _RemoveDoneTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RemoveDoneTwoToneIcon = svg(
  svg('path', {
    d: 'M4.84 1.98 3.43 3.39l10.38 10.38-1.41 1.41-4.24-4.24-1.41 1.41 5.66 5.66 2.83-2.83 6.6 6.6 1.41-1.41zm13.21 10.38L23 7.4 21.57 6l-4.94 4.94zm-.71-4.96-1.41-1.41-2.12 2.12 1.41 1.41zM1.08 12.35l5.66 5.66 1.41-1.41-5.66-5.66z',
  }),
  'RemoveDoneTwoTone',
);
export const RemoveFromQueueIcon = (props?: KTRawAttr) => {
  const s = _RemoveFromQueueIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RemoveFromQueueIcon = svg(
  svg('path', {
...
export const RemoveFromQueueOutlinedIcon = (props?: KTRawAttr) => {
  const s = _RemoveFromQueueOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RemoveFromQueueOutlinedIcon = svg(
  svg('path', {
...
export const RemoveFromQueueRoundedIcon = (props?: KTRawAttr) => {
  const s = _RemoveFromQueueRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RemoveFromQueueRoundedIcon = svg(
  svg('path', {
...
export const RemoveFromQueueSharpIcon = (props?: KTRawAttr) => {
  const s = _RemoveFromQueueSharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RemoveFromQueueSharpIcon = svg(
  svg('path', { d: 'M23 3H1v16h7v2h8v-2h7zm-2 14H3V5h18zm-5-7v2H8v-2z' }),
  'RemoveFromQueueSharp',
);
export const RemoveFromQueueTwoToneIcon = (props?: KTRawAttr) => {
  const s = _RemoveFromQueueTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RemoveFromQueueTwoToneIcon = svg(
  [
    svg('path', { d: 'M3 17h18V5H3zm5-7h8v2H8z', opacity: '.3' }, '0'),
    svg(
      'path',
      {
...
export const RemoveModeratorIcon = (props?: KTRawAttr) => {
  const s = _RemoveModeratorIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RemoveModeratorIcon = svg(
  svg('path', {
...
export const RemoveModeratorOutlinedIcon = (props?: KTRawAttr) => {
  const s = _RemoveModeratorOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RemoveModeratorOutlinedIcon = svg(
  svg('path', {
...
export const RemoveModeratorRoundedIcon = (props?: KTRawAttr) => {
  const s = _RemoveModeratorRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RemoveModeratorRoundedIcon = svg(
  svg('path', {
...
export const RemoveModeratorSharpIcon = (props?: KTRawAttr) => {
  const s = _RemoveModeratorSharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RemoveModeratorSharpIcon = svg(
  svg('path', {
...
export const RemoveModeratorTwoToneIcon = (props?: KTRawAttr) => {
  const s = _RemoveModeratorTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RemoveModeratorTwoToneIcon = svg(
  [
    svg(
      'path',
      {
...
export const RemoveOutlinedIcon = (props?: KTRawAttr) => {
  const s = _RemoveOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RemoveOutlinedIcon = svg(svg('path', { d: 'M19 13H5v-2h14z' }), 'RemoveOutlined');
export const RemoveRedEyeIcon = (props?: KTRawAttr) => {
  const s = _RemoveRedEyeIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RemoveRedEyeIcon = svg(
  svg('path', {
    d: 'M12 4.5C7 4.5 2.73 7.61 1 12c1.73 4.39 6 7.5 11 7.5s9.27-3.11 11-7.5c-1.73-4.39-6-7.5-11-7.5M12 17c-2.76 0-5-2.24-5-5s2.24-5 5-5 5 2.24 5 5-2.24 5-5 5m0-8c-1.66 0-3 1.34-3 3s1.34 3 3 3 3-1.34 3-3-1.34-3-3-3',
  }),
  'RemoveRedEye',
);
export const RemoveRedEyeOutlinedIcon = (props?: KTRawAttr) => {
  const s = _RemoveRedEyeOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RemoveRedEyeOutlinedIcon = svg(
  svg('path', {
...
export const RemoveRedEyeRoundedIcon = (props?: KTRawAttr) => {
  const s = _RemoveRedEyeRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RemoveRedEyeRoundedIcon = svg(
  svg('path', {
    d: 'M12 4.5C7 4.5 2.73 7.61 1 12c1.73 4.39 6 7.5 11 7.5s9.27-3.11 11-7.5c-1.73-4.39-6-7.5-11-7.5M12 17c-2.76 0-5-2.24-5-5s2.24-5 5-5 5 2.24 5 5-2.24 5-5 5m0-8c-1.66 0-3 1.34-3 3s1.34 3 3 3 3-1.34 3-3-1.34-3-3-3',
  }),
  'RemoveRedEyeRounded',
);
export const RemoveRedEyeSharpIcon = (props?: KTRawAttr) => {
  const s = _RemoveRedEyeSharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RemoveRedEyeSharpIcon = svg(
  svg('path', {
    d: 'M12 4.5C7 4.5 2.73 7.61 1 12c1.73 4.39 6 7.5 11 7.5s9.27-3.11 11-7.5c-1.73-4.39-6-7.5-11-7.5M12 17c-2.76 0-5-2.24-5-5s2.24-5 5-5 5 2.24 5 5-2.24 5-5 5m0-8c-1.66 0-3 1.34-3 3s1.34 3 3 3 3-1.34 3-3-1.34-3-3-3',
  }),
  'RemoveRedEyeSharp',
);
export const RemoveRedEyeTwoToneIcon = (props?: KTRawAttr) => {
  const s = _RemoveRedEyeTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RemoveRedEyeTwoToneIcon = svg(
  [
    svg(
      'path',
      {
...
export const RemoveRoadIcon = (props?: KTRawAttr) => {
  const s = _RemoveRoadIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RemoveRoadIcon = svg(
  svg('path', {
...
export const RemoveRoadOutlinedIcon = (props?: KTRawAttr) => {
  const s = _RemoveRoadOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RemoveRoadOutlinedIcon = svg(
  svg('path', {
    d: 'M18 4h2v9h-2zM4 4h2v16H4zm7 0h2v4h-2zm0 6h2v4h-2zm0 6h2v4h-2zm11.5.41L21.09 15 19 17.09 16.91 15l-1.41 1.41 2.09 2.09-2.09 2.09L16.91 22 19 19.91 21.09 22l1.41-1.41-2.09-2.09z',
  }),
  'RemoveRoadOutlined',
);
export const RemoveRoadRoundedIcon = (props?: KTRawAttr) => {
  const s = _RemoveRoadRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RemoveRoadRoundedIcon = svg(
  svg('path', {
...
export const RemoveRoadSharpIcon = (props?: KTRawAttr) => {
  const s = _RemoveRoadSharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RemoveRoadSharpIcon = svg(
  svg('path', {
    d: 'M18 4h2v9h-2zM4 4h2v16H4zm7 0h2v4h-2zm0 6h2v4h-2zm0 6h2v4h-2zm11.5.41L21.09 15 19 17.09 16.91 15l-1.41 1.41 2.09 2.09-2.09 2.09L16.91 22 19 19.91 21.09 22l1.41-1.41-2.09-2.09z',
  }),
  'RemoveRoadSharp',
);
export const RemoveRoadTwoToneIcon = (props?: KTRawAttr) => {
  const s = _RemoveRoadTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RemoveRoadTwoToneIcon = svg(
  svg('path', {
    d: 'M18 4h2v9h-2zM4 4h2v16H4zm7 0h2v4h-2zm0 6h2v4h-2zm0 6h2v4h-2zm11.5.41L21.09 15 19 17.09 16.91 15l-1.41 1.41 2.09 2.09-2.09 2.09L16.91 22 19 19.91 21.09 22l1.41-1.41-2.09-2.09z',
  }),
  'RemoveRoadTwoTone',
);
export const RemoveRoundedIcon = (props?: KTRawAttr) => {
  const s = _RemoveRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RemoveRoundedIcon = svg(
  svg('path', { d: 'M18 13H6c-.55 0-1-.45-1-1s.45-1 1-1h12c.55 0 1 .45 1 1s-.45 1-1 1' }),
  'RemoveRounded',
);
export const RemoveSharpIcon = (props?: KTRawAttr) => {
  const s = _RemoveSharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RemoveSharpIcon = svg(svg('path', { d: 'M19 13H5v-2h14z' }), 'RemoveSharp');
export const RemoveShoppingCartIcon = (props?: KTRawAttr) => {
  const s = _RemoveShoppingCartIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RemoveShoppingCartIcon = svg(
  svg('path', {
...
export const RemoveShoppingCartOutlinedIcon = (props?: KTRawAttr) => {
  const s = _RemoveShoppingCartOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RemoveShoppingCartOutlinedIcon = svg(
  svg('path', {
...
export const RemoveShoppingCartRoundedIcon = (props?: KTRawAttr) => {
  const s = _RemoveShoppingCartRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RemoveShoppingCartRoundedIcon = svg(
  svg('path', {
...
export const RemoveShoppingCartSharpIcon = (props?: KTRawAttr) => {
  const s = _RemoveShoppingCartSharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RemoveShoppingCartSharpIcon = svg(
  svg('path', {
...
export const RemoveShoppingCartTwoToneIcon = (props?: KTRawAttr) => {
  const s = _RemoveShoppingCartTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RemoveShoppingCartTwoToneIcon = svg(
  [
    svg(
      'path',
      {
    ...
    svg('path', { d: 'M18.31 6H9.12l4.99 5h1.44z', opacity: '.3' }, '1'),
    svg(
      'path',
      {
...
export const RemoveTwoToneIcon = (props?: KTRawAttr) => {
  const s = _RemoveTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RemoveTwoToneIcon = svg(svg('path', { d: 'M19 13H5v-2h14z' }), 'RemoveTwoTone');
export const ReorderIcon = (props?: KTRawAttr) => {
  const s = _ReorderIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _ReorderIcon = svg(svg('path', { d: 'M3 15h18v-2H3zm0 4h18v-2H3zm0-8h18V9H3zm0-6v2h18V5z' }), 'Reorder');
export const ReorderOutlinedIcon = (props?: KTRawAttr) => {
  const s = _ReorderOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _ReorderOutlinedIcon = svg(
  svg('path', { d: 'M3 15h18v-2H3zm0 4h18v-2H3zm0-8h18V9H3zm0-6v2h18V5z' }),
  'ReorderOutlined',
);
export const ReorderRoundedIcon = (props?: KTRawAttr) => {
  const s = _ReorderRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _ReorderRoundedIcon = svg(
  svg('path', {
...
export const ReorderSharpIcon = (props?: KTRawAttr) => {
  const s = _ReorderSharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _ReorderSharpIcon = svg(
  svg('path', { d: 'M3 15h18v-2H3zm0 4h18v-2H3zm0-8h18V9H3zm0-6v2h18V5z' }),
  'ReorderSharp',
);
export const ReorderTwoToneIcon = (props?: KTRawAttr) => {
  const s = _ReorderTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _ReorderTwoToneIcon = svg(
  svg('path', { d: 'M3 15h18v-2H3zm0 4h18v-2H3zm0-8h18V9H3zm0-6v2h18V5z' }),
  'ReorderTwoTone',
);
export const RepartitionIcon = (props?: KTRawAttr) => {
  const s = _RepartitionIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RepartitionIcon = svg(
  svg('path', {
...
export const RepartitionOutlinedIcon = (props?: KTRawAttr) => {
  const s = _RepartitionOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RepartitionOutlinedIcon = svg(
  svg('path', {
    d: 'M3 21h18v-6H3zm7.33-2v-2h3.33v2zM19 19h-3.33v-2H19zM5 17h3.33v2H5zm1-7 1.42-1.42L5.83 7H17c1.1 0 2 .9 2 2s-.9 2-2 2H3v2h14c2.21 0 4-1.79 4-4s-1.79-4-4-4H5.83l1.59-1.59L6 2 2 6z',
  }),
  'RepartitionOutlined',
);
export const RepartitionRoundedIcon = (props?: KTRawAttr) => {
  const s = _RepartitionRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RepartitionRoundedIcon = svg(
  svg('path', {
...
export const RepartitionSharpIcon = (props?: KTRawAttr) => {
  const s = _RepartitionSharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RepartitionSharpIcon = svg(
  svg('path', {
    d: 'M3 21h18v-6H3zm7.33-2v-2h3.33v2zM19 19h-3.33v-2H19zM5 17h3.33v2H5zm1-7 1.42-1.42L5.83 7H17c1.1 0 2 .9 2 2s-.9 2-2 2H3v2h14c2.21 0 4-1.79 4-4s-1.79-4-4-4H5.83l1.59-1.59L6 2 2 6z',
  }),
  'RepartitionSharp',
);
export const RepartitionTwoToneIcon = (props?: KTRawAttr) => {
  const s = _RepartitionTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RepartitionTwoToneIcon = svg(
  [
    svg('path', { d: 'M15.67 17H19v2h-3.33zm-5.34 0h3.33v2h-3.33zM5 17h3.33v2H5z', opacity: '.3' }, '0'),
    svg(
      'path',
      {
...
export const RepeatIcon = (props?: KTRawAttr) => {
  const s = _RepeatIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RepeatIcon = svg(
  svg('path', { d: 'M7 7h10v3l4-4-4-4v3H5v6h2zm10 10H7v-3l-4 4 4 4v-3h12v-6h-2z' }),
  'Repeat',
);
export const RepeatOnIcon = (props?: KTRawAttr) => {
  const s = _RepeatOnIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RepeatOnIcon = svg(
  svg('path', {
    fillRule: 'evenodd',
...
export const RepeatOnOutlinedIcon = (props?: KTRawAttr) => {
  const s = _RepeatOnOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RepeatOnOutlinedIcon = svg(
  svg('path', {
...
export const RepeatOnRoundedIcon = (props?: KTRawAttr) => {
  const s = _RepeatOnRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RepeatOnRoundedIcon = svg(
  svg('path', {
...
export const RepeatOnSharpIcon = (props?: KTRawAttr) => {
  const s = _RepeatOnSharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RepeatOnSharpIcon = svg(
  svg('path', {
...
export const RepeatOnTwoToneIcon = (props?: KTRawAttr) => {
  const s = _RepeatOnTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RepeatOnTwoToneIcon = svg(
  svg('path', {
    d: 'M21 1H3c-1.1 0-2 .9-2 2v18c0 1.1.9 2 2 2h18c1.1 0 2-.9 2-2V3c0-1.1-.9-2-2-2m-2 18H7v3l-4-4 4-4v3h10v-4h2zm-2-9V7H7v4H5V5h12V2l4 4z',
  }),
  'RepeatOnTwoTone',
);
export const RepeatOneIcon = (props?: KTRawAttr) => {
  const s = _RepeatOneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RepeatOneIcon = svg(
  svg('path', { d: 'M7 7h10v3l4-4-4-4v3H5v6h2zm10 10H7v-3l-4 4 4 4v-3h12v-6h-2zm-4-2V9h-1l-2 1v1h1.5v4z' }),
  'RepeatOne',
);
export const RepeatOneOnIcon = (props?: KTRawAttr) => {
  const s = _RepeatOneOnIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RepeatOneOnIcon = svg(
  svg('path', {
    fillRule: 'evenodd',
...
export const RepeatOneOnOutlinedIcon = (props?: KTRawAttr) => {
  const s = _RepeatOneOnOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RepeatOneOnOutlinedIcon = svg(
  svg('path', {
...
export const RepeatOneOnRoundedIcon = (props?: KTRawAttr) => {
  const s = _RepeatOneOnRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RepeatOneOnRoundedIcon = svg(
  svg('path', {
    d: 'M21 1H3c-1.1 0-2 .9-2 2v18c0 1.1.9 2 2 2h18c1.1 0 2-.9 2-2V3c0-1.1-.9-2-2-2m-2 17c0 .55-.45 1-1 1H7v1.79c0 .45-.54.67-.85.36l-2.79-2.79c-.2-.2-.2-.51 0-.71l2.79-2.79c.31-.32.85-.1.85.35V17h10v-3c0-.55.45-1 1-1s1 .45 1 1zm-8.25-7.5c-.41 0-.75-.34-.75-.75s.34-.75.75-.75h1.5c.41 0 .75.34.75.75v4.5c0 .41-.34.75-.75.75s-.75-.34-.75-.75V10.5zm9.89-4.15-2.79 2.79c-.31.32-.85.1-.85-.35V7H7v3c0 .55-.45 1-1 1s-1-.45-1-1V6c0-.55.45-1 1-1h11V3.21c0-.45.54-.67.85-.36l2.79 2.79c.2.2.2.51 0 .71',
  }),
  'RepeatOneOnRounded',
);
export const RepeatOneOnSharpIcon = (props?: KTRawAttr) => {
  const s = _RepeatOneOnSharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RepeatOneOnSharpIcon = svg(
  svg('path', {
...
export const RepeatOneOnTwoToneIcon = (props?: KTRawAttr) => {
  const s = _RepeatOneOnTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RepeatOneOnTwoToneIcon = svg(
  svg('path', {
    d: 'M21 1H3c-1.1 0-2 .9-2 2v18c0 1.1.9 2 2 2h18c1.1 0 2-.9 2-2V3c0-1.1-.9-2-2-2m-2 18H7v3l-4-4 4-4v3h10v-4h2zm-9-8.5V9h3v6h-1.5v-4.5zm7-.5V7H7v4H5V5h12V2l4 4z',
  }),
  'RepeatOneOnTwoTone',
);
export const RepeatOneOutlinedIcon = (props?: KTRawAttr) => {
  const s = _RepeatOneOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RepeatOneOutlinedIcon = svg(
  svg('path', { d: 'M7 7h10v3l4-4-4-4v3H5v6h2zm10 10H7v-3l-4 4 4 4v-3h12v-6h-2zm-4-2V9h-1l-2 1v1h1.5v4z' }),
  'RepeatOneOutlined',
);
export const RepeatOneRoundedIcon = (props?: KTRawAttr) => {
  const s = _RepeatOneRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RepeatOneRoundedIcon = svg(
  svg('path', {
...
export const RepeatOneSharpIcon = (props?: KTRawAttr) => {
  const s = _RepeatOneSharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RepeatOneSharpIcon = svg(
  svg('path', { d: 'M7 7h10v3l4-4-4-4v3H5v6h2zm10 10H7v-3l-4 4 4 4v-3h12v-6h-2zm-4-2V9h-1l-2 1v1h1.5v4z' }),
  'RepeatOneSharp',
);
export const RepeatOneTwoToneIcon = (props?: KTRawAttr) => {
  const s = _RepeatOneTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RepeatOneTwoToneIcon = svg(
  svg('path', { d: 'M13 15V9h-1l-2 1v1h1.5v4zm6-2h-2v4H7v-3l-4 4 4 4v-3h12zM17 2v3H5v6h2V7h10v3l4-4z' }),
  'RepeatOneTwoTone',
);
export const RepeatOutlinedIcon = (props?: KTRawAttr) => {
  const s = _RepeatOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RepeatOutlinedIcon = svg(
  svg('path', { d: 'M7 7h10v3l4-4-4-4v3H5v6h2zm10 10H7v-3l-4 4 4 4v-3h12v-6h-2z' }),
  'RepeatOutlined',
);
export const RepeatRoundedIcon = (props?: KTRawAttr) => {
  const s = _RepeatRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RepeatRoundedIcon = svg(
  svg('path', {
...
export const RepeatSharpIcon = (props?: KTRawAttr) => {
  const s = _RepeatSharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RepeatSharpIcon = svg(
  svg('path', { d: 'M7 7h10v3l4-4-4-4v3H5v6h2zm10 10H7v-3l-4 4 4 4v-3h12v-6h-2z' }),
  'RepeatSharp',
);
export const RepeatTwoToneIcon = (props?: KTRawAttr) => {
  const s = _RepeatTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RepeatTwoToneIcon = svg(
  svg('path', { d: 'M7 22v-3h12v-6h-2v4H7v-3l-4 4zM21 6l-4-4v3H5v6h2V7h10v3z' }),
  'RepeatTwoTone',
);
export const ReplayIcon = (props?: KTRawAttr) => {
  const s = _ReplayIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _ReplayIcon = svg(
  svg('path', {
    d: 'M12 5V1L7 6l5 5V7c3.31 0 6 2.69 6 6s-2.69 6-6 6-6-2.69-6-6H4c0 4.42 3.58 8 8 8s8-3.58 8-8-3.58-8-8-8',
  }),
  'Replay',
);
export const Replay10Icon = (props?: KTRawAttr) => {
  const s = _Replay10Icon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _Replay10Icon = svg(
  [
    svg(
      'path',
      {
...
export const Replay10OutlinedIcon = (props?: KTRawAttr) => {
  const s = _Replay10OutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _Replay10OutlinedIcon = svg(
  svg('path', {
...
export const Replay10RoundedIcon = (props?: KTRawAttr) => {
  const s = _Replay10RoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _Replay10RoundedIcon = svg(
  svg('path', {
...
export const Replay10SharpIcon = (props?: KTRawAttr) => {
  const s = _Replay10SharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _Replay10SharpIcon = svg(
  svg('path', {
    d: 'M11.99 5V1l-5 5 5 5V7c3.31 0 6 2.69 6 6s-2.69 6-6 6-6-2.69-6-6h-2c0 4.42 3.58 8 8 8s8-3.58 8-8-3.58-8-8-8m-1.1 11h-.85v-3.26l-1.01.31v-.69l1.77-.63h.09zm4.28-1.76c0 .32-.03.6-.1.82s-.17.42-.29.57-.28.26-.45.33-.37.1-.59.1-.41-.03-.59-.1-.33-.18-.46-.33-.23-.34-.3-.57-.11-.5-.11-.82v-.74c0-.32.03-.6.1-.82s.17-.42.29-.57.28-.26.45-.33.37-.1.59-.1.41.03.59.1.33.18.46.33.23.34.3.57.11.5.11.82zm-.85-.86c0-.19-.01-.35-.04-.48s-.07-.23-.12-.31-.11-.14-.19-.17-.16-.05-.25-.05-.18.02-.25.05-.14.09-.19.17-.09.18-.12.31-.04.29-.04.48v.97c0 .19.01.35.04.48s.07.24.12.32.11.14.19.17.16.05.25.05.18-.02.25-.05.14-.09.19-.17.09-.19.11-.32.04-.29.04-.48v-.97z',
  }),
  'Replay10Sharp',
);
export const Replay10TwoToneIcon = (props?: KTRawAttr) => {
  const s = _Replay10TwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _Replay10TwoToneIcon = svg(
  svg('path', {
    d: 'M11.99 5V1l-5 5 5 5V7c3.31 0 6 2.69 6 6s-2.69 6-6 6-6-2.69-6-6h-2c0 4.42 3.58 8 8 8s8-3.58 8-8-3.58-8-8-8m-1.1 11h-.85v-3.26l-1.01.31v-.69l1.77-.63h.09zm4.28-1.76c0 .32-.03.6-.1.82s-.17.42-.29.57-.28.26-.45.33-.37.1-.59.1-.41-.03-.59-.1-.33-.18-.46-.33-.23-.34-.3-.57-.11-.5-.11-.82v-.74c0-.32.03-.6.1-.82s.17-.42.29-.57.28-.26.45-.33.37-.1.59-.1.41.03.59.1.33.18.46.33.23.34.3.57.11.5.11.82zm-.85-.86c0-.19-.01-.35-.04-.48s-.07-.23-.12-.31-.11-.14-.19-.17-.16-.05-.25-.05-.18.02-.25.05-.14.09-.19.17-.09.18-.12.31-.04.29-.04.48v.97c0 .19.01.35.04.48s.07.24.12.32.11.14.19.17.16.05.25.05.18-.02.25-.05.14-.09.19-.17.09-.19.11-.32.04-.29.04-.48v-.97z',
  }),
  'Replay10TwoTone',
);
export const Replay30Icon = (props?: KTRawAttr) => {
  const s = _Replay30Icon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _Replay30Icon = svg(
  [
    svg(
      'path',
      { d: 'M12 5V1L7 6l5 5V7c3.31 0 6 2.69 6 6s-2.69 6-6 6-6-2.69-6-6H4c0 4.42 3.58 8 8 8s8-3.58 8-8-3.58-8-8-8' },
...
export const Replay30OutlinedIcon = (props?: KTRawAttr) => {
  const s = _Replay30OutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _Replay30OutlinedIcon = svg(
  svg('path', {
    d: 'M12 5V1L7 6l5 5V7c3.31 0 6 2.69 6 6s-2.69 6-6 6-6-2.69-6-6H4c0 4.42 3.58 8 8 8s8-3.58 8-8-3.58-8-8-8m-2.44 8.49h.45c.21 0 .37-.05.48-.16s.16-.25.16-.43c0-.08-.01-.15-.04-.22s-.06-.12-.11-.17-.11-.09-.18-.11-.16-.04-.25-.04c-.08 0-.15.01-.22.03s-.13.05-.18.1-.09.09-.12.15-.05.13-.05.2h-.85c0-.18.04-.34.11-.48s.17-.27.3-.37.27-.18.44-.23.35-.08.54-.08c.21 0 .41.03.59.08s.33.13.46.23.23.23.3.38.11.33.11.53c0 .09-.01.18-.04.27s-.07.17-.13.25-.12.15-.2.22-.17.12-.28.17c.24.09.42.21.54.39s.18.38.18.61c0 .2-.04.38-.12.53s-.18.29-.32.39-.29.19-.48.24-.38.08-.6.08c-.18 0-.36-.02-.53-.07s-.33-.12-.46-.23-.25-.23-.33-.38-.12-.34-.12-.55h.85c0 .08.02.15.05.22s.07.12.13.17.12.09.2.11.16.04.25.04c.1 0 .19-.01.27-.04s.15-.07.2-.12.1-.11.13-.18.04-.15.04-.24c0-.11-.02-.21-.05-.29s-.08-.15-.14-.2-.13-.09-.22-.11-.18-.04-.29-.04h-.47zm5.74.75c0 .32-.03.6-.1.82s-.17.42-.29.57-.28.26-.45.33-.37.1-.59.1-.41-.03-.59-.1-.33-.18-.46-.33-.23-.34-.3-.57-.11-.5-.11-.82v-.74c0-.32.03-.6.1-.82s.17-.42.29-.57.28-.26.45-.33.37-.1.59-.1.41.03.59.1.33.18.46.33.23.34.3.57.11.5.11.82zm-.85-.86c0-.19-.01-.35-.04-.48s-.07-.23-.12-.31-.11-.14-.19-.17-.16-.05-.25-.05-.18.02-.25.05-.14.09-.19.17-.09.18-.12.31-.04.29-.04.48v.97c0 .19.01.35.04.48s.07.24.12.32.11.14.19.17.16.05.25.05.18-.02.25-.05.14-.09.19-.17.09-.19.11-.32c.03-.13.04-.29.04-.48v-.97z',
  }),
  'Replay30Outlined',
);
export const Replay30RoundedIcon = (props?: KTRawAttr) => {
  const s = _Replay30RoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _Replay30RoundedIcon = svg(
  svg('path', {
...
export const Replay30SharpIcon = (props?: KTRawAttr) => {
  const s = _Replay30SharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _Replay30SharpIcon = svg(
  svg('path', {
    d: 'M12 5V1L7 6l5 5V7c3.31 0 6 2.69 6 6s-2.69 6-6 6-6-2.69-6-6H4c0 4.42 3.58 8 8 8s8-3.58 8-8-3.58-8-8-8m-2.44 8.49h.45c.21 0 .37-.05.48-.16s.16-.25.16-.43c0-.08-.01-.15-.04-.22s-.06-.12-.11-.17-.11-.09-.18-.11-.16-.04-.25-.04c-.08 0-.15.01-.22.03s-.13.05-.18.1-.09.09-.12.15-.05.13-.05.2h-.85c0-.18.04-.34.11-.48s.17-.27.3-.37.27-.18.44-.23.35-.08.54-.08c.21 0 .41.03.59.08s.33.13.46.23.23.23.3.38.11.33.11.53c0 .09-.01.18-.04.27s-.07.17-.13.25-.12.15-.2.22-.17.12-.28.17c.24.09.42.21.54.39s.18.38.18.61c0 .2-.04.38-.12.53s-.18.29-.32.39-.29.19-.48.24-.38.08-.6.08c-.18 0-.36-.02-.53-.07s-.33-.12-.46-.23-.25-.23-.33-.38-.12-.34-.12-.55h.85c0 .08.02.15.05.22s.07.12.13.17.12.09.2.11.16.04.25.04c.1 0 .19-.01.27-.04s.15-.07.2-.12.1-.11.13-.18.04-.15.04-.24c0-.11-.02-.21-.05-.29s-.08-.15-.14-.2-.13-.09-.22-.11-.18-.04-.29-.04h-.47zm5.74.75c0 .32-.03.6-.1.82s-.17.42-.29.57-.28.26-.45.33-.37.1-.59.1-.41-.03-.59-.1-.33-.18-.46-.33-.23-.34-.3-.57-.11-.5-.11-.82v-.74c0-.32.03-.6.1-.82s.17-.42.29-.57.28-.26.45-.33.37-.1.59-.1.41.03.59.1.33.18.46.33.23.34.3.57.11.5.11.82zm-.85-.86c0-.19-.01-.35-.04-.48s-.07-.23-.12-.31-.11-.14-.19-.17-.16-.05-.25-.05-.18.02-.25.05-.14.09-.19.17-.09.18-.12.31-.04.29-.04.48v.97c0 .19.01.35.04.48s.07.24.12.32.11.14.19.17.16.05.25.05.18-.02.25-.05.14-.09.19-.17.09-.19.11-.32c.03-.13.04-.29.04-.48v-.97z',
  }),
  'Replay30Sharp',
);
export const Replay30TwoToneIcon = (props?: KTRawAttr) => {
  const s = _Replay30TwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _Replay30TwoToneIcon = svg(
  svg('path', {
    d: 'M12 5V1L7 6l5 5V7c3.31 0 6 2.69 6 6s-2.69 6-6 6-6-2.69-6-6H4c0 4.42 3.58 8 8 8s8-3.58 8-8-3.58-8-8-8m-2.44 8.49h.45c.21 0 .37-.05.48-.16s.16-.25.16-.43c0-.08-.01-.15-.04-.22s-.06-.12-.11-.17-.11-.09-.18-.11-.16-.04-.25-.04c-.08 0-.15.01-.22.03s-.13.05-.18.1-.09.09-.12.15-.05.13-.05.2h-.85c0-.18.04-.34.11-.48s.17-.27.3-.37.27-.18.44-.23.35-.08.54-.08c.21 0 .41.03.59.08s.33.13.46.23.23.23.3.38.11.33.11.53c0 .09-.01.18-.04.27s-.07.17-.13.25-.12.15-.2.22-.17.12-.28.17c.24.09.42.21.54.39s.18.38.18.61c0 .2-.04.38-.12.53s-.18.29-.32.39-.29.19-.48.24-.38.08-.6.08c-.18 0-.36-.02-.53-.07s-.33-.12-.46-.23-.25-.23-.33-.38-.12-.34-.12-.55h.85c0 .08.02.15.05.22s.07.12.13.17.12.09.2.11.16.04.25.04c.1 0 .19-.01.27-.04s.15-.07.2-.12.1-.11.13-.18.04-.15.04-.24c0-.11-.02-.21-.05-.29s-.08-.15-.14-.2-.13-.09-.22-.11-.18-.04-.29-.04h-.47zm5.74.75c0 .32-.03.6-.1.82s-.17.42-.29.57-.28.26-.45.33-.37.1-.59.1-.41-.03-.59-.1-.33-.18-.46-.33-.23-.34-.3-.57-.11-.5-.11-.82v-.74c0-.32.03-.6.1-.82s.17-.42.29-.57.28-.26.45-.33.37-.1.59-.1.41.03.59.1.33.18.46.33.23.34.3.57.11.5.11.82zm-.85-.86c0-.19-.01-.35-.04-.48s-.07-.23-.12-.31-.11-.14-.19-.17-.16-.05-.25-.05-.18.02-.25.05-.14.09-.19.17-.09.18-.12.31-.04.29-.04.48v.97c0 .19.01.35.04.48s.07.24.12.32.11.14.19.17.16.05.25.05.18-.02.25-.05.14-.09.19-.17.09-.19.11-.32c.03-.13.04-.29.04-.48v-.97z',
  }),
  'Replay30TwoTone',
);
export const Replay5Icon = (props?: KTRawAttr) => {
  const s = _Replay5Icon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _Replay5Icon = svg(
  [
    svg(
      'path',
      { d: 'M12 5V1L7 6l5 5V7c3.31 0 6 2.69 6 6s-2.69 6-6 6-6-2.69-6-6H4c0 4.42 3.58 8 8 8s8-3.58 8-8-3.58-8-8-8' },
...
export const Replay5OutlinedIcon = (props?: KTRawAttr) => {
  const s = _Replay5OutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _Replay5OutlinedIcon = svg(
  svg('path', {
...
export const Replay5RoundedIcon = (props?: KTRawAttr) => {
  const s = _Replay5RoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _Replay5RoundedIcon = svg(
  svg('path', {
...
export const Replay5SharpIcon = (props?: KTRawAttr) => {
  const s = _Replay5SharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _Replay5SharpIcon = svg(
  svg('path', {
    d: 'M12 5V1L7 6l5 5V7c3.31 0 6 2.69 6 6s-2.69 6-6 6-6-2.69-6-6H4c0 4.42 3.58 8 8 8s8-3.58 8-8-3.58-8-8-8m-1.31 8.9.25-2.17h2.39v.71h-1.7l-.11.92c.03-.02.07-.03.11-.05s.09-.04.15-.05.12-.03.18-.04.13-.02.2-.02c.21 0 .39.03.55.1s.3.16.41.28.2.27.25.45.09.38.09.6q0 .285-.09.54c-.09.255-.15.32-.27.45s-.27.24-.45.31-.39.12-.64.12c-.18 0-.36-.03-.53-.08s-.32-.14-.46-.24-.24-.24-.32-.39-.13-.33-.13-.53h.84c.02.18.08.32.19.41s.25.15.42.15q.165 0 .27-.06c.105-.06.14-.1.18-.17s.08-.15.11-.25.03-.2.03-.31-.01-.21-.04-.31-.07-.17-.13-.24-.13-.12-.21-.15-.19-.05-.3-.05c-.08 0-.15.01-.2.02s-.11.03-.15.05-.08.05-.12.07-.07.06-.1.09z',
  }),
  'Replay5Sharp',
);
export const Replay5TwoToneIcon = (props?: KTRawAttr) => {
  const s = _Replay5TwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _Replay5TwoToneIcon = svg(
  svg('path', {
    d: 'M12 5V1L7 6l5 5V7c3.31 0 6 2.69 6 6s-2.69 6-6 6-6-2.69-6-6H4c0 4.42 3.58 8 8 8s8-3.58 8-8-3.58-8-8-8m-1.31 8.9.25-2.17h2.39v.71h-1.7l-.11.92c.03-.02.07-.03.11-.05s.09-.04.15-.05.12-.03.18-.04.13-.02.2-.02c.21 0 .39.03.55.1s.3.16.41.28.2.27.25.45.09.38.09.6q0 .285-.09.54c-.09.255-.15.32-.27.45s-.27.24-.45.31-.39.12-.64.12c-.18 0-.36-.03-.53-.08s-.32-.14-.46-.24-.24-.24-.32-.39-.13-.33-.13-.53h.84c.02.18.08.32.19.41s.25.15.42.15q.165 0 .27-.06c.105-.06.14-.1.18-.17s.08-.15.11-.25.03-.2.03-.31-.01-.21-.04-.31-.07-.17-.13-.24-.13-.12-.21-.15-.19-.05-.3-.05c-.08 0-.15.01-.2.02s-.11.03-.15.05-.08.05-.12.07-.07.06-.1.09z',
  }),
  'Replay5TwoTone',
);
export const ReplayCircleFilledIcon = (props?: KTRawAttr) => {
  const s = _ReplayCircleFilledIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _ReplayCircleFilledIcon = svg(
  svg('path', {
    fillRule: 'evenodd',
...
export const ReplayCircleFilledOutlinedIcon = (props?: KTRawAttr) => {
  const s = _ReplayCircleFilledOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _ReplayCircleFilledOutlinedIcon = svg(
  svg('path', {
...
export const ReplayCircleFilledRoundedIcon = (props?: KTRawAttr) => {
  const s = _ReplayCircleFilledRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _ReplayCircleFilledRoundedIcon = svg(
  svg('path', {
...
export const ReplayCircleFilledSharpIcon = (props?: KTRawAttr) => {
  const s = _ReplayCircleFilledSharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _ReplayCircleFilledSharpIcon = svg(
  svg('path', {
...
export const ReplayCircleFilledTwoToneIcon = (props?: KTRawAttr) => {
  const s = _ReplayCircleFilledTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _ReplayCircleFilledTwoToneIcon = svg(
  svg('path', {
    d: 'M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2m6 10.5c0 3.31-2.69 6-6 6s-6-2.69-6-6h2c0 2.21 1.79 4 4 4s4-1.79 4-4-1.79-4-4-4v3l-4-4 4-4v3c3.31 0 6 2.69 6 6',
  }),
  'ReplayCircleFilledTwoTone',
);
export const ReplayOutlinedIcon = (props?: KTRawAttr) => {
  const s = _ReplayOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _ReplayOutlinedIcon = svg(
  svg('path', {
    d: 'M12 5V1L7 6l5 5V7c3.31 0 6 2.69 6 6s-2.69 6-6 6-6-2.69-6-6H4c0 4.42 3.58 8 8 8s8-3.58 8-8-3.58-8-8-8',
  }),
  'ReplayOutlined',
);
export const ReplayRoundedIcon = (props?: KTRawAttr) => {
  const s = _ReplayRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _ReplayRoundedIcon = svg(
  svg('path', {
...
export const ReplaySharpIcon = (props?: KTRawAttr) => {
  const s = _ReplaySharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _ReplaySharpIcon = svg(
  svg('path', {
    d: 'M12 5V1L7 6l5 5V7c3.31 0 6 2.69 6 6s-2.69 6-6 6-6-2.69-6-6H4c0 4.42 3.58 8 8 8s8-3.58 8-8-3.58-8-8-8',
  }),
  'ReplaySharp',
);
export const ReplayTwoToneIcon = (props?: KTRawAttr) => {
  const s = _ReplayTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _ReplayTwoToneIcon = svg(
  svg('path', {
    d: 'm7 6 5 5V7c3.31 0 6 2.69 6 6s-2.69 6-6 6-6-2.69-6-6H4c0 4.42 3.58 8 8 8s8-3.58 8-8-3.58-8-8-8V1z',
  }),
  'ReplayTwoTone',
);
export const ReplyIcon = (props?: KTRawAttr) => {
  const s = _ReplyIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _ReplyIcon = svg(svg('path', { d: 'M10 9V5l-7 7 7 7v-4.1c5 0 8.5 1.6 11 5.1-1-5-4-10-11-11' }), 'Reply');
export const ReplyAllIcon = (props?: KTRawAttr) => {
  const s = _ReplyAllIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _ReplyAllIcon = svg(
  svg('path', { d: 'M7 8V5l-7 7 7 7v-3l-4-4zm6 1V5l-7 7 7 7v-4.1c5 0 8.5 1.6 11 5.1-1-5-4-10-11-11' }),
  'ReplyAll',
);
export const ReplyAllOutlinedIcon = (props?: KTRawAttr) => {
  const s = _ReplyAllOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _ReplyAllOutlinedIcon = svg(
  svg('path', { d: 'M7 8V5l-7 7 7 7v-3l-4-4zm6 1V5l-7 7 7 7v-4.1c5 0 8.5 1.6 11 5.1-1-5-4-10-11-11' }),
  'ReplyAllOutlined',
);
export const ReplyAllRoundedIcon = (props?: KTRawAttr) => {
  const s = _ReplyAllRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _ReplyAllRoundedIcon = svg(
  svg('path', {
...
export const ReplyAllSharpIcon = (props?: KTRawAttr) => {
  const s = _ReplyAllSharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _ReplyAllSharpIcon = svg(
  svg('path', { d: 'M7 8V5l-7 7 7 7v-3l-4-4zm6 1V5l-7 7 7 7v-4.1c5 0 8.5 1.6 11 5.1-1-5-4-10-11-11' }),
  'ReplyAllSharp',
);
export const ReplyAllTwoToneIcon = (props?: KTRawAttr) => {
  const s = _ReplyAllTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _ReplyAllTwoToneIcon = svg(
  svg('path', { d: 'M7 8V5l-7 7 7 7v-3l-4-4zm6 1V5l-7 7 7 7v-4.1c5 0 8.5 1.6 11 5.1-1-5-4-10-11-11' }),
  'ReplyAllTwoTone',
);
export const ReplyOutlinedIcon = (props?: KTRawAttr) => {
  const s = _ReplyOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _ReplyOutlinedIcon = svg(
  svg('path', { d: 'M10 9V5l-7 7 7 7v-4.1c5 0 8.5 1.6 11 5.1-1-5-4-10-11-11' }),
  'ReplyOutlined',
);
export const ReplyRoundedIcon = (props?: KTRawAttr) => {
  const s = _ReplyRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _ReplyRoundedIcon = svg(
  svg('path', {
...
export const ReplySharpIcon = (props?: KTRawAttr) => {
  const s = _ReplySharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _ReplySharpIcon = svg(
  svg('path', { d: 'M10 9V5l-7 7 7 7v-4.1c5 0 8.5 1.6 11 5.1-1-5-4-10-11-11' }),
  'ReplySharp',
);
export const ReplyTwoToneIcon = (props?: KTRawAttr) => {
  const s = _ReplyTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _ReplyTwoToneIcon = svg(
  svg('path', { d: 'M10 9V5l-7 7 7 7v-4.1c5 0 8.5 1.6 11 5.1-1-5-4-10-11-11' }),
  'ReplyTwoTone',
);
export const ReportIcon = (props?: KTRawAttr) => {
  const s = _ReportIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _ReportIcon = svg(
  svg('path', {
...
export const ReportGmailerrorredIcon = (props?: KTRawAttr) => {
  const s = _ReportGmailerrorredIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _ReportGmailerrorredIcon = svg(
  [
    svg(
      'path',
    ...
    svg('path', { d: 'M11 7h2v6h-2zm0 8h2v2h-2z' }, '1'),
  ],
  'ReportGmailerrorred',
);
export const ReportGmailerrorredOutlinedIcon = (props?: KTRawAttr) => {
  const s = _ReportGmailerrorredOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _ReportGmailerrorredOutlinedIcon = svg(
  [
    svg(
      'path',
      { d: 'M15.73 3H8.27L3 8.27v7.46L8.27 21h7.46L21 15.73V8.27zM19 14.9 14.9 19H9.1L5 14.9V9.1L9.1 5h5.8L19 9.1z' },
    ...
    svg('circle', { cx: '12', cy: '16', r: '1' }, '1'),
    svg('path', { d: 'M11 7h2v7h-2z' }, '2'),
  ],
  'ReportGmailerrorredOutlined',
);
export const ReportGmailerrorredRoundedIcon = (props?: KTRawAttr) => {
  const s = _ReportGmailerrorredRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _ReportGmailerrorredRoundedIcon = svg(
  [
    svg(
      'path',
      {
    ...
    svg('circle', { cx: '12', cy: '16', r: '1' }, '1'),
    svg('path', { d: 'M12 7c-.55 0-1 .45-1 1v5c0 .55.45 1 1 1s1-.45 1-1V8c0-.55-.45-1-1-1' }, '2'),
  ],
  'ReportGmailerrorredRounded',
);
export const ReportGmailerrorredSharpIcon = (props?: KTRawAttr) => {
  const s = _ReportGmailerrorredSharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _ReportGmailerrorredSharpIcon = svg(
  [
    svg(
      'path',
      { d: 'M15.73 3H8.27L3 8.27v7.46L8.27 21h7.46L21 15.73V8.27zM19 14.9 14.9 19H9.1L5 14.9V9.1L9.1 5h5.8L19 9.1z' },
...
export const ReportGmailerrorredTwoToneIcon = (props?: KTRawAttr) => {
  const s = _ReportGmailerrorredTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _ReportGmailerrorredTwoToneIcon = svg(
  [
    svg(
      'path',
      { d: 'M15.73 3H8.27L3 8.27v7.46L8.27 21h7.46L21 15.73V8.27zM19 14.9 14.9 19H9.1L5 14.9V9.1L9.1 5h5.8L19 9.1z' },
...
export const ReportOffIcon = (props?: KTRawAttr) => {
  const s = _ReportOffIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _ReportOffIcon = svg(
  svg('path', {
...
export const ReportOffOutlinedIcon = (props?: KTRawAttr) => {
  const s = _ReportOffOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _ReportOffOutlinedIcon = svg(
  [
    svg('path', { d: 'M9.1 5h5.8L19 9.1v5.8l-.22.22 1.42 1.41.8-.8V8.27L15.73 3H8.27l-.8.8 1.41 1.42z' }, '0'),
    svg('circle', { cx: '12', cy: '16', r: '1' }, '1'),
    svg(
      'path',
      {
...
export const ReportOffRoundedIcon = (props?: KTRawAttr) => {
  const s = _ReportOffRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _ReportOffRoundedIcon = svg(
  svg('path', {
...
export const ReportOffSharpIcon = (props?: KTRawAttr) => {
  const s = _ReportOffSharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _ReportOffSharpIcon = svg(
  svg('path', {
...
export const ReportOffTwoToneIcon = (props?: KTRawAttr) => {
  const s = _ReportOffTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _ReportOffTwoToneIcon = svg(
  [
    svg(
      'path',
      {
    ...
    svg('path', { d: 'M9.1 5h5.8L19 9.1v5.8l-.22.22 1.42 1.41.8-.8V8.27L15.73 3H8.27l-.8.8 1.41 1.42z' }, '1'),
    svg('circle', { cx: '12', cy: '16', r: '1' }, '2'),
    svg(
      'path',
      {
...
export const ReportOutlinedIcon = (props?: KTRawAttr) => {
  const s = _ReportOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _ReportOutlinedIcon = svg(
  [
    svg(
      'path',
      { d: 'M15.73 3H8.27L3 8.27v7.46L8.27 21h7.46L21 15.73V8.27zM19 14.9 14.9 19H9.1L5 14.9V9.1L9.1 5h5.8L19 9.1z' },
...
export const ReportProblemIcon = (props?: KTRawAttr) => {
  const s = _ReportProblemIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _ReportProblemIcon = svg(svg('path', { d: 'M1 21h22L12 2zm12-3h-2v-2h2zm0-4h-2v-4h2z' }), 'ReportProblem');
export const ReportProblemOutlinedIcon = (props?: KTRawAttr) => {
  const s = _ReportProblemOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _ReportProblemOutlinedIcon = svg(
  svg('path', { d: 'M12 5.99 19.53 19H4.47zM12 2 1 21h22zm1 14h-2v2h2zm0-6h-2v4h2z' }),
  'ReportProblemOutlined',
);
export const ReportProblemRoundedIcon = (props?: KTRawAttr) => {
  const s = _ReportProblemRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _ReportProblemRoundedIcon = svg(
  svg('path', {
...
export const ReportProblemSharpIcon = (props?: KTRawAttr) => {
  const s = _ReportProblemSharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _ReportProblemSharpIcon = svg(
  svg('path', { d: 'M1 21h22L12 2zm12-3h-2v-2h2zm0-4h-2v-4h2z' }),
  'ReportProblemSharp',
);
export const ReportProblemTwoToneIcon = (props?: KTRawAttr) => {
  const s = _ReportProblemTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _ReportProblemTwoToneIcon = svg(
  [
    svg('path', { d: 'M12 5.99 4.47 19h15.06zM13 18h-2v-2h2zm-2-4v-4h2v4z', opacity: '.3' }, '0'),
    svg('path', { d: 'M12 2 1 21h22zm0 3.99L19.53 19H4.47zM11 16h2v2h-2zm0-6h2v4h-2z' }, '1'),
  ],
  'ReportProblemTwoTone',
);
export const ReportRoundedIcon = (props?: KTRawAttr) => {
  const s = _ReportRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _ReportRoundedIcon = svg(
  svg('path', {
...
export const ReportSharpIcon = (props?: KTRawAttr) => {
  const s = _ReportSharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _ReportSharpIcon = svg(
  svg('path', {
    d: 'M15.73 3H8.27L3 8.27v7.46L8.27 21h7.46L21 15.73V8.27zM12 17.3c-.72 0-1.3-.58-1.3-1.3s.58-1.3 1.3-1.3 1.3.58 1.3 1.3-.58 1.3-1.3 1.3m1-4.3h-2V7h2z',
  }),
  'ReportSharp',
);
export const ReportTwoToneIcon = (props?: KTRawAttr) => {
  const s = _ReportTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _ReportTwoToneIcon = svg(
  [
    svg(
      'path',
      {
    ...
    svg('circle', { cx: '12', cy: '16', r: '1' }, '2'),
    svg('path', { d: 'M11 7h2v7h-2z' }, '3'),
  ],
  'ReportTwoTone',
);
export const RequestPageIcon = (props?: KTRawAttr) => {
  const s = _RequestPageIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RequestPageIcon = svg(
  svg('path', {
...
export const RequestPageOutlinedIcon = (props?: KTRawAttr) => {
  const s = _RequestPageOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RequestPageOutlinedIcon = svg(
  svg('path', {
...
export const RequestPageRoundedIcon = (props?: KTRawAttr) => {
  const s = _RequestPageRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RequestPageRoundedIcon = svg(
  svg('path', {
...
export const RequestPageSharpIcon = (props?: KTRawAttr) => {
  const s = _RequestPageSharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RequestPageSharpIcon = svg(
  svg('path', { d: 'M14 2H4.01L4 22h16V8zm1 9h-4v1h4v5h-2v1h-2v-1H9v-2h4v-1H9V9h2V8h2v1h2z' }),
  'RequestPageSharp',
);
export const RequestPageTwoToneIcon = (props?: KTRawAttr) => {
  const s = _RequestPageTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RequestPageTwoToneIcon = svg(
  [
    svg(
      'path',
      {
...
export const RequestQuoteIcon = (props?: KTRawAttr) => {
  const s = _RequestQuoteIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RequestQuoteIcon = svg(
  svg('path', {
...
export const RequestQuoteOutlinedIcon = (props?: KTRawAttr) => {
  const s = _RequestQuoteOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RequestQuoteOutlinedIcon = svg(
  svg('path', {
...
export const RequestQuoteRoundedIcon = (props?: KTRawAttr) => {
  const s = _RequestQuoteRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RequestQuoteRoundedIcon = svg(
  svg('path', {
...
export const RequestQuoteSharpIcon = (props?: KTRawAttr) => {
  const s = _RequestQuoteSharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RequestQuoteSharpIcon = svg(
  svg('path', { d: 'M14 2H4v20h16V8zm1 10h-4v1h4v5h-2v1h-2v-1H9v-2h4v-1H9v-5h2V9h2v1h2zm-2-4V3.5L17.5 8z' }),
  'RequestQuoteSharp',
);
export const RequestQuoteTwoToneIcon = (props?: KTRawAttr) => {
  const s = _RequestQuoteTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RequestQuoteTwoToneIcon = svg(
  [
    svg(
      'path',
      {
...
export const ResetTvIcon = (props?: KTRawAttr) => {
  const s = _ResetTvIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _ResetTvIcon = svg(
  svg('path', {
...
export const ResetTvOutlinedIcon = (props?: KTRawAttr) => {
  const s = _ResetTvOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _ResetTvOutlinedIcon = svg(
  svg('path', {
...
export const ResetTvRoundedIcon = (props?: KTRawAttr) => {
  const s = _ResetTvRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _ResetTvRoundedIcon = svg(
  svg('path', {
...
export const ResetTvSharpIcon = (props?: KTRawAttr) => {
  const s = _ResetTvSharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _ResetTvSharpIcon = svg(
  svg('path', { d: 'M22 10h-9.01V7L9 11l3.99 4v-3H20v5H4V5h16v3h2V3H2v16h6v2h8v-2h6z' }),
  'ResetTvSharp',
);
export const ResetTvTwoToneIcon = (props?: KTRawAttr) => {
  const s = _ResetTvTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _ResetTvTwoToneIcon = svg(
  svg('path', {
...
export const RestartAltIcon = (props?: KTRawAttr) => {
  const s = _RestartAltIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RestartAltIcon = svg(
  svg('path', {
    d: 'M12 5V2L8 6l4 4V7c3.31 0 6 2.69 6 6 0 2.97-2.17 5.43-5 5.91v2.02c3.95-.49 7-3.85 7-7.93 0-4.42-3.58-8-8-8m-6 8c0-1.65.67-3.15 1.76-4.24L6.34 7.34C4.9 8.79 4 10.79 4 13c0 4.08 3.05 7.44 7 7.93v-2.02c-2.83-.48-5-2.94-5-5.91',
  }),
  'RestartAlt',
);
export const RestartAltOutlinedIcon = (props?: KTRawAttr) => {
  const s = _RestartAltOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RestartAltOutlinedIcon = svg(
  svg('path', {
...
export const RestartAltRoundedIcon = (props?: KTRawAttr) => {
  const s = _RestartAltRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RestartAltRoundedIcon = svg(
  svg('path', {
...
export const RestartAltSharpIcon = (props?: KTRawAttr) => {
  const s = _RestartAltSharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RestartAltSharpIcon = svg(
  svg('path', {
    d: 'M12 5V2L8 6l4 4V7c3.31 0 6 2.69 6 6 0 2.97-2.17 5.43-5 5.91v2.02c3.95-.49 7-3.85 7-7.93 0-4.42-3.58-8-8-8m-6 8c0-1.65.67-3.15 1.76-4.24L6.34 7.34C4.9 8.79 4 10.79 4 13c0 4.08 3.05 7.44 7 7.93v-2.02c-2.83-.48-5-2.94-5-5.91',
  }),
  'RestartAltSharp',
);
export const RestartAltTwoToneIcon = (props?: KTRawAttr) => {
  const s = _RestartAltTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RestartAltTwoToneIcon = svg(
  svg('path', {
    d: 'M12 5V2L8 6l4 4V7c3.31 0 6 2.69 6 6 0 2.97-2.17 5.43-5 5.91v2.02c3.95-.49 7-3.85 7-7.93 0-4.42-3.58-8-8-8m-6 8c0-1.65.67-3.15 1.76-4.24L6.34 7.34C4.9 8.79 4 10.79 4 13c0 4.08 3.05 7.44 7 7.93v-2.02c-2.83-.48-5-2.94-5-5.91',
  }),
  'RestartAltTwoTone',
);
export const RestaurantIcon = (props?: KTRawAttr) => {
  const s = _RestaurantIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RestaurantIcon = svg(
  svg('path', {
...
export const RestaurantMenuIcon = (props?: KTRawAttr) => {
  const s = _RestaurantMenuIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RestaurantMenuIcon = svg(
  svg('path', {
...
export const RestaurantMenuOutlinedIcon = (props?: KTRawAttr) => {
  const s = _RestaurantMenuOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RestaurantMenuOutlinedIcon = svg(
  svg('path', {
    d: 'm8.1 13.34 2.83-2.83L3.91 3.5c-1.56 1.56-1.56 4.09 0 5.66zm6.78-1.81c1.53.71 3.68.21 5.27-1.38 1.91-1.91 2.28-4.65.81-6.12-1.46-1.46-4.2-1.1-6.12.81-1.59 1.59-2.09 3.74-1.38 5.27L3.7 19.87l1.41 1.41L12 14.41l6.88 6.88 1.41-1.41L13.41 13z',
  }),
  'RestaurantMenuOutlined',
);
export const RestaurantMenuRoundedIcon = (props?: KTRawAttr) => {
  const s = _RestaurantMenuRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RestaurantMenuRoundedIcon = svg(
  svg('path', {
...
export const RestaurantMenuSharpIcon = (props?: KTRawAttr) => {
  const s = _RestaurantMenuSharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RestaurantMenuSharpIcon = svg(
  svg('path', {
    d: 'm8.1 13.34 2.83-2.83L3.91 3.5c-1.56 1.56-1.56 4.09 0 5.66zm6.78-1.81c1.53.71 3.68.21 5.27-1.38 1.91-1.91 2.28-4.65.81-6.12-1.46-1.46-4.2-1.1-6.12.81-1.59 1.59-2.09 3.74-1.38 5.27L3.7 19.87l1.41 1.41L12 14.41l6.88 6.88 1.41-1.41L13.41 13z',
  }),
  'RestaurantMenuSharp',
);
export const RestaurantMenuTwoToneIcon = (props?: KTRawAttr) => {
  const s = _RestaurantMenuTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RestaurantMenuTwoToneIcon = svg(
  svg('path', {
...
export const RestaurantOutlinedIcon = (props?: KTRawAttr) => {
  const s = _RestaurantOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RestaurantOutlinedIcon = svg(
  svg('path', {
    d: 'M16 6v8h3v8h2V2c-2.76 0-5 2.24-5 4m-5 3H9V2H7v7H5V2H3v7c0 2.21 1.79 4 4 4v9h2v-9c2.21 0 4-1.79 4-4V2h-2z',
  }),
  'RestaurantOutlined',
);
export const RestaurantRoundedIcon = (props?: KTRawAttr) => {
  const s = _RestaurantRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RestaurantRoundedIcon = svg(
  svg('path', {
...
export const RestaurantSharpIcon = (props?: KTRawAttr) => {
  const s = _RestaurantSharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RestaurantSharpIcon = svg(
  svg('path', {
    d: 'M16 6v8h3v8h2V2c-2.76 0-5 2.24-5 4m-5 3H9V2H7v7H5V2H3v7c0 2.21 1.79 4 4 4v9h2v-9c2.21 0 4-1.79 4-4V2h-2z',
  }),
  'RestaurantSharp',
);
export const RestaurantTwoToneIcon = (props?: KTRawAttr) => {
  const s = _RestaurantTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RestaurantTwoToneIcon = svg(
  svg('path', {
    d: 'M16 6v8h3v8h2V2c-2.76 0-5 2.24-5 4m-5 3H9V2H7v7H5V2H3v7c0 2.21 1.79 4 4 4v9h2v-9c2.21 0 4-1.79 4-4V2h-2z',
  }),
  'RestaurantTwoTone',
);
export const RestoreIcon = (props?: KTRawAttr) => {
  const s = _RestoreIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RestoreIcon = svg(
  svg('path', {
    d: 'M13 3c-4.97 0-9 4.03-9 9H1l3.89 3.89.07.14L9 12H6c0-3.87 3.13-7 7-7s7 3.13 7 7-3.13 7-7 7c-1.93 0-3.68-.79-4.94-2.06l-1.42 1.42C8.27 19.99 10.51 21 13 21c4.97 0 9-4.03 9-9s-4.03-9-9-9m-1 5v5l4.28 2.54.72-1.21-3.5-2.08V8z',
  }),
  'Restore',
);
export const RestoreFromTrashIcon = (props?: KTRawAttr) => {
  const s = _RestoreFromTrashIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RestoreFromTrashIcon = svg(
  svg('path', { d: 'M19 4h-3.5l-1-1h-5l-1 1H5v2h14zM6 7v12c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2V7zm8 7v4h-4v-4H8l4-4 4 4z' }),
  'RestoreFromTrash',
);
export const RestoreFromTrashOutlinedIcon = (props?: KTRawAttr) => {
  const s = _RestoreFromTrashOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RestoreFromTrashOutlinedIcon = svg(
  svg('path', {
    d: 'm15.5 4-1-1h-5l-1 1H5v2h14V4zM6 19c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2V7H6zm2-5V9h8v10H8zm2 4h4v-4h2l-4-4-4 4h2z',
  }),
  'RestoreFromTrashOutlined',
);
export const RestoreFromTrashRoundedIcon = (props?: KTRawAttr) => {
  const s = _RestoreFromTrashRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RestoreFromTrashRoundedIcon = svg(
  svg('path', {
...
export const RestoreFromTrashSharpIcon = (props?: KTRawAttr) => {
  const s = _RestoreFromTrashSharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RestoreFromTrashSharpIcon = svg(
  svg('path', { d: 'M6 21h12V7H6zm6-11 4 4h-2v4h-4v-4H8zm3.5-6-1-1h-5l-1 1H5v2h14V4z' }),
  'RestoreFromTrashSharp',
);
export const RestoreFromTrashTwoToneIcon = (props?: KTRawAttr) => {
  const s = _RestoreFromTrashTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RestoreFromTrashTwoToneIcon = svg(
  [
    svg('path', { d: 'M16 14h-2v4h-4v-4H8v5h8zm0 0V9H8v5l4-4z', opacity: '.3' }, '0'),
    svg(
      'path',
      {
...
export const RestoreOutlinedIcon = (props?: KTRawAttr) => {
  const s = _RestoreOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RestoreOutlinedIcon = svg(
  svg('path', {
...
export const RestorePageIcon = (props?: KTRawAttr) => {
  const s = _RestorePageIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RestorePageIcon = svg(
  svg('path', {
...
export const RestorePageOutlinedIcon = (props?: KTRawAttr) => {
  const s = _RestorePageOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RestorePageOutlinedIcon = svg(
  svg('path', {
...
export const RestorePageRoundedIcon = (props?: KTRawAttr) => {
  const s = _RestorePageRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RestorePageRoundedIcon = svg(
  svg('path', {
...
export const RestorePageSharpIcon = (props?: KTRawAttr) => {
  const s = _RestorePageSharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RestorePageSharpIcon = svg(
  svg('path', {
...
export const RestorePageTwoToneIcon = (props?: KTRawAttr) => {
  const s = _RestorePageTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RestorePageTwoToneIcon = svg(
  [
    svg(
      'path',
      {
...
export const RestoreRoundedIcon = (props?: KTRawAttr) => {
  const s = _RestoreRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RestoreRoundedIcon = svg(
  svg('path', {
...
export const RestoreSharpIcon = (props?: KTRawAttr) => {
  const s = _RestoreSharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RestoreSharpIcon = svg(
  svg('path', {
    d: 'M13 3c-4.97 0-9 4.03-9 9H1l4 3.99L9 12H6c0-3.87 3.13-7 7-7s7 3.13 7 7-3.13 7-7 7c-1.93 0-3.68-.79-4.94-2.06l-1.42 1.42C8.27 19.99 10.51 21 13 21c4.97 0 9-4.03 9-9s-4.03-9-9-9m-1 5v5l4.25 2.52.77-1.28-3.52-2.09V8z',
  }),
  'RestoreSharp',
);
export const RestoreTwoToneIcon = (props?: KTRawAttr) => {
  const s = _RestoreTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RestoreTwoToneIcon = svg(
  svg('path', {
    d: 'M13 3c-4.97 0-9 4.03-9 9H1l4 3.99L9 12H6c0-3.87 3.13-7 7-7s7 3.13 7 7-3.13 7-7 7c-1.93 0-3.68-.79-4.94-2.06l-1.42 1.42C8.27 19.99 10.51 21 13 21c4.97 0 9-4.03 9-9s-4.03-9-9-9m-1 5v5l4.25 2.52.77-1.28-3.52-2.09V8z',
  }),
  'RestoreTwoTone',
);
export const ReviewsIcon = (props?: KTRawAttr) => {
  const s = _ReviewsIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _ReviewsIcon = svg(
  svg('path', {
...
export const ReviewsOutlinedIcon = (props?: KTRawAttr) => {
  const s = _ReviewsOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _ReviewsOutlinedIcon = svg(
  [
    svg(
      'path',
...
export const ReviewsRoundedIcon = (props?: KTRawAttr) => {
  const s = _ReviewsRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _ReviewsRoundedIcon = svg(
  svg('path', {
...
export const ReviewsSharpIcon = (props?: KTRawAttr) => {
  const s = _ReviewsSharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _ReviewsSharpIcon = svg(
  svg('path', { d: 'M22 2H2v20l4-4h16zm-8.43 9.57L12 15l-1.57-3.43L7 10l3.43-1.57L12 5l1.57 3.43L17 10z' }),
  'ReviewsSharp',
);
export const ReviewsTwoToneIcon = (props?: KTRawAttr) => {
  const s = _ReviewsTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _ReviewsTwoToneIcon = svg(
  [
    svg(
      'path',
...
export const RiceBowlIcon = (props?: KTRawAttr) => {
  const s = _RiceBowlIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RiceBowlIcon = svg(
  svg('path', {
...
export const RiceBowlOutlinedIcon = (props?: KTRawAttr) => {
  const s = _RiceBowlOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RiceBowlOutlinedIcon = svg(
  svg('path', {
...
export const RiceBowlRoundedIcon = (props?: KTRawAttr) => {
  const s = _RiceBowlRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RiceBowlRoundedIcon = svg(
  svg('path', {
...
export const RiceBowlSharpIcon = (props?: KTRawAttr) => {
  const s = _RiceBowlSharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RiceBowlSharpIcon = svg(
  svg('path', {
    d: 'M22 12c0-5.52-4.48-10-10-10S2 6.48 2 12c0 3.69 2.47 6.86 6 8.25V22h8v-1.75c3.53-1.39 6-4.56 6-8.25m-2 0h-4V5.08c2.39 1.39 4 3.97 4 6.92m-6-7.74V12h-4V4.26c.64-.16 1.31-.26 2-.26s1.36.1 2 .26M4 12c0-2.95 1.61-5.53 4-6.92V12z',
  }),
  'RiceBowlSharp',
);
export const RiceBowlTwoToneIcon = (props?: KTRawAttr) => {
  const s = _RiceBowlTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RiceBowlTwoToneIcon = svg(
  [
    svg(
      'path',
      {
...
export const RingVolumeIcon = (props?: KTRawAttr) => {
  const s = _RingVolumeIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RingVolumeIcon = svg(
  svg('path', {
...
export const RingVolumeOutlinedIcon = (props?: KTRawAttr) => {
  const s = _RingVolumeOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RingVolumeOutlinedIcon = svg(
  svg('path', {
...
export const RingVolumeRoundedIcon = (props?: KTRawAttr) => {
  const s = _RingVolumeRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RingVolumeRoundedIcon = svg(
  svg('path', {
...
export const RingVolumeSharpIcon = (props?: KTRawAttr) => {
  const s = _RingVolumeSharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RingVolumeSharpIcon = svg(
  svg('path', {
...
export const RingVolumeTwoToneIcon = (props?: KTRawAttr) => {
  const s = _RingVolumeTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RingVolumeTwoToneIcon = svg(
  [
    svg(
      'path',
      {
...
export const RocketIcon = (props?: KTRawAttr) => {
  const s = _RocketIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RocketIcon = svg(
  svg('path', {
...
export const RocketLaunchIcon = (props?: KTRawAttr) => {
  const s = _RocketLaunchIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RocketLaunchIcon = svg(
  svg('path', {
...
export const RocketLaunchOutlinedIcon = (props?: KTRawAttr) => {
  const s = _RocketLaunchOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RocketLaunchOutlinedIcon = svg(
  svg('path', {
...
export const RocketLaunchRoundedIcon = (props?: KTRawAttr) => {
  const s = _RocketLaunchRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RocketLaunchRoundedIcon = svg(
  svg('path', {
...
export const RocketLaunchSharpIcon = (props?: KTRawAttr) => {
  const s = _RocketLaunchSharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RocketLaunchSharpIcon = svg(
  svg('path', {
...
export const RocketLaunchTwoToneIcon = (props?: KTRawAttr) => {
  const s = _RocketLaunchTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RocketLaunchTwoToneIcon = svg(
  [
    svg(
      'path',
      {
...
export const RocketOutlinedIcon = (props?: KTRawAttr) => {
  const s = _RocketOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RocketOutlinedIcon = svg(
  svg('path', {
...
export const RocketRoundedIcon = (props?: KTRawAttr) => {
  const s = _RocketRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RocketRoundedIcon = svg(
  svg('path', {
...
export const RocketSharpIcon = (props?: KTRawAttr) => {
  const s = _RocketSharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RocketSharpIcon = svg(
  svg('path', {
...
export const RocketTwoToneIcon = (props?: KTRawAttr) => {
  const s = _RocketTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RocketTwoToneIcon = svg(
  [
    svg(
      'path',
      {
...
export const RollerShadesIcon = (props?: KTRawAttr) => {
  const s = _RollerShadesIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RollerShadesIcon = svg(
  svg('path', {
    d: 'M20 19V3H4v16H2v2h20v-2zM6 19v-6h5v1.8c-.4.3-.8.8-.8 1.4 0 1 .8 1.8 1.8 1.8s1.8-.8 1.8-1.8c0-.6-.3-1.1-.8-1.4V13h5v6z',
  }),
  'RollerShades',
);
export const RollerShadesClosedIcon = (props?: KTRawAttr) => {
  const s = _RollerShadesClosedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RollerShadesClosedIcon = svg(
  svg('path', {
    d: 'M20 19V3H4v16H2v2h8.25c0 .97.78 1.75 1.75 1.75s1.75-.78 1.75-1.75H22v-2zM6 19v-2h5v2zm7 0v-2h5v2z',
  }),
  'RollerShadesClosed',
);
export const RollerShadesClosedOutlinedIcon = (props?: KTRawAttr) => {
  const s = _RollerShadesClosedOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RollerShadesClosedOutlinedIcon = svg(
  svg('path', {
...
export const RollerShadesClosedRoundedIcon = (props?: KTRawAttr) => {
  const s = _RollerShadesClosedRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RollerShadesClosedRoundedIcon = svg(
  svg('path', {
...
export const RollerShadesClosedSharpIcon = (props?: KTRawAttr) => {
  const s = _RollerShadesClosedSharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RollerShadesClosedSharpIcon = svg(
  svg('path', {
    d: 'M20 19V3H4v16H2v2h8.25c0 .97.78 1.75 1.75 1.75s1.75-.78 1.75-1.75H22v-2zM6 19v-2h5v2zm7 0v-2h5v2z',
  }),
  'RollerShadesClosedSharp',
);
export const RollerShadesClosedTwoToneIcon = (props?: KTRawAttr) => {
  const s = _RollerShadesClosedTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RollerShadesClosedTwoToneIcon = svg(
  [
    svg('path', { d: 'M6 5h12v10H6z', opacity: '.3' }, '0'),
    svg(
      'path',
      {
...
export const RollerShadesOutlinedIcon = (props?: KTRawAttr) => {
  const s = _RollerShadesOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RollerShadesOutlinedIcon = svg(
  svg('path', {
...
export const RollerShadesRoundedIcon = (props?: KTRawAttr) => {
  const s = _RollerShadesRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RollerShadesRoundedIcon = svg(
  svg('path', {
...
export const RollerShadesSharpIcon = (props?: KTRawAttr) => {
  const s = _RollerShadesSharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RollerShadesSharpIcon = svg(
  svg('path', {
    d: 'M20 19V3H4v16H2v2h20v-2zM6 19v-6h5v1.8c-.4.3-.8.8-.8 1.4 0 1 .8 1.8 1.8 1.8s1.8-.8 1.8-1.8c0-.6-.3-1.1-.8-1.4V13h5v6z',
  }),
  'RollerShadesSharp',
);
export const RollerShadesTwoToneIcon = (props?: KTRawAttr) => {
  const s = _RollerShadesTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RollerShadesTwoToneIcon = svg(
  [
    svg('path', { d: 'M6 5h12v6H6z', opacity: '.3' }, '0'),
    svg(
      'path',
      {
...
export const RollerSkatingIcon = (props?: KTRawAttr) => {
  const s = _RollerSkatingIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RollerSkatingIcon = svg(
  svg('path', {
...
export const RollerSkatingOutlinedIcon = (props?: KTRawAttr) => {
  const s = _RollerSkatingOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RollerSkatingOutlinedIcon = svg(
  svg('path', {
...
export const RollerSkatingRoundedIcon = (props?: KTRawAttr) => {
  const s = _RollerSkatingRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RollerSkatingRoundedIcon = svg(
  svg('path', {
...
export const RollerSkatingSharpIcon = (props?: KTRawAttr) => {
  const s = _RollerSkatingSharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RollerSkatingSharpIcon = svg(
  svg('path', {
...
export const RollerSkatingTwoToneIcon = (props?: KTRawAttr) => {
  const s = _RollerSkatingTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RollerSkatingTwoToneIcon = svg(
  [
    svg(
      'path',
      {
...
export const RoofingIcon = (props?: KTRawAttr) => {
  const s = _RoofingIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RoofingIcon = svg(
  svg('path', { d: 'M13 18h-2v-2h2zm2-4H9v6h6zm4-4.7V4h-3v2.6L12 3 2 12h3l7-6.31L19 12h3z' }),
  'Roofing',
);
export const RoofingOutlinedIcon = (props?: KTRawAttr) => {
  const s = _RoofingOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RoofingOutlinedIcon = svg(
  svg('path', { d: 'M13 18h-2v-2h2zm2-4H9v6h6zm4-4.7V4h-3v2.6L12 3 2 12h3l7-6.31L19 12h3z' }),
  'RoofingOutlined',
);
export const RoofingRoundedIcon = (props?: KTRawAttr) => {
  const s = _RoofingRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RoofingRoundedIcon = svg(
  svg('path', {
...
export const RoofingSharpIcon = (props?: KTRawAttr) => {
  const s = _RoofingSharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RoofingSharpIcon = svg(
  svg('path', { d: 'M13 18h-2v-2h2zm2-4H9v6h6zm4-4.7V4h-3v2.6L12 3 2 12h3l7-6.31L19 12h3z' }),
  'RoofingSharp',
);
export const RoofingTwoToneIcon = (props?: KTRawAttr) => {
  const s = _RoofingTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RoofingTwoToneIcon = svg(
  [
    svg('path', { d: 'M11 16h2v2h-2z', opacity: '.3' }, '0'),
    svg('path', { d: 'M13 18h-2v-2h2zm2-4H9v6h6zm4-4.7V4h-3v2.6L12 3 2 12h3l7-6.31L19 12h3z' }, '1'),
  ],
  'RoofingTwoTone',
);
export const RoomIcon = (props?: KTRawAttr) => {
  const s = _RoomIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RoomIcon = svg(
  svg('path', {
    d: 'M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7m0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5',
  }),
  'Room',
);
export const RoomOutlinedIcon = (props?: KTRawAttr) => {
  const s = _RoomOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RoomOutlinedIcon = svg(
  [
    svg(
      'path',
      {
...
export const RoomPreferencesIcon = (props?: KTRawAttr) => {
  const s = _RoomPreferencesIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RoomPreferencesIcon = svg(
  svg('path', {
...
export const RoomPreferencesOutlinedIcon = (props?: KTRawAttr) => {
  const s = _RoomPreferencesOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RoomPreferencesOutlinedIcon = svg(
  svg('path', {
...
export const RoomPreferencesRoundedIcon = (props?: KTRawAttr) => {
  const s = _RoomPreferencesRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RoomPreferencesRoundedIcon = svg(
  svg('path', {
...
export const RoomPreferencesSharpIcon = (props?: KTRawAttr) => {
  const s = _RoomPreferencesSharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RoomPreferencesSharpIcon = svg(
  svg('path', {
    d: 'M14 11.26V6h3v4h2V4h-5V3H5v16H3v2h9.26c-.79-1.13-1.26-2.51-1.26-4 0-2.38 1.19-4.47 3-5.74M10 11h2v2h-2zm11.69 5.37 1.14-1-1-1.73-1.45.49q-.48-.405-1.08-.63L19 12h-2l-.3 1.49q-.6.225-1.08.63l-1.45-.49-1 1.73 1.14 1c-.08.5-.08.76 0 1.26l-1.14 1 1 1.73 1.45-.49q.48.405 1.08.63L17 22h2l.3-1.49q.6-.225 1.08-.63l1.45.49 1-1.73-1.14-1c.08-.51.08-.77 0-1.27M18 19c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2',
  }),
  'RoomPreferencesSharp',
);
export const RoomPreferencesTwoToneIcon = (props?: KTRawAttr) => {
  const s = _RoomPreferencesTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RoomPreferencesTwoToneIcon = svg(
  [
    svg(
      'path',
      { d: 'M13 12.11V5H7v14h4.29c-.19-.63-.29-1.3-.29-2 0-1.91.76-3.63 2-4.89M10 11h2v2h-2z', opacity: '.3' },
      '0',
    ),
    svg(
      'path',
...
export const RoomRoundedIcon = (props?: KTRawAttr) => {
  const s = _RoomRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RoomRoundedIcon = svg(
  svg('path', {
...
export const RoomServiceIcon = (props?: KTRawAttr) => {
  const s = _RoomServiceIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RoomServiceIcon = svg(
  svg('path', {
...
export const RoomServiceOutlinedIcon = (props?: KTRawAttr) => {
  const s = _RoomServiceOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RoomServiceOutlinedIcon = svg(
  svg('path', {
...
export const RoomServiceRoundedIcon = (props?: KTRawAttr) => {
  const s = _RoomServiceRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RoomServiceRoundedIcon = svg(
  svg('path', {
...
export const RoomServiceSharpIcon = (props?: KTRawAttr) => {
  const s = _RoomServiceSharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RoomServiceSharpIcon = svg(
  svg('path', {
    d: 'M2 17h20v2H2zm11.84-9.21c.1-.24.16-.51.16-.79 0-1.1-.9-2-2-2s-2 .9-2 2c0 .28.06.55.16.79C6.25 8.6 3.27 11.93 3 16h18c-.27-4.07-3.25-7.4-7.16-8.21',
  }),
  'RoomServiceSharp',
);
export const RoomServiceTwoToneIcon = (props?: KTRawAttr) => {
  const s = _RoomServiceTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RoomServiceTwoToneIcon = svg(
  [
    svg('path', { d: 'M12 9.58c-2.95 0-5.47 1.83-6.5 4.41h13c-1.03-2.58-3.55-4.41-6.5-4.41', opacity: '.3' }, '0'),
    svg(
      'path',
      {
...
export const RoomSharpIcon = (props?: KTRawAttr) => {
  const s = _RoomSharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RoomSharpIcon = svg(
  svg('path', {
    d: 'M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7m0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5',
  }),
  'RoomSharp',
);
export const RoomTwoToneIcon = (props?: KTRawAttr) => {
  const s = _RoomTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RoomTwoToneIcon = svg(
  [
    svg(
      'path',
      {
...
export const Rotate90DegreesCcwIcon = (props?: KTRawAttr) => {
  const s = _Rotate90DegreesCcwIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _Rotate90DegreesCcwIcon = svg(
  svg('path', {
...
export const Rotate90DegreesCcwOutlinedIcon = (props?: KTRawAttr) => {
  const s = _Rotate90DegreesCcwOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _Rotate90DegreesCcwOutlinedIcon = svg(
  svg('path', {
    d: 'M7.34 6.41.86 12.9l6.49 6.48 6.49-6.48zM3.69 12.9l3.66-3.66L11 12.9l-3.66 3.66zm15.67-6.26C17.61 4.88 15.3 4 13 4V.76L8.76 5 13 9.24V6c1.79 0 3.58.68 4.95 2.05 2.73 2.73 2.73 7.17 0 9.9C16.58 19.32 14.79 20 13 20c-.97 0-1.94-.21-2.84-.61l-1.49 1.49C10.02 21.62 11.51 22 13 22c2.3 0 4.61-.88 6.36-2.64 3.52-3.51 3.52-9.21 0-12.72',
  }),
  'Rotate90DegreesCcwOutlined',
);
export const Rotate90DegreesCcwRoundedIcon = (props?: KTRawAttr) => {
  const s = _Rotate90DegreesCcwRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _Rotate90DegreesCcwRoundedIcon = svg(
  svg('path', {
...
export const Rotate90DegreesCcwSharpIcon = (props?: KTRawAttr) => {
  const s = _Rotate90DegreesCcwSharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _Rotate90DegreesCcwSharpIcon = svg(
  svg('path', {
    d: 'M7.34 6.41.86 12.9l6.49 6.48 6.49-6.48zM3.69 12.9l3.66-3.66L11 12.9l-3.66 3.66zm15.67-6.26C17.61 4.88 15.3 4 13 4V.76L8.76 5 13 9.24V6c1.79 0 3.58.68 4.95 2.05 2.73 2.73 2.73 7.17 0 9.9C16.58 19.32 14.79 20 13 20c-.97 0-1.94-.21-2.84-.61l-1.49 1.49C10.02 21.62 11.51 22 13 22c2.3 0 4.61-.88 6.36-2.64 3.52-3.51 3.52-9.21 0-12.72',
  }),
  'Rotate90DegreesCcwSharp',
);
export const Rotate90DegreesCcwTwoToneIcon = (props?: KTRawAttr) => {
  const s = _Rotate90DegreesCcwTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _Rotate90DegreesCcwTwoToneIcon = svg(
  [
    svg('path', { d: 'M7.35 9.24 3.69 12.9l3.65 3.66L11 12.9z', opacity: '.3' }, '0'),
    svg(
      'path',
      {
...
export const Rotate90DegreesCwIcon = (props?: KTRawAttr) => {
  const s = _Rotate90DegreesCwIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _Rotate90DegreesCwIcon = svg(
  svg('path', {
...
export const Rotate90DegreesCwOutlinedIcon = (props?: KTRawAttr) => {
  const s = _Rotate90DegreesCwOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _Rotate90DegreesCwOutlinedIcon = svg(
  svg('path', {
...
export const Rotate90DegreesCwRoundedIcon = (props?: KTRawAttr) => {
  const s = _Rotate90DegreesCwRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _Rotate90DegreesCwRoundedIcon = svg(
  [
    svg(
      'path',
      {
...
export const Rotate90DegreesCwSharpIcon = (props?: KTRawAttr) => {
  const s = _Rotate90DegreesCwSharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _Rotate90DegreesCwSharpIcon = svg(
  [
    svg(
      'path',
      {
    ...
    svg('path', { d: 'm17 7-6 6 6 6 6-6z' }, '1'),
  ],
  'Rotate90DegreesCwSharp',
);
export const Rotate90DegreesCwTwoToneIcon = (props?: KTRawAttr) => {
  const s = _Rotate90DegreesCwTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _Rotate90DegreesCwTwoToneIcon = svg(
  [
    svg(
      'path',
      {
    ...
    svg('path', { d: 'm13.8172 12.9945 3.175-3.1749 3.1749 3.175-3.175 3.1748z', opacity: '.3' }, '1'),
  ],
  'Rotate90DegreesCwTwoTone',
);
export const RotateLeftIcon = (props?: KTRawAttr) => {
  const s = _RotateLeftIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RotateLeftIcon = svg(
  svg('path', {
...
export const RotateLeftOutlinedIcon = (props?: KTRawAttr) => {
  const s = _RotateLeftOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RotateLeftOutlinedIcon = svg(
  svg('path', {
    d: 'M7.11 8.53 5.7 7.11C4.8 8.27 4.24 9.61 4.07 11h2.02c.14-.87.49-1.72 1.02-2.47M6.09 13H4.07c.17 1.39.72 2.73 1.62 3.89l1.41-1.42c-.52-.75-.87-1.59-1.01-2.47m1.01 5.32c1.16.9 2.51 1.44 3.9 1.61V17.9c-.87-.15-1.71-.49-2.46-1.03zM13 4.07V1L8.45 5.55 13 10V6.09c2.84.48 5 2.94 5 5.91s-2.16 5.43-5 5.91v2.02c3.95-.49 7-3.85 7-7.93s-3.05-7.44-7-7.93',
  }),
  'RotateLeftOutlined',
);
export const RotateLeftRoundedIcon = (props?: KTRawAttr) => {
  const s = _RotateLeftRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RotateLeftRoundedIcon = svg(
  svg('path', {
...
export const RotateLeftSharpIcon = (props?: KTRawAttr) => {
  const s = _RotateLeftSharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RotateLeftSharpIcon = svg(
  svg('path', {
    d: 'M7.11 8.53 5.7 7.11C4.8 8.27 4.24 9.61 4.07 11h2.02c.14-.87.49-1.72 1.02-2.47M6.09 13H4.07c.17 1.39.72 2.73 1.62 3.89l1.41-1.42c-.52-.75-.87-1.59-1.01-2.47m1.01 5.32c1.16.9 2.51 1.44 3.9 1.61V17.9c-.87-.15-1.71-.49-2.46-1.03zM13 4.07V1L8.45 5.55 13 10V6.09c2.84.48 5 2.94 5 5.91s-2.16 5.43-5 5.91v2.02c3.95-.49 7-3.85 7-7.93s-3.05-7.44-7-7.93',
  }),
  'RotateLeftSharp',
);
export const RotateLeftTwoToneIcon = (props?: KTRawAttr) => {
  const s = _RotateLeftTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RotateLeftTwoToneIcon = svg(
  svg('path', {
...
export const RotateRightIcon = (props?: KTRawAttr) => {
  const s = _RotateRightIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RotateRightIcon = svg(
  svg('path', {
...
export const RotateRightOutlinedIcon = (props?: KTRawAttr) => {
  const s = _RotateRightOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RotateRightOutlinedIcon = svg(
  svg('path', {
    d: 'M15.55 5.55 11 1v3.07C7.06 4.56 4 7.92 4 12s3.05 7.44 7 7.93v-2.02c-2.84-.48-5-2.94-5-5.91s2.16-5.43 5-5.91V10zM19.93 11c-.17-1.39-.72-2.73-1.62-3.89l-1.42 1.42c.54.75.88 1.6 1.02 2.47zM13 17.9v2.02c1.39-.17 2.74-.71 3.9-1.61l-1.44-1.44c-.75.54-1.59.89-2.46 1.03m3.89-2.42 1.42 1.41c.9-1.16 1.45-2.5 1.62-3.89h-2.02c-.14.87-.48 1.72-1.02 2.48',
  }),
  'RotateRightOutlined',
);
export const RotateRightRoundedIcon = (props?: KTRawAttr) => {
  const s = _RotateRightRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RotateRightRoundedIcon = svg(
  svg('path', {
...
export const RotateRightSharpIcon = (props?: KTRawAttr) => {
  const s = _RotateRightSharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RotateRightSharpIcon = svg(
  svg('path', {
    d: 'M15.55 5.55 11 1v3.07C7.06 4.56 4 7.92 4 12s3.05 7.44 7 7.93v-2.02c-2.84-.48-5-2.94-5-5.91s2.16-5.43 5-5.91V10zM19.93 11c-.17-1.39-.72-2.73-1.62-3.89l-1.42 1.42c.54.75.88 1.6 1.02 2.47zM13 17.9v2.02c1.39-.17 2.74-.71 3.9-1.61l-1.44-1.44c-.75.54-1.59.89-2.46 1.03m3.89-2.42 1.42 1.41c.9-1.16 1.45-2.5 1.62-3.89h-2.02c-.14.87-.48 1.72-1.02 2.48',
  }),
  'RotateRightSharp',
);
export const RotateRightTwoToneIcon = (props?: KTRawAttr) => {
  const s = _RotateRightTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RotateRightTwoToneIcon = svg(
  svg('path', {
...
export const RoundaboutLeftIcon = (props?: KTRawAttr) => {
  const s = _RoundaboutLeftIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RoundaboutLeftIcon = svg(
  svg('path', {
...
export const RoundaboutLeftOutlinedIcon = (props?: KTRawAttr) => {
  const s = _RoundaboutLeftOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RoundaboutLeftOutlinedIcon = svg(
  svg('path', {
    d: 'M10.08 8c.48-2.84 2.94-5 5.92-5 3.31 0 6 2.69 6 6 0 2.97-2.16 5.44-5 5.92V21h-2v-6.09c0-.98.71-1.8 1.67-1.97C18.56 12.63 20 10.98 20 9c0-2.21-1.79-4-4-4-1.98 0-3.63 1.44-3.94 3.33-.17.96-.99 1.67-1.97 1.67H5.83l1.59 1.59L6 13 2 9l4-4 1.41 1.41L5.83 8z',
  }),
  'RoundaboutLeftOutlined',
);
export const RoundaboutLeftRoundedIcon = (props?: KTRawAttr) => {
  const s = _RoundaboutLeftRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RoundaboutLeftRoundedIcon = svg(
  svg('path', {
...
export const RoundaboutLeftSharpIcon = (props?: KTRawAttr) => {
  const s = _RoundaboutLeftSharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RoundaboutLeftSharpIcon = svg(
  svg('path', {
...
export const RoundaboutLeftTwoToneIcon = (props?: KTRawAttr) => {
  const s = _RoundaboutLeftTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RoundaboutLeftTwoToneIcon = svg(
  svg('path', {
    d: 'M10.08 8c.48-2.84 2.94-5 5.92-5 3.31 0 6 2.69 6 6 0 2.97-2.16 5.44-5 5.92V21h-2v-6.09c0-.98.71-1.8 1.67-1.97C18.56 12.63 20 10.98 20 9c0-2.21-1.79-4-4-4-1.98 0-3.63 1.44-3.94 3.33-.17.96-.99 1.67-1.97 1.67H5.83l1.59 1.59L6 13 2 9l4-4 1.41 1.41L5.83 8z',
  }),
  'RoundaboutLeftTwoTone',
);
export const RoundaboutRightIcon = (props?: KTRawAttr) => {
  const s = _RoundaboutRightIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RoundaboutRightIcon = svg(
  svg('path', {
...
export const RoundaboutRightOutlinedIcon = (props?: KTRawAttr) => {
  const s = _RoundaboutRightOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RoundaboutRightOutlinedIcon = svg(
  svg('path', {
    d: 'M13.92 8C13.44 5.16 10.97 3 8 3 4.69 3 2 5.69 2 9c0 2.97 2.16 5.44 5 5.92V21h2v-6.09c0-.98-.71-1.8-1.67-1.97C5.44 12.63 4 10.98 4 9c0-2.21 1.79-4 4-4 1.98 0 3.63 1.44 3.94 3.33.17.96.99 1.67 1.97 1.67h4.26l-1.59 1.59L18 13l4-4-4-4-1.41 1.41L18.17 8z',
  }),
  'RoundaboutRightOutlined',
);
export const RoundaboutRightRoundedIcon = (props?: KTRawAttr) => {
  const s = _RoundaboutRightRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RoundaboutRightRoundedIcon = svg(
  svg('path', {
...
export const RoundaboutRightSharpIcon = (props?: KTRawAttr) => {
  const s = _RoundaboutRightSharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RoundaboutRightSharpIcon = svg(
  svg('path', {
...
export const RoundaboutRightTwoToneIcon = (props?: KTRawAttr) => {
  const s = _RoundaboutRightTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RoundaboutRightTwoToneIcon = svg(
  svg('path', {
    d: 'M13.92 8C13.44 5.16 10.97 3 8 3 4.69 3 2 5.69 2 9c0 2.97 2.16 5.44 5 5.92V21h2v-6.09c0-.98-.71-1.8-1.67-1.97C5.44 12.63 4 10.98 4 9c0-2.21 1.79-4 4-4 1.98 0 3.63 1.44 3.94 3.33.17.96.99 1.67 1.97 1.67h4.26l-1.59 1.59L18 13l4-4-4-4-1.41 1.41L18.17 8z',
  }),
  'RoundaboutRightTwoTone',
);
export const RoundedCornerIcon = (props?: KTRawAttr) => {
  const s = _RoundedCornerIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RoundedCornerIcon = svg(
  svg('path', {
...
export const RoundedCornerOutlinedIcon = (props?: KTRawAttr) => {
  const s = _RoundedCornerOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RoundedCornerOutlinedIcon = svg(
  svg('path', {
    d: 'M19 19h2v2h-2zm0-2h2v-2h-2zM3 13h2v-2H3zm0 4h2v-2H3zm0-8h2V7H3zm0-4h2V3H3zm4 0h2V3H7zm8 16h2v-2h-2zm-4 0h2v-2h-2zm4 0h2v-2h-2zm-8 0h2v-2H7zm-4 0h2v-2H3zM21 8c0-2.76-2.24-5-5-5h-5v2h5c1.65 0 3 1.35 3 3v5h2z',
  }),
  'RoundedCornerOutlined',
);
export const RoundedCornerRoundedIcon = (props?: KTRawAttr) => {
  const s = _RoundedCornerRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RoundedCornerRoundedIcon = svg(
  svg('path', {
    d: 'M19 19h2v2h-2zm0-2h2v-2h-2zM3 13h2v-2H3zm0 4h2v-2H3zm0-8h2V7H3zm0-4h2V3H3zm4 0h2V3H7zm8 16h2v-2h-2zm-4 0h2v-2h-2zm4 0h2v-2h-2zm-8 0h2v-2H7zm-4 0h2v-2H3zM21 8c0-2.76-2.24-5-5-5h-5v2h5c1.65 0 3 1.35 3 3v5h2z',
  }),
  'RoundedCornerRounded',
);
export const RoundedCornerSharpIcon = (props?: KTRawAttr) => {
  const s = _RoundedCornerSharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RoundedCornerSharpIcon = svg(
  svg('path', {
    d: 'M19 19h2v2h-2zm0-2h2v-2h-2zM3 13h2v-2H3zm0 4h2v-2H3zm0-8h2V7H3zm0-4h2V3H3zm4 0h2V3H7zm8 16h2v-2h-2zm-4 0h2v-2h-2zm4 0h2v-2h-2zm-8 0h2v-2H7zm-4 0h2v-2H3zM21 8c0-2.76-2.24-5-5-5h-5v2h5c1.65 0 3 1.35 3 3v5h2z',
  }),
  'RoundedCornerSharp',
);
export const RoundedCornerTwoToneIcon = (props?: KTRawAttr) => {
  const s = _RoundedCornerTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RoundedCornerTwoToneIcon = svg(
  svg('path', {
    d: 'M19 19h2v2h-2zm0-2h2v-2h-2zM3 13h2v-2H3zm0 4h2v-2H3zm0-8h2V7H3zm0-4h2V3H3zm4 0h2V3H7zm8 16h2v-2h-2zm-4 0h2v-2h-2zm4 0h2v-2h-2zm-8 0h2v-2H7zm-4 0h2v-2H3zM21 8c0-2.76-2.24-5-5-5h-5v2h5c1.65 0 3 1.35 3 3v5h2z',
  }),
  'RoundedCornerTwoTone',
);
export const RouteIcon = (props?: KTRawAttr) => {
  const s = _RouteIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RouteIcon = svg(
  svg('path', {
...
export const RouteOutlinedIcon = (props?: KTRawAttr) => {
  const s = _RouteOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RouteOutlinedIcon = svg(
  svg('path', {
...
export const RouteRoundedIcon = (props?: KTRawAttr) => {
  const s = _RouteRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RouteRoundedIcon = svg(
  svg('path', {
    d: 'M19 15.18V7c0-2.21-1.79-4-4-4s-4 1.79-4 4v10c0 1.1-.9 2-2 2s-2-.9-2-2V8.82C8.16 8.4 9 7.3 9 6c0-1.66-1.34-3-3-3S3 4.34 3 6c0 1.3.84 2.4 2 2.82V17c0 2.21 1.79 4 4 4s4-1.79 4-4V7c0-1.1.9-2 2-2s2 .9 2 2v8.18c-1.16.41-2 1.51-2 2.82 0 1.66 1.34 3 3 3s3-1.34 3-3c0-1.3-.84-2.4-2-2.82',
  }),
  'RouteRounded',
);
export const RouteSharpIcon = (props?: KTRawAttr) => {
  const s = _RouteSharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RouteSharpIcon = svg(
  svg('path', {
...
export const RouteTwoToneIcon = (props?: KTRawAttr) => {
  const s = _RouteTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RouteTwoToneIcon = svg(
  [
    svg('circle', { cx: '6', cy: '6', r: '1', opacity: '.3' }, '0'),
    svg('circle', { cx: '18', cy: '18', r: '1', opacity: '.3' }, '1'),
    svg(
      'path',
      {
        d: 'M19 15.18V7c0-2.21-1.79-4-4-4s-4 1.79-4 4v10c0 1.1-.9 2-2 2s-2-.9-2-2V8.82C8.16 8.4 9 7.3 9 6c0-1.66-1.34-3-3-3S3 4.34 3 6c0 1.3.84 2.4 2 2.82V17c0 2.21 1.79 4 4 4s4-1.79 4-4V7c0-1.1.9-2 2-2s2 .9 2 2v8.18c-1.16.41-2 1.51-2 2.82 0 1.66 1.34 3 3 3s3-1.34 3-3c0-1.3-.84-2.4-2-2.82M6 7c-.55 0-1-.45-1-1s.45-1 1-1 1 .45 1 1-.45 1-1 1m12 12c-.55 0-1-.45-1-1s.45-1 1-1 1 .45 1 1-.45 1-1 1',
...
export const RouterIcon = (props?: KTRawAttr) => {
  const s = _RouterIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RouterIcon = svg(
  svg('path', {
...
export const RouterOutlinedIcon = (props?: KTRawAttr) => {
  const s = _RouterOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RouterOutlinedIcon = svg(
  svg('path', {
...
export const RouterRoundedIcon = (props?: KTRawAttr) => {
  const s = _RouterRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RouterRoundedIcon = svg(
  svg('path', {
...
export const RouterSharpIcon = (props?: KTRawAttr) => {
  const s = _RouterSharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RouterSharpIcon = svg(
  svg('path', {
...
export const RouterTwoToneIcon = (props?: KTRawAttr) => {
  const s = _RouterTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RouterTwoToneIcon = svg(
  [
    svg('path', { d: 'M15 15H5v4h14v-4zm-7 3H6v-2h2zm3.5 0h-2v-2h2zm3.5 0h-2v-2h2z', opacity: '.3' }, '0'),
    svg(
      'path',
      {
        d: 'M16 4.2c1.5 0 3 .6 4.2 1.7l.8-.8C19.6 3.7 17.8 3 16 3s-3.6.7-5 2.1l.8.8C13 4.8 14.5 4.2 16 4.2m-3.3 2.5.8.8c.7-.7 1.6-1 2.5-1s1.8.3 2.5 1l.8-.8c-.9-.9-2.1-1.4-3.3-1.4s-2.4.5-3.3 1.4M19 13h-2V9h-2v4H5c-1.1 0-2 .9-2 2v4c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2v-4c0-1.1-.9-2-2-2m0 6H5v-4h14zM6 16h2v2H6zm3.5 0h2v2h-2zm3.5 0h2v2h-2z',
...
export const RowingIcon = (props?: KTRawAttr) => {
  const s = _RowingIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RowingIcon = svg(
  svg('path', {
...
export const RowingOutlinedIcon = (props?: KTRawAttr) => {
  const s = _RowingOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RowingOutlinedIcon = svg(
  svg('path', {
...
export const RowingRoundedIcon = (props?: KTRawAttr) => {
  const s = _RowingRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RowingRoundedIcon = svg(
  svg('path', {
...
export const RowingSharpIcon = (props?: KTRawAttr) => {
  const s = _RowingSharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RowingSharpIcon = svg(
  svg('path', {
...
export const RowingTwoToneIcon = (props?: KTRawAttr) => {
  const s = _RowingTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RowingTwoToneIcon = svg(
  svg('path', {
    d: 'M8.5 14.5 4 19l1.5 1.5L9 17h2zM15 1c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2m6 20.01L18 24l-2.99-3.01V19.5l-7.1-7.09c-.31.05-.61.07-.91.07v-2.16c1.66.03 3.61-.87 4.67-2.04l1.4-1.55c.19-.21.43-.38.69-.5.29-.14.62-.23.96-.23h.03C15.99 6.01 17 7.02 17 8.26v5.75c0 .84-.35 1.61-.92 2.16l-3.58-3.58v-2.27c-.63.52-1.43 1.02-2.29 1.39L16.5 18H18z',
  }),
  'RowingTwoTone',
);
export const RssFeedIcon = (props?: KTRawAttr) => {
  const s = _RssFeedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RssFeedIcon = svg(
  [
    svg('circle', { cx: '6.18', cy: '17.82', r: '2.18' }, '0'),
    svg(
      'path',
      {
...
export const RssFeedOutlinedIcon = (props?: KTRawAttr) => {
  const s = _RssFeedOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RssFeedOutlinedIcon = svg(
  [
    svg('circle', { cx: '6.18', cy: '17.82', r: '2.18' }, '0'),
    svg(
      'path',
...
export const RssFeedRoundedIcon = (props?: KTRawAttr) => {
  const s = _RssFeedRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RssFeedRoundedIcon = svg(
  [
    svg('circle', { cx: '6.18', cy: '17.82', r: '2.18' }, '0'),
    svg(
      'path',
...
export const RssFeedSharpIcon = (props?: KTRawAttr) => {
  const s = _RssFeedSharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RssFeedSharpIcon = svg(
  [
    svg('circle', { cx: '6.18', cy: '17.82', r: '2.18' }, '0'),
    svg(
      'path',
...
export const RssFeedTwoToneIcon = (props?: KTRawAttr) => {
  const s = _RssFeedTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RssFeedTwoToneIcon = svg(
  [
    svg('circle', { cx: '6.18', cy: '17.82', r: '2.18' }, '0'),
    svg(
      'path',
...
export const RsvpIcon = (props?: KTRawAttr) => {
  const s = _RsvpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RsvpIcon = svg(
  svg('path', {
...
export const RsvpOutlinedIcon = (props?: KTRawAttr) => {
  const s = _RsvpOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RsvpOutlinedIcon = svg(
  svg('path', {
    d: 'M16 9h1.5l-1.75 6h-1.5L12.5 9H14l1 3.43zM5.1 12.9 6 15H4.5l-.85-2H2.5v2H1V9h3.5c.85 0 1.5.65 1.5 1.5v1c0 .6-.4 1.15-.9 1.4m-.6-2.4h-2v1h2zm17 2.5h-2v2H18V9h3.5c.83 0 1.5.67 1.5 1.5v1c0 .83-.67 1.5-1.5 1.5m0-2.5h-2v1h2zM11.5 9v1.5h-3v.75h2c.55 0 1 .45 1 1V14c0 .55-.45 1-1 1H7v-1.5h3v-.75H7.75c-.41 0-.75-.34-.75-.75v-2c0-.55.45-1 1-1z',
  }),
  'RsvpOutlined',
);
export const RsvpRoundedIcon = (props?: KTRawAttr) => {
  const s = _RsvpRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RsvpRoundedIcon = svg(
  svg('path', {
...
export const RsvpSharpIcon = (props?: KTRawAttr) => {
  const s = _RsvpSharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RsvpSharpIcon = svg(
  svg('path', {
...
export const RsvpTwoToneIcon = (props?: KTRawAttr) => {
  const s = _RsvpTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RsvpTwoToneIcon = svg(
  svg('path', {
    d: 'M16 9h1.5l-1.75 6h-1.5L12.5 9H14l1 3.43zM5.1 12.9 6 15H4.5l-.85-2H2.5v2H1V9h3.5c.85 0 1.5.65 1.5 1.5v1c0 .6-.4 1.15-.9 1.4m-.6-2.4h-2v1h2zm17 2.5h-2v2H18V9h3.5c.83 0 1.5.67 1.5 1.5v1c0 .83-.67 1.5-1.5 1.5m0-2.5h-2v1h2zM11.5 9v1.5h-3v.75h2c.55 0 1 .45 1 1V14c0 .55-.45 1-1 1H7v-1.5h3v-.75H7.75c-.41 0-.75-.34-.75-.75v-2c0-.55.45-1 1-1z',
  }),
  'RsvpTwoTone',
);
export const RttIcon = (props?: KTRawAttr) => {
  const s = _RttIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RttIcon = svg(
  svg('path', {
...
export const RttOutlinedIcon = (props?: KTRawAttr) => {
  const s = _RttOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RttOutlinedIcon = svg(
  svg('path', {
    d: 'm9.03 3-1.11 7.07h2.62l.7-4.5h2.58L11.8 18.43H9.47L9.06 21h7.27l.4-2.57h-2.35l2-12.86h2.58l-.71 4.5h2.65L22 3zM8 5H4l-.31 2h4zm-.61 4h-4l-.31 2h4zm.92 8h-6L2 19h6zm.62-4h-6l-.31 2h6.01z',
  }),
  'RttOutlined',
);
export const RttRoundedIcon = (props?: KTRawAttr) => {
  const s = _RttRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RttRoundedIcon = svg(
  svg('path', {
...
export const RttSharpIcon = (props?: KTRawAttr) => {
  const s = _RttSharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RttSharpIcon = svg(
  svg('path', {
    d: 'm9.03 3-1.11 7.07h2.62l.7-4.5h2.58L11.8 18.43H9.47L9.06 21h7.27l.4-2.57h-2.35l2-12.86h2.58l-.71 4.5h2.65L22 3zM8 5H4l-.31 2h4zm-.61 4h-4l-.31 2h4zm.92 8h-6L2 19h6zm.62-4h-6l-.31 2h6.01z',
  }),
  'RttSharp',
);
export const RttTwoToneIcon = (props?: KTRawAttr) => {
  const s = _RttTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RttTwoToneIcon = svg(
  svg('path', {
    d: 'm9.03 3-1.11 7.07h2.62l.7-4.5h2.58L11.8 18.43H9.47L9.06 21h7.27l.4-2.57h-2.35l2-12.86h2.58l-.71 4.5h2.65L22 3zM8 5H4l-.31 2h4zm-.61 4h-4l-.31 2h4zm.92 8h-6L2 19h6zm.62-4h-6l-.31 2h6.01z',
  }),
  'RttTwoTone',
);
export const RuleIcon = (props?: KTRawAttr) => {
  const s = _RuleIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RuleIcon = svg(
  svg('path', {
...
export const RuleFolderIcon = (props?: KTRawAttr) => {
  const s = _RuleFolderIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RuleFolderIcon = svg(
  svg('path', {
...
export const RuleFolderOutlinedIcon = (props?: KTRawAttr) => {
  const s = _RuleFolderOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RuleFolderOutlinedIcon = svg(
  svg('path', {
...
export const RuleFolderRoundedIcon = (props?: KTRawAttr) => {
  const s = _RuleFolderRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RuleFolderRoundedIcon = svg(
  svg('path', {
...
export const RuleFolderSharpIcon = (props?: KTRawAttr) => {
  const s = _RuleFolderSharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RuleFolderSharpIcon = svg(
  svg('path', {
...
export const RuleFolderTwoToneIcon = (props?: KTRawAttr) => {
  const s = _RuleFolderTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RuleFolderTwoToneIcon = svg(
  [
    svg(
      'path',
      {
...
export const RuleOutlinedIcon = (props?: KTRawAttr) => {
  const s = _RuleOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RuleOutlinedIcon = svg(
  svg('path', {
    d: 'M16.54 11 13 7.46l1.41-1.41 2.12 2.12 4.24-4.24 1.41 1.41zM11 7H2v2h9zm10 6.41L19.59 12 17 14.59 14.41 12 13 13.41 15.59 16 13 18.59 14.41 20 17 17.41 19.59 20 21 18.59 18.41 16zM11 15H2v2h9z',
  }),
  'RuleOutlined',
);
export const RuleRoundedIcon = (props?: KTRawAttr) => {
  const s = _RuleRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RuleRoundedIcon = svg(
  svg('path', {
...
export const RuleSharpIcon = (props?: KTRawAttr) => {
  const s = _RuleSharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RuleSharpIcon = svg(
  svg('path', {
    d: 'M16.54 11 13 7.46l1.41-1.41 2.12 2.12 4.24-4.24 1.41 1.41zM11 7H2v2h9zm10 6.41L19.59 12 17 14.59 14.41 12 13 13.41 15.59 16 13 18.59 14.41 20 17 17.41 19.59 20 21 18.59 18.41 16zM11 15H2v2h9z',
  }),
  'RuleSharp',
);
export const RuleTwoToneIcon = (props?: KTRawAttr) => {
  const s = _RuleTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RuleTwoToneIcon = svg(
  svg('path', {
    d: 'M16.54 11 13 7.46l1.41-1.41 2.12 2.12 4.24-4.24 1.41 1.41zM11 7H2v2h9zm10 6.41L19.59 12 17 14.59 14.41 12 13 13.41 15.59 16 13 18.59 14.41 20 17 17.41 19.59 20 21 18.59 18.41 16zM11 15H2v2h9z',
  }),
  'RuleTwoTone',
);
export const RunCircleIcon = (props?: KTRawAttr) => {
  const s = _RunCircleIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RunCircleIcon = svg(
  svg('path', {
...
export const RunCircleOutlinedIcon = (props?: KTRawAttr) => {
  const s = _RunCircleOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RunCircleOutlinedIcon = svg(
  [
    svg(
      'path',
      {
    ...
    svg('circle', { cx: '13.5', cy: '7', r: '1' }, '2'),
  ],
  'RunCircleOutlined',
);
export const RunCircleRoundedIcon = (props?: KTRawAttr) => {
  const s = _RunCircleRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RunCircleRoundedIcon = svg(
  svg('path', {
...
export const RunCircleSharpIcon = (props?: KTRawAttr) => {
  const s = _RunCircleSharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RunCircleSharpIcon = svg(
  svg('path', {
    d: 'M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2m1.5 4c.55 0 1 .45 1 1s-.45 1-1 1-1-.45-1-1 .45-1 1-1m2.5 6c-.7 0-2.01-.54-2.91-1.76l-.41 2.35L14 14.03V18h-1v-3.58l-1.11-1.21-.52 2.64-3.77-.77.2-.98 2.78.57.96-4.89-1.54.57V12H9V9.65l3.28-1.21c.49-.18 1.03.06 1.26.53.83 1.7 2.05 2.03 2.46 2.03z',
  }),
  'RunCircleSharp',
);
export const RunCircleTwoToneIcon = (props?: KTRawAttr) => {
  const s = _RunCircleTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RunCircleTwoToneIcon = svg(
  [
    svg(
      'path',
      {
    ...
    svg('circle', { cx: '13.5', cy: '7', r: '1' }, '3'),
  ],
  'RunCircleTwoTone',
);
export const RunningWithErrorsIcon = (props?: KTRawAttr) => {
  const s = _RunningWithErrorsIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RunningWithErrorsIcon = svg(
  svg('path', {
...
export const RunningWithErrorsOutlinedIcon = (props?: KTRawAttr) => {
  const s = _RunningWithErrorsOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RunningWithErrorsOutlinedIcon = svg(
  svg('path', {
    d: 'M22 10v8h-2v-8zm-2 10v2h2v-2zm-2-2.71C16.53 18.95 14.39 20 12 20c-4.41 0-8-3.59-8-8s3.59-8 8-8v9l7.55-7.55C17.72 3.34 15.02 2 12 2 6.48 2 2 6.48 2 12s4.48 10 10 10c2.25 0 4.33-.74 6-2z',
  }),
  'RunningWithErrorsOutlined',
);
export const RunningWithErrorsRoundedIcon = (props?: KTRawAttr) => {
  const s = _RunningWithErrorsRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RunningWithErrorsRoundedIcon = svg(
  svg('path', {
...
export const RunningWithErrorsSharpIcon = (props?: KTRawAttr) => {
  const s = _RunningWithErrorsSharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RunningWithErrorsSharpIcon = svg(
  svg('path', {
    d: 'M22 10v8h-2v-8zm-2 10v2h2v-2zm-2-2.71C16.53 18.95 14.39 20 12 20c-4.41 0-8-3.59-8-8s3.59-8 8-8v9l7.55-7.55C17.72 3.34 15.02 2 12 2 6.48 2 2 6.48 2 12s4.48 10 10 10c2.25 0 4.33-.74 6-2z',
  }),
  'RunningWithErrorsSharp',
);
export const RunningWithErrorsTwoToneIcon = (props?: KTRawAttr) => {
  const s = _RunningWithErrorsTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RunningWithErrorsTwoToneIcon = svg(
  svg('path', {
    d: 'M22 10v8h-2v-8zm-2 10v2h2v-2zm-2-2.71C16.53 18.95 14.39 20 12 20c-4.41 0-8-3.59-8-8s3.59-8 8-8v9l7.55-7.55C17.72 3.34 15.02 2 12 2 6.48 2 2 6.48 2 12s4.48 10 10 10c2.25 0 4.33-.74 6-2z',
  }),
  'RunningWithErrorsTwoTone',
);
export const RvHookupIcon = (props?: KTRawAttr) => {
  const s = _RvHookupIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RvHookupIcon = svg(
  svg('path', {
...
export const RvHookupOutlinedIcon = (props?: KTRawAttr) => {
  const s = _RvHookupOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RvHookupOutlinedIcon = svg(
  svg('path', {
    d: 'M20 17v-6c0-1.1-.9-2-2-2H7V7l-3 3 3 3v-2h4v3H4v3c0 1.1.9 2 2 2h2c0 1.66 1.34 3 3 3s3-1.34 3-3h8v-2zm-9 3c-.55 0-1-.45-1-1s.45-1 1-1 1 .45 1 1-.45 1-1 1m7-6h-4v-3h4zM17 2v2H9v2h8v2l3-3z',
  }),
  'RvHookupOutlined',
);
export const RvHookupRoundedIcon = (props?: KTRawAttr) => {
  const s = _RvHookupRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RvHookupRoundedIcon = svg(
  svg('path', {
...
export const RvHookupSharpIcon = (props?: KTRawAttr) => {
  const s = _RvHookupSharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RvHookupSharpIcon = svg(
  svg('path', {
...
export const RvHookupTwoToneIcon = (props?: KTRawAttr) => {
  const s = _RvHookupTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _RvHookupTwoToneIcon = svg(
  [
    svg(
      'path',
      {
