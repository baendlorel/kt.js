...
export const DIAGNOSTIC_UNUSED_LOCAL = 6133;
export const DIAGNOSTIC_LABEL_NOT_ALLOWED = 1344;
export const DIAGNOSTIC_UNUSED_LABEL = 7028;
export const DIAGNOSTIC_DRAFT_ESCAPE = 80001;
export const DIAGNOSTIC_KFOR_INVALID_MEMBER = 80002;
...
export const KFOR_TUPLE_PATTERN =
  /^\(\s*([A-Za-z_$][A-Za-z0-9_$]*)\s*,\s*([A-Za-z_$][A-Za-z0-9_$]*)\s*\)\s+(in|of)\s+([\s\S]+)$/;
