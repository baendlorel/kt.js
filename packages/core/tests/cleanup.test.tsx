...
describe('core cleanup lifecycle', () => {
  ...
  it('should cleanup event listeners when conditional branches are replaced', () => {
  ...
  it('should cleanup reactive attribute listeners when conditional branches are replaced', () => {
    const visible = ref(true);
  ...
  it('should cleanup k-model bindings when a branch is removed', () => {
    const visible = ref(true);
  ...
  it('should cleanup replaced reactive content nodes', () => {
    const onClick = vi.fn();
  ...
  it('should cleanup fragment subscriptions when removed by conditional replacement', () => {
    const visible = ref(true);
