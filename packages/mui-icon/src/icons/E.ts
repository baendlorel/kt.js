...
export const EMobiledataIcon = svg(svg("path", {
  d: "M16 9V7H8v10h8v-2h-6v-2h6v-2h-6V9z"
}), 'EMobiledata');
export const EMobiledataOutlinedIcon = svg(svg("path", {
  d: "M16 9V7H8v10h8v-2h-6v-2h6v-2h-6V9z"
}), 'EMobiledataOutlined');
export const EMobiledataRoundedIcon = svg(svg("path", {
...
export const EMobiledataSharpIcon = svg(svg("path", {
  d: "M16 9V7H8v10h8v-2h-6v-2h6v-2h-6V9z"
}), 'EMobiledataSharp');
export const EMobiledataTwoToneIcon = svg(svg("path", {
  d: "M16 9V7H8v10h8v-2h-6v-2h6v-2h-6V9z"
}), 'EMobiledataTwoTone');
export const EarbudsIcon = svg(svg("path", {
...
export const EarbudsBatteryIcon = svg(svg("path", {
...
export const EarbudsBatteryOutlinedIcon = svg(svg("path", {
...
export const EarbudsBatteryRoundedIcon = svg(svg("path", {
...
export const EarbudsBatterySharpIcon = svg(svg("path", {
...
export const EarbudsBatteryTwoToneIcon = svg([svg("path", {
  d: "M18 9h2v7h-2z",
  opacity: ".3"
}, "0"), svg("path", {
...
export const EarbudsOutlinedIcon = svg(svg("path", {
...
export const EarbudsRoundedIcon = svg(svg("path", {
  d: "M6.2 3.01C4.44 2.89 3 4.42 3 6.19V16c0 2.76 2.24 5 5 5s5-2.24 5-5V8c0-1.66 1.34-3 3-3s3 1.34 3 3v7h-.83c-1.61 0-3.06 1.18-3.17 2.79-.12 1.69 1.16 3.1 2.8 3.21 1.76.12 3.2-1.42 3.2-3.18V8c0-2.76-2.24-5-5-5s-5 2.24-5 5v8c0 1.66-1.34 3-3 3s-3-1.34-3-3V9h.83C7.44 9 8.89 7.82 9 6.21c.11-1.68-1.17-3.1-2.8-3.2"
}), 'EarbudsRounded');
export const EarbudsSharpIcon = svg([svg("path", {
  d: "M6.2 3.01C4.44 2.89 3 4.42 3 6.19V16c0 2.76 2.24 5 5 5s5-2.24 5-5V8c0-1.66 1.34-3 3-3s3 1.34 3 3v7h-.83c-1.61 0-3.06 1.18-3.17 2.79-.12 1.69 1.16 3.1 2.8 3.21 1.76.12 3.2-1.42 3.2-3.18V8c0-2.76-2.24-5-5-5s-5 2.24-5 5v8c0 1.66-1.34 3-3 3s-3-1.34-3-3V9h.83C7.44 9 8.89 7.82 9 6.21c.11-1.68-1.17-3.1-2.8-3.2"
}, "0"), svg("path", {
  d: "M6 3h3v6H6zm9 12h3v6h-3z"
}, "1")], 'EarbudsSharp');
export const EarbudsTwoToneIcon = svg([svg("path", {
  d: "M7 6c0-.55-.45-1-1-1s-1 .45-1 1v1h1c.55 0 1-.45 1-1m10 12c0 .55.45 1 1 1s1-.45 1-1v-1h-1c-.55 0-1 .45-1 1",
  opacity: ".3"
}, "0"), svg("path", {
  d: "M16 3c-2.76 0-5 2.24-5 5v8c0 1.66-1.34 3-3 3s-3-1.34-3-3V9h.83C7.44 9 8.89 7.82 9 6.21 9.12 4.52 7.84 3.11 6.2 3 4.44 2.89 3 4.42 3 6.19V16c0 2.76 2.24 5 5 5s5-2.24 5-5V8c0-1.66 1.34-3 3-3s3 1.34 3 3v7h-.83c-1.61 0-3.06 1.18-3.17 2.79-.12 1.69 1.16 3.1 2.8 3.21 1.76.12 3.2-1.42 3.2-3.18V8c0-2.76-2.24-5-5-5M5 6c0-.55.45-1 1-1s1 .45 1 1-.45 1-1 1H5zm14 12c0 .55-.45 1-1 1s-1-.45-1-1 .45-1 1-1h1z"
}, "1")], 'EarbudsTwoTone');
export const EastIcon = svg(svg("path", {
  d: "m15 5-1.41 1.41L18.17 11H2v2h16.17l-4.59 4.59L15 19l7-7z"
}), 'East');
export const EastOutlinedIcon = svg(svg("path", {
  d: "m15 5-1.41 1.41L18.17 11H2v2h16.17l-4.59 4.59L15 19l7-7z"
}), 'EastOutlined');
export const EastRoundedIcon = svg(svg("path", {
...
export const EastSharpIcon = svg(svg("path", {
  d: "m15 5-1.41 1.41L18.17 11H2v2h16.17l-4.59 4.59L15 19l7-7z"
}), 'EastSharp');
export const EastTwoToneIcon = svg(svg("path", {
  d: "m15 5-1.41 1.41L18.17 11H2v2h16.17l-4.59 4.59L15 19l7-7z"
}), 'EastTwoTone');
export const EdgesensorHighIcon = svg(svg("path", {
...
export const EdgesensorHighOutlinedIcon = svg(svg("path", {
...
export const EdgesensorHighRoundedIcon = svg(svg("path", {
...
export const EdgesensorHighSharpIcon = svg(svg("path", {
  d: "M3 7h2v7H3zm-3 3h2v7H0zm22-3h2v7h-2zm-3 3h2v7h-2zm-1-8H6v20h12zm-2 15H8V7h8z"
}), 'EdgesensorHighSharp');
export const EdgesensorHighTwoToneIcon = svg([svg("path", {
...
export const EdgesensorLowIcon = svg(svg("path", {
...
export const EdgesensorLowOutlinedIcon = svg(svg("path", {
...
export const EdgesensorLowRoundedIcon = svg(svg("path", {
...
export const EdgesensorLowSharpIcon = svg(svg("path", {
  d: "M2 7h2v7H2zm18 3h2v7h-2zM6 2v20h12V2zm10 15H8V7h8z"
}), 'EdgesensorLowSharp');
export const EdgesensorLowTwoToneIcon = svg([svg("path", {
  d: "M8 4h8v1H8zm0 15h8v1H8z",
  opacity: ".3"
}, "0"), svg("path", {
...
export const EditIcon = svg(svg("path", {
  d: "M3 17.25V21h3.75L17.81 9.94l-3.75-3.75zM20.71 7.04c.39-.39.39-1.02 0-1.41l-2.34-2.34a.996.996 0 0 0-1.41 0l-1.83 1.83 3.75 3.75z"
}), 'Edit');
export const EditAttributesIcon = svg(svg("path", {
...
export const EditAttributesOutlinedIcon = svg(svg("path", {
...
export const EditAttributesRoundedIcon = svg(svg("path", {
...
export const EditAttributesSharpIcon = svg(svg("path", {
  d: "M17.63 7H6.37C3.96 7 2 9.24 2 12s1.96 5 4.37 5h11.26c2.41 0 4.37-2.24 4.37-5s-1.96-5-4.37-5M7.24 14.46l-2.57-2.57.7-.7 1.87 1.87 3.52-3.52.7.7z"
}), 'EditAttributesSharp');
export const EditAttributesTwoToneIcon = svg([svg("path", {
...
export const EditCalendarIcon = svg(svg("path", {
...
export const EditCalendarOutlinedIcon = svg(svg("path", {
...
export const EditCalendarRoundedIcon = svg(svg("path", {
...
export const EditCalendarSharpIcon = svg(svg("path", {
...
export const EditCalendarTwoToneIcon = svg([svg("path", {
  d: "M5 6h14v2H5z",
  opacity: ".3"
}, "0"), svg("path", {
  d: "M5 10h14v2h2V6c0-1.1-.9-2-2-2h-1V2h-2v2H8V2H6v2H5c-1.11 0-1.99.9-1.99 2L3 20c0 1.1.89 2 2 2h7v-2H5zm0-4h14v2H5zm17.84 10.28-.71.71-2.12-2.12.71-.71c.39-.39 1.02-.39 1.41 0l.71.71c.39.39.39 1.02 0 1.41m-3.54-.7 2.12 2.12-5.3 5.3H14v-2.12z"
}, "1")], 'EditCalendarTwoTone');
export const EditDocumentIcon = svg(svg("path", {
...
export const EditLocationIcon = svg(svg("path", {
...
export const EditLocationAltIcon = svg([svg("path", {
...
export const EditLocationAltOutlinedIcon = svg(svg("path", {
...
export const EditLocationAltRoundedIcon = svg([svg("path", {
...
export const EditLocationAltSharpIcon = svg(svg("path", {
...
export const EditLocationAltTwoToneIcon = svg([svg("path", {
...
export const EditLocationOutlinedIcon = svg(svg("path", {
...
export const EditLocationRoundedIcon = svg(svg("path", {
...
export const EditLocationSharpIcon = svg(svg("path", {
...
export const EditLocationTwoToneIcon = svg([svg("path", {
...
export const EditNoteIcon = svg(svg("path", {
...
export const EditNoteOutlinedIcon = svg(svg("path", {
  d: "M3 10h11v2H3zm0-2h11V6H3zm0 8h7v-2H3zm15.01-3.13.71-.71c.39-.39 1.02-.39 1.41 0l.71.71c.39.39.39 1.02 0 1.41l-.71.71zm-.71.71-5.3 5.3V21h2.12l5.3-5.3z"
}), 'EditNoteOutlined');
export const EditNoteRoundedIcon = svg(svg("path", {
  d: "M14 11c0 .55-.45 1-1 1H4c-.55 0-1-.45-1-1s.45-1 1-1h9c.55 0 1 .45 1 1M3 7c0 .55.45 1 1 1h9c.55 0 1-.45 1-1s-.45-1-1-1H4c-.55 0-1 .45-1 1m7 8c0-.55-.45-1-1-1H4c-.55 0-1 .45-1 1s.45 1 1 1h5c.55 0 1-.45 1-1m8.01-2.13.71-.71c.39-.39 1.02-.39 1.41 0l.71.71c.39.39.39 1.02 0 1.41l-.71.71zm-.71.71-5.16 5.16c-.09.09-.14.21-.14.35v1.41c0 .28.22.5.5.5h1.41c.13 0 .26-.05.35-.15l5.16-5.16z"
}), 'EditNoteRounded');
export const EditNoteSharpIcon = svg(svg("path", {
  d: "M3 10h11v2H3zm0-2h11V6H3zm0 8h7v-2H3zm15.01-3.13 1.41-1.41 2.12 2.12-1.41 1.41zm-.71.71-5.3 5.3V21h2.12l5.3-5.3z"
}), 'EditNoteSharp');
export const EditNoteTwoToneIcon = svg(svg("path", {
  d: "M3 10h11v2H3zm0-2h11V6H3zm0 8h7v-2H3zm15.01-3.13.71-.71c.39-.39 1.02-.39 1.41 0l.71.71c.39.39.39 1.02 0 1.41l-.71.71zm-.71.71-5.3 5.3V21h2.12l5.3-5.3z"
}), 'EditNoteTwoTone');
export const EditNotificationsIcon = svg(svg("path", {
...
export const EditNotificationsOutlinedIcon = svg(svg("path", {
...
export const EditNotificationsRoundedIcon = svg(svg("path", {
...
export const EditNotificationsSharpIcon = svg(svg("path", {
...
export const EditOffOutlinedIcon = svg(svg("path", {
...
export const EditOffRoundedIcon = svg(svg("path", {
...
export const EditOffSharpIcon = svg(svg("path", {
...
export const EditOffTwoToneIcon = svg([svg("path", {
  d: "M5 18.08V19h.92l5.12-5.12-.92-.92zm9.06-9.06-1.11 1.11.92.92 1.11-1.11z",
  opacity: ".3"
}, "0"), svg("path", {
  d: "m14.06 9.02.92.92-1.11 1.11 1.41 1.41 2.52-2.52-3.75-3.75-2.52 2.52 1.41 1.41zm6.65-1.98c.39-.39.39-1.02 0-1.41l-2.34-2.34c-.2-.2-.45-.29-.71-.29s-.51.1-.7.29l-1.83 1.83 3.75 3.75zM2.81 2.81 1.39 4.22l7.32 7.32L3 17.25V21h3.75l5.71-5.71 7.32 7.32 1.41-1.41zM5.92 19H5v-.92l5.13-5.13.92.92z"
}, "1")], 'EditOffTwoTone');
export const EditOutlinedIcon = svg(svg("path", {
...
export const EditRoadIcon = svg(svg("path", {
...
export const EditRoadOutlinedIcon = svg(svg("path", {
  d: "M18 4h-2v7.9l2-2zM4 4h2v16H4zm6 0h2v4h-2zm0 6h2v4h-2zm0 6h2v4h-2zm12.56-3.41-1.15-1.15c-.59-.59-1.54-.59-2.12 0L14 16.73V20h3.27l5.29-5.29c.59-.59.59-1.54 0-2.12m-5.98 5.86h-1.03v-1.03L19 13.97 20.03 15z"
}), 'EditRoadOutlined');
export const EditRoadRoundedIcon = svg(svg("path", {
...
export const EditRoadSharpIcon = svg(svg("path", {
  d: "M18 4h-2v7.9l2-2zM4 4h2v16H4zm6 0h2v4h-2zm0 6h2v4h-2zm0 6h2v4h-2zm12.56-3.41-1.15-1.15c-.59-.59-1.54-.59-2.12 0L14 16.73V20h3.27l5.29-5.29c.59-.59.59-1.54 0-2.12m-5.98 5.86h-1.03v-1.03L19 13.97 20.03 15z"
}), 'EditRoadSharp');
export const EditRoadTwoToneIcon = svg([svg("path", {
  d: "M15.55 17.42v1.03h1.03L20.03 15 19 13.97z",
  opacity: ".3"
}, "0"), svg("path", {
  d: "M18 4h-2v7.9l2-2zM4 4h2v16H4zm6 0h2v4h-2zm0 6h2v4h-2zm0 6h2v4h-2zm12.56-3.41-1.15-1.15c-.59-.59-1.54-.59-2.12 0L14 16.73V20h3.27l5.29-5.29c.59-.59.59-1.54 0-2.12m-5.98 5.86h-1.03v-1.03L19 13.97 20.03 15z"
}, "1")], 'EditRoadTwoTone');
export const EditRoundedIcon = svg(svg("path", {
...
export const EditTwoToneIcon = svg([svg("path", {
...
export const EggIcon = svg(svg("path", {
...
export const EggAltIcon = svg(svg("path", {
...
export const EggAltOutlinedIcon = svg([svg("path", {
...
export const EggAltRoundedIcon = svg(svg("path", {
  d: "M19 9c-2-2-3.01-7-9.03-7C4.95 2 1.94 6 2 11.52S6.96 19 9.97 19c2.01 0 2.01 3 6.02 3C19 22 22 19 22 15.02 22 12 21.01 11 19 9m-7 6.5c-1.93 0-3.5-1.57-3.5-3.5s1.57-3.5 3.5-3.5 3.5 1.57 3.5 3.5-1.57 3.5-3.5 3.5"
}), 'EggAltRounded');
export const EggAltSharpIcon = svg(svg("path", {
  d: "M19 9c-2-2-3.01-7-9.03-7C4.95 2 1.94 6 2 11.52S6.96 19 9.97 19c2.01 0 2.01 3 6.02 3C19 22 22 19 22 15.02 22 12 21.01 11 19 9m-7 6.5c-1.93 0-3.5-1.57-3.5-3.5s1.57-3.5 3.5-3.5 3.5 1.57 3.5 3.5-1.57 3.5-3.5 3.5"
}), 'EggAltSharp');
export const EggAltTwoToneIcon = svg([svg("path", {
...
export const EggOutlinedIcon = svg([svg("path", {
...
export const EggRoundedIcon = svg(svg("path", {
  d: "M12 3C8.5 3 5 9.33 5 14c0 3.87 3.13 7 7 7s7-3.13 7-7c0-4.67-3.5-11-7-11m1 15c-3 0-5-1.99-5-5 0-.55.45-1 1-1s1 .45 1 1c0 2.92 2.42 3 3 3 .55 0 1 .45 1 1s-.45 1-1 1"
}), 'EggRounded');
export const EggSharpIcon = svg(svg("path", {
...
export const EggTwoToneIcon = svg([svg("path", {
...
export const EightKIcon = svg(svg("path", {
...
export const EightKOutlinedIcon = svg([svg("path", {
...
export const EightKPlusIcon = svg(svg("path", {
...
export const EightKPlusOutlinedIcon = svg([svg("path", {
...
export const EightKPlusRoundedIcon = svg([svg("path", {
...
export const EightKPlusSharpIcon = svg(svg("path", {
...
export const EightKPlusTwoToneIcon = svg([svg("path", {
  d: "M7.5 12.5h1V14h-1zm0-2.5h1v1.5h-1z",
  opacity: ".3"
}, "0"), svg("path", {
...
export const EightKRoundedIcon = svg(svg("path", {
...
export const EightKSharpIcon = svg(svg("path", {
...
export const EightKTwoToneIcon = svg([svg("path", {
...
export const EightMpIcon = svg(svg("path", {
...
export const EightMpOutlinedIcon = svg([svg("path", {
...
export const EightMpRoundedIcon = svg([svg("path", {
...
export const EightMpSharpIcon = svg([svg("path", {
...
export const EightMpTwoToneIcon = svg([svg("path", {
...
export const EighteenMpIcon = svg(svg("path", {
...
export const EighteenMpOutlinedIcon = svg([svg("path", {
  d: "M7.5 14h1v3H10v-3h1v4.5h1.5v-5c0-.55-.45-1-1-1H7c-.55 0-1 .45-1 1v5h1.5zm6 4.5H15V17h2c.55 0 1-.45 1-1v-2.5c0-.55-.45-1-1-1h-3.5zM15 14h1.5v1.5H15z"
}, "0"), svg("path", {
  d: "M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2m0 16H5V5h14z"
}, "1"), svg("path", {
...
export const EighteenMpRoundedIcon = svg([svg("path", {
...
export const EighteenMpSharpIcon = svg([svg("path", {
...
export const EighteenMpTwoToneIcon = svg([svg("path", {
...
export const EighteenUpRatingIcon = svg([svg("path", {
...
export const EighteenUpRatingOutlinedIcon = svg([svg("path", {
...
export const EighteenUpRatingRoundedIcon = svg([svg("path", {
  d: "M13 12.5h1.5V14H13zm0-2.5h1.5v1.5H13z"
}, "0"), svg("path", {
...
export const EighteenUpRatingSharpIcon = svg([svg("path", {
  d: "M13 12.5h1.5V14H13zm0-2.5h1.5v1.5H13z"
}, "0"), svg("path", {
...
export const EighteenUpRatingTwoToneIcon = svg([svg("path", {
...
export const EightteenMpIcon = svg(svg("path", {
...
export const EightteenMpOutlinedIcon = svg([svg("path", {
...
export const EightteenMpRoundedIcon = svg([svg("path", {
  d: "M13.5 9H15v1.5h-1.5z"
}, "0"), svg("path", {
...
export const EightteenMpSharpIcon = svg([svg("path", {
  d: "M13.5 9H15v1.5h-1.5zm0-2.5H15V8h-1.5z"
}, "0"), svg("path", {
...
export const EightteenMpTwoToneIcon = svg([svg("path", {
  d: "M13.5 6.5H15V8h-1.5zm0 2.5H15v1.5h-1.5z",
  opacity: ".3"
}, "0"), svg("path", {
...
export const EjectIcon = svg(svg("path", {
  d: "M5 17h14v2H5zm7-12L5.33 15h13.34z"
}), 'Eject');
export const EjectOutlinedIcon = svg(svg("path", {
  d: "M5 17h14v2H5zm7-12L5.33 15h13.34zm0 3.6 2.93 4.4H9.07z"
}), 'EjectOutlined');
export const EjectRoundedIcon = svg(svg("path", {
...
export const EjectSharpIcon = svg(svg("path", {
  d: "M5 17h14v2H5zm7-12L5.33 15h13.34z"
}), 'EjectSharp');
export const EjectTwoToneIcon = svg([svg("path", {
  d: "M12 8.6 9.07 13h5.86z",
  opacity: ".3"
}, "0"), svg("path", {
  d: "M5 17h14v2H5zm7-12L5.33 15h13.34zm0 3.6 2.93 4.4H9.07z"
}, "1")], 'EjectTwoTone');
export const ElderlyIcon = svg(svg("path", {
...
export const ElderlyOutlinedIcon = svg(svg("path", {
  d: "M13.5 5.5c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2m6.5 7V23h-1V12.5c0-.28-.22-.5-.5-.5s-.5.22-.5.5v1h-1v-.69c-1.46-.38-2.7-1.29-3.51-2.52-.31.87-.49 1.78-.49 2.71 0 .23.02.46.03.69L15 16.5V23h-2v-5l-1.78-2.54L11 19l-3 4-1.6-1.2L9 18.33V13c0-1.15.18-2.29.5-3.39l-1.5.85V14H6V9.3l5.4-3.07v.01c.59-.31 1.32-.33 1.94.03.36.21.63.51.8.85l.79 1.67C15.58 10.1 16.94 11 18.5 11c.83 0 1.5.67 1.5 1.5"
}), 'ElderlyOutlined');
export const ElderlyRoundedIcon = svg(svg("path", {
...
export const ElderlySharpIcon = svg(svg("path", {
  d: "M13.5 5.5c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2m6.5 7V23h-1V12.5c0-.28-.22-.5-.5-.5s-.5.22-.5.5v1h-1v-.69c-1.46-.38-2.7-1.29-3.51-2.52-.31.87-.49 1.78-.49 2.71 0 .23.02.46.03.69L15 16.5V23h-2v-5l-1.78-2.54L11 19l-3 4-1.6-1.2L9 18.33V13c0-1.15.18-2.29.5-3.39l-1.5.85V14H6V9.3l5.4-3.07v.01c.59-.31 1.32-.33 1.94.03.36.21.63.51.8.85l.79 1.67C15.58 10.1 16.94 11 18.5 11c.83 0 1.5.67 1.5 1.5"
}), 'ElderlySharp');
export const ElderlyTwoToneIcon = svg(svg("path", {
  d: "M13.5 5.5c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2m6.5 7V23h-1V12.5c0-.28-.22-.5-.5-.5s-.5.22-.5.5v1h-1v-.69c-1.46-.38-2.7-1.29-3.51-2.52-.31.87-.49 1.78-.49 2.71 0 .23.02.46.03.69L15 16.5V23h-2v-5l-1.78-2.54L11 19l-3 4-1.6-1.2L9 18.33V13c0-1.15.18-2.29.5-3.39l-1.5.85V14H6V9.3l5.4-3.07v.01c.59-.31 1.32-.33 1.94.03.36.21.63.51.8.85l.79 1.67C15.58 10.1 16.94 11 18.5 11c.83 0 1.5.67 1.5 1.5"
}), 'ElderlyTwoTone');
export const ElderlyWomanIcon = svg(svg("path", {
...
export const ElderlyWomanOutlinedIcon = svg(svg("path", {
  d: "M18.5 11c-1.56 0-2.92-.9-3.58-2.21l-.79-1.67C14.12 7.1 13.63 6 12.34 6 8.72 6 6 16.69 6 19h2.5l-2.1 2.8L8 23l3-4h2v4h2v-4.03L13 13l.49-2.71c.81 1.23 2.05 2.14 3.51 2.52v.69h1v-1c0-.28.22-.5.5-.5s.5.22.5.5V23h1V12.5c0-.83-.67-1.5-1.5-1.5m-6.9-8.09c-.06.19-.1.38-.1.59 0 1.1.9 2 2 2s2-.9 2-2-.9-2-2-2c-.21 0-.4.04-.59.1-.15-.35-.5-.6-.91-.6-.55 0-1 .45-1 1 0 .41.25.76.6.91"
}), 'ElderlyWomanOutlined');
export const ElderlyWomanRoundedIcon = svg(svg("path", {
...
export const ElderlyWomanSharpIcon = svg(svg("path", {
  d: "M18.5 11c-1.56 0-2.92-.9-3.58-2.21l-.79-1.67C14.12 7.1 13.63 6 12.34 6 8.72 6 6 16.69 6 19h2.5l-2.1 2.8L8 23l3-4h2v4h2v-4.03L13 13l.49-2.71c.81 1.23 2.05 2.14 3.51 2.52v.69h1v-1c0-.28.22-.5.5-.5s.5.22.5.5V23h1V12.5c0-.83-.67-1.5-1.5-1.5m-6.9-8.09c-.06.19-.1.38-.1.59 0 1.1.9 2 2 2s2-.9 2-2-.9-2-2-2c-.21 0-.4.04-.59.1-.15-.35-.5-.6-.91-.6-.55 0-1 .45-1 1 0 .41.25.76.6.91"
}), 'ElderlyWomanSharp');
export const ElderlyWomanTwoToneIcon = svg(svg("path", {
  d: "M18.5 11c-1.56 0-2.92-.9-3.58-2.21l-.79-1.67C14.12 7.1 13.63 6 12.34 6 8.72 6 6 16.69 6 19h2.5l-2.1 2.8L8 23l3-4h2v4h2v-4.03L13 13l.49-2.71c.81 1.23 2.05 2.14 3.51 2.52v.69h1v-1c0-.28.22-.5.5-.5s.5.22.5.5V23h1V12.5c0-.83-.67-1.5-1.5-1.5m-6.9-8.09c-.06.19-.1.38-.1.59 0 1.1.9 2 2 2s2-.9 2-2-.9-2-2-2c-.21 0-.4.04-.59.1-.15-.35-.5-.6-.91-.6-.55 0-1 .45-1 1 0 .41.25.76.6.91"
}), 'ElderlyWomanTwoTone');
export const ElectricBikeIcon = svg(svg("path", {
...
export const ElectricBikeOutlinedIcon = svg(svg("path", {
  d: "M19 7h-.82l-1.7-4.68C16.19 1.53 15.44 1 14.6 1H12v2h2.6l1.46 4h-4.81l-.36-1H12V4H7v2h1.75l1.82 5H9.9c-.44-2.23-2.31-3.88-4.65-3.99C2.45 6.87 0 9.2 0 12s2.2 5 5 5c2.46 0 4.45-1.69 4.9-4h4.2c.44 2.23 2.31 3.88 4.65 3.99 2.8.13 5.25-2.19 5.25-5C24 9.2 21.8 7 19 7M7.82 13c-.4 1.17-1.49 2-2.82 2-1.68 0-3-1.32-3-3s1.32-3 3-3c1.33 0 2.42.83 2.82 2H5v2zm6.28-2h-1.4l-.73-2H15c-.44.58-.76 1.25-.9 2m4.9 4c-1.68 0-3-1.32-3-3 0-.93.41-1.73 1.05-2.28l.96 2.64 1.88-.68-.97-2.67c.02 0 .05-.01.08-.01 1.68 0 3 1.32 3 3s-1.32 3-3 3m-8 5H7l6 3v-2h4l-6-3z"
}), 'ElectricBikeOutlined');
export const ElectricBikeRoundedIcon = svg(svg("path", {
...
export const ElectricBikeSharpIcon = svg(svg("path", {
...
export const ElectricBikeTwoToneIcon = svg(svg("path", {
  d: "M19 7h-.82l-1.7-4.68C16.19 1.53 15.44 1 14.6 1H12v2h2.6l1.46 4h-4.81l-.36-1H12V4H7v2h1.75l1.82 5H9.9c-.44-2.23-2.31-3.88-4.65-3.99C2.45 6.87 0 9.2 0 12s2.2 5 5 5c2.46 0 4.45-1.69 4.9-4h4.2c.44 2.23 2.31 3.88 4.65 3.99 2.8.13 5.25-2.19 5.25-5C24 9.2 21.8 7 19 7M7.82 13c-.4 1.17-1.49 2-2.82 2-1.68 0-3-1.32-3-3s1.32-3 3-3c1.33 0 2.42.83 2.82 2H5v2zm6.28-2h-1.4l-.73-2H15c-.44.58-.76 1.25-.9 2m4.9 4c-1.68 0-3-1.32-3-3 0-.93.41-1.73 1.05-2.28l.96 2.64 1.88-.68-.97-2.67c.02 0 .05-.01.08-.01 1.68 0 3 1.32 3 3s-1.32 3-3 3m-8 5H7l6 3v-2h4l-6-3z"
}), 'ElectricBikeTwoTone');
export const ElectricBoltIcon = svg(svg("path", {
...
export const ElectricBoltOutlinedIcon = svg(svg("path", {
  d: "M14.69 2.21 4.33 11.49c-.64.58-.28 1.65.58 1.73L13 14l-4.85 6.76c-.22.31-.19.74.08 1.01.3.3.77.31 1.08.02l10.36-9.28c.64-.58.28-1.65-.58-1.73L11 10l4.85-6.76c.22-.31.19-.74-.08-1.01-.3-.3-.77-.31-1.08-.02"
}), 'ElectricBoltOutlined');
export const ElectricBoltRoundedIcon = svg(svg("path", {
  d: "M14.69 2.21 4.33 11.49c-.64.58-.28 1.65.58 1.73L13 14l-4.85 6.76c-.22.31-.19.74.08 1.01.3.3.77.31 1.08.02l10.36-9.28c.64-.58.28-1.65-.58-1.73L11 10l4.85-6.76c.22-.31.19-.74-.08-1.01-.3-.3-.77-.31-1.08-.02"
}), 'ElectricBoltRounded');
export const ElectricBoltSharpIcon = svg(svg("path", {
  d: "M15 2 2.5 13 13 14l-5 7 1 1 12.5-11L11 10l5-7z"
}), 'ElectricBoltSharp');
export const ElectricBoltTwoToneIcon = svg(svg("path", {
  d: "M14.69 2.21 4.33 11.49c-.64.58-.28 1.65.58 1.73L13 14l-4.85 6.76c-.22.31-.19.74.08 1.01.3.3.77.31 1.08.02l10.36-9.28c.64-.58.28-1.65-.58-1.73L11 10l4.85-6.76c.22-.31.19-.74-.08-1.01-.3-.3-.77-.31-1.08-.02"
}), 'ElectricBoltTwoTone');
export const ElectricCarIcon = svg(svg("path", {
...
export const ElectricCarOutlinedIcon = svg([svg("path", {
...
export const ElectricCarRoundedIcon = svg(svg("path", {
...
export const ElectricCarSharpIcon = svg(svg("path", {
...
export const ElectricCarTwoToneIcon = svg([svg("path", {
...
export const ElectricMeterIcon = svg(svg("path", {
...
export const ElectricMeterOutlinedIcon = svg([svg("path", {
...
export const ElectricMeterRoundedIcon = svg(svg("path", {
...
export const ElectricMeterSharpIcon = svg(svg("path", {
  d: "M12 2c-4.96 0-9 4.04-9 9 0 3.91 2.51 7.24 6 8.47V22h2v-2.06c.33.04.66.06 1 .06s.67-.02 1-.06V22h2v-2.53c3.49-1.24 6-4.57 6-8.47 0-4.96-4.04-9-9-9m2.25 12-3 3-1.5-1.5L11 14.25 9.75 13l3-3 1.5 1.5L13 12.75zM16 9H8V7h8z"
}), 'ElectricMeterSharp');
export const ElectricMeterTwoToneIcon = svg([svg("path", {
...
export const ElectricMopedIcon = svg([svg("path", {
...
export const ElectricMopedOutlinedIcon = svg([svg("path", {
...
export const ElectricMopedRoundedIcon = svg([svg("path", {
...
export const ElectricMopedSharpIcon = svg([svg("path", {
...
export const ElectricMopedTwoToneIcon = svg([svg("path", {
...
export const ElectricRickshawIcon = svg(svg("path", {
...
export const ElectricRickshawOutlinedIcon = svg(svg("path", {
...
export const ElectricRickshawRoundedIcon = svg(svg("path", {
...
export const ElectricRickshawSharpIcon = svg(svg("path", {
...
export const ElectricRickshawTwoToneIcon = svg([svg("path", {
...
export const ElectricScooterIcon = svg([svg("path", {
...
export const ElectricScooterOutlinedIcon = svg([svg("path", {
  d: "M7.82 16H15v-1c0-2.21 1.79-4 4-4h.74l-1.9-8.44C17.63 1.65 16.82 1 15.89 1H12v2h3.89l1.4 6.25h-.01c-2.16.65-3.81 2.48-4.19 4.75H7.82c-.48-1.34-1.86-2.24-3.42-1.94-1.18.23-2.13 1.2-2.35 2.38C1.7 16.34 3.16 18 5 18c1.3 0 2.4-.84 2.82-2M5 16c-.55 0-1-.45-1-1s.45-1 1-1 1 .45 1 1-.45 1-1 1"
}, "0"), svg("path", {
  d: "M19 12c-1.66 0-3 1.34-3 3s1.34 3 3 3 3-1.34 3-3-1.34-3-3-3m0 4c-.55 0-1-.45-1-1s.45-1 1-1 1 .45 1 1-.45 1-1 1m-8 4H7l6 3v-2h4l-6-3z"
}, "1")], 'ElectricScooterOutlined');
export const ElectricScooterRoundedIcon = svg([svg("path", {
...
export const ElectricScooterSharpIcon = svg([svg("path", {
...
export const ElectricScooterTwoToneIcon = svg([svg("path", {
  d: "M7.82 16H15v-1c0-2.21 1.79-4 4-4h.74l-1.9-8.44C17.63 1.65 16.82 1 15.89 1H12v2h3.89l1.4 6.25h-.01c-2.16.65-3.81 2.48-4.19 4.75H7.82c-.48-1.34-1.86-2.24-3.42-1.94-1.18.23-2.13 1.2-2.35 2.38C1.7 16.34 3.16 18 5 18c1.3 0 2.4-.84 2.82-2M5 16c-.55 0-1-.45-1-1s.45-1 1-1 1 .45 1 1-.45 1-1 1"
}, "0"), svg("path", {
  d: "M19 12c-1.66 0-3 1.34-3 3s1.34 3 3 3 3-1.34 3-3-1.34-3-3-3m0 4c-.55 0-1-.45-1-1s.45-1 1-1 1 .45 1 1-.45 1-1 1m-8 4H7l6 3v-2h4l-6-3z"
}, "1")], 'ElectricScooterTwoTone');
export const ElectricalServicesIcon = svg([svg("path", {
...
export const ElectricalServicesOutlinedIcon = svg([svg("path", {
  d: "M21 14c0-.55-.45-1-1-1h-2v2h2c.55 0 1-.45 1-1m-1 3h-2v2h2c.55 0 1-.45 1-1s-.45-1-1-1m-8-3h-2v4h2c0 1.1.9 2 2 2h3v-8h-3c-1.1 0-2 .9-2 2"
}, "0"), svg("path", {
  d: "M5 13c0-1.1.9-2 2-2h1.5c1.93 0 3.5-1.57 3.5-3.5S10.43 4 8.5 4H5c-.55 0-1 .45-1 1s.45 1 1 1h3.5c.83 0 1.5.67 1.5 1.5S9.33 9 8.5 9H7c-2.21 0-4 1.79-4 4s1.79 4 4 4h2v-2H7c-1.1 0-2-.9-2-2"
}, "1")], 'ElectricalServicesOutlined');
export const ElectricalServicesRoundedIcon = svg(svg("path", {
...
export const ElectricalServicesSharpIcon = svg([svg("path", {
  d: "M18 13h3v2h-3zm-6-1v2h-2v4h2v2h5v-8z"
}, "0"), svg("path", {
  d: "M5 11h7V4H4v2h6v3H3v8h6v-2H5zm13 6h3v2h-3z"
}, "1")], 'ElectricalServicesSharp');
export const ElectricalServicesTwoToneIcon = svg([svg("path", {
...
export const ElevatorIcon = svg(svg("path", {
...
export const ElevatorOutlinedIcon = svg(svg("path", {
...
export const ElevatorRoundedIcon = svg(svg("path", {
...
export const ElevatorSharpIcon = svg(svg("path", {
...
export const ElevatorTwoToneIcon = svg([svg("path", {
...
export const ElevenMpIcon = svg(svg("path", {
...
export const ElevenMpOutlinedIcon = svg([svg("path", {
  d: "M7.5 14h1v3H10v-3h1v4.5h1.5v-5c0-.55-.45-1-1-1H7c-.55 0-1 .45-1 1v5h1.5zm6 4.5H15V17h2c.55 0 1-.45 1-1v-2.5c0-.55-.45-1-1-1h-3.5zM15 14h1.5v1.5H15z"
}, "0"), svg("path", {
  d: "M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2m0 16H5V5h14z"
}, "1"), svg("path", {
...
export const ElevenMpRoundedIcon = svg([svg("path", {
...
export const ElevenMpSharpIcon = svg([svg("path", {
...
export const ElevenMpTwoToneIcon = svg([svg("path", {
...
export const EmailSharpIcon = svg(svg("path", {
  d: "M22 4H2v16h20zm-2 4-8 5-8-5V6l8 5 8-5z"
}), 'EmailSharp');
export const EmailTwoToneIcon = svg([svg("path", {
...
export const EmergencyIcon = svg(svg("path", {
...
export const EmergencyOutlinedIcon = svg(svg("path", {
...
export const EmergencyRecordingIcon = svg(svg("path", {
...
export const EmergencyRecordingOutlinedIcon = svg(svg("path", {
...
export const EmergencyRecordingRoundedIcon = svg(svg("path", {
...
export const EmergencyRecordingSharpIcon = svg(svg("path", {
...
export const EmergencyRecordingTwoToneIcon = svg([svg("path", {
...
export const EmergencyRoundedIcon = svg(svg("path", {
...
export const EmergencyShareIcon = svg(svg("path", {
...
export const EmergencyShareOutlinedIcon = svg(svg("path", {
...
export const EmergencyShareRoundedIcon = svg(svg("path", {
...
export const EmergencyShareSharpIcon = svg(svg("path", {
  d: "M12 9c-3.15 0-6 2.41-6 6.15q0 3.735 6 8.85 6-5.115 6-8.85C18 11.41 15.15 9 12 9m0 7.5c-.83 0-1.5-.67-1.5-1.5s.67-1.5 1.5-1.5 1.5.67 1.5 1.5-.67 1.5-1.5 1.5M12 4c1.93 0 3.68.78 4.95 2.05l-1.41 1.41C14.63 6.56 13.38 6 12 6s-2.63.56-3.54 1.46L7.05 6.05C8.32 4.78 10.07 4 12 4m7.78-.77-1.41 1.41C16.74 3.01 14.49 2 12.01 2S7.27 3.01 5.64 4.63L4.22 3.22C6.22 1.23 8.97 0 12.01 0s5.78 1.23 7.77 3.23"
}), 'EmergencyShareSharp');
export const EmergencyShareTwoToneIcon = svg([svg("path", {
...
export const EmergencySharpIcon = svg(svg("path", {
  d: "m20.79 9.23-2-3.46L14 8.54V3h-4v5.54L5.21 5.77l-2 3.46L8 12l-4.79 2.77 2 3.46L10 15.46V21h4v-5.54l4.79 2.77 2-3.46L16 12z"
}), 'EmergencySharp');
export const EmergencyTwoToneIcon = svg([svg("path", {
...
export const EmojiEmotionsIcon = svg(svg("path", {
...
export const EmojiEmotionsOutlinedIcon = svg([svg("circle", {
  cx: "15.5",
  cy: "9.5",
  r: "1.5"
}, "0"), svg("circle", {
...
export const EmojiEmotionsRoundedIcon = svg(svg("path", {
...
export const EmojiEmotionsSharpIcon = svg(svg("path", {
  d: "M11.99 2C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2M8.5 8c.83 0 1.5.67 1.5 1.5S9.33 11 8.5 11 7 10.33 7 9.5 7.67 8 8.5 8M12 18c-2.28 0-4.22-1.66-5-4h10c-.78 2.34-2.72 4-5 4m3.5-7c-.83 0-1.5-.67-1.5-1.5S14.67 8 15.5 8s1.5.67 1.5 1.5-.67 1.5-1.5 1.5"
}), 'EmojiEmotionsSharp');
export const EmojiEmotionsTwoToneIcon = svg([svg("path", {
...
export const EmojiEventsIcon = svg(svg("path", {
...
export const EmojiEventsOutlinedIcon = svg(svg("path", {
...
export const EmojiEventsRoundedIcon = svg(svg("path", {
...
export const EmojiEventsSharpIcon = svg(svg("path", {
  d: "M19 5h-2V3H7v2H5c-1.1 0-2 .9-2 2v1c0 2.55 1.92 4.63 4.39 4.94.63 1.5 1.98 2.63 3.61 2.96V19H7v2h10v-2h-4v-3.1c1.63-.33 2.98-1.46 3.61-2.96C19.08 12.63 21 10.55 21 8V7c0-1.1-.9-2-2-2M5 8V7h2v3.82C5.84 10.4 5 9.3 5 8m14 0c0 1.3-.84 2.4-2 2.82V7h2z"
}), 'EmojiEventsSharp');
export const EmojiEventsTwoToneIcon = svg([svg("path", {
  d: "M12 14c-1.65 0-3-1.35-3-3V5h6v6c0 1.65-1.35 3-3 3",
  opacity: ".3"
}, "0"), svg("path", {
  d: "M19 5h-2V3H7v2H5c-1.1 0-2 .9-2 2v1c0 2.55 1.92 4.63 4.39 4.94.63 1.5 1.98 2.63 3.61 2.96V19H7v2h10v-2h-4v-3.1c1.63-.33 2.98-1.46 3.61-2.96C19.08 12.63 21 10.55 21 8V7c0-1.1-.9-2-2-2M5 8V7h2v3.82C5.84 10.4 5 9.3 5 8m7 6c-1.65 0-3-1.35-3-3V5h6v6c0 1.65-1.35 3-3 3m7-6c0 1.3-.84 2.4-2 2.82V7h2z"
}, "1")], 'EmojiEventsTwoTone');
export const EmojiFlagsIcon = svg(svg("path", {
...
export const EmojiFlagsOutlinedIcon = svg(svg("path", {
  d: "m14 9-1-2H7V5.72c.6-.34 1-.98 1-1.72 0-1.1-.9-2-2-2s-2 .9-2 2c0 .74.4 1.38 1 1.72V21h2v-4h5l1 2h7V9h-6zm4 8h-4l-1-2H7V9h5l1 2h5v6z"
}), 'EmojiFlagsOutlined');
export const EmojiFlagsRoundedIcon = svg(svg("path", {
...
export const EmojiFlagsSharpIcon = svg(svg("path", {
  d: "m14 9-1-2H7V5.72c.6-.34 1-.98 1-1.72 0-1.1-.9-2-2-2s-2 .9-2 2c0 .74.4 1.38 1 1.72V21h2v-4h5l1 2h7V9h-6zm4 8h-4l-1-2H7V9h5l1 2h5v6z"
}), 'EmojiFlagsSharp');
export const EmojiFlagsTwoToneIcon = svg([svg("path", {
  d: "M12 9H7v6h6l1 2h4v-6h-5z",
  opacity: ".3"
}, "0"), svg("path", {
  d: "m14 9-1-2H7V5.72c.6-.34 1-.98 1-1.72 0-1.1-.9-2-2-2s-2 .9-2 2c0 .74.4 1.38 1 1.72V21h2v-4h5l1 2h7V9h-6zm4 8h-4l-1-2H7V9h5l1 2h5v6z"
}, "1")], 'EmojiFlagsTwoTone');
export const EmojiFoodBeverageIcon = svg(svg("path", {
...
export const EmojiFoodBeverageOutlinedIcon = svg(svg("path", {
...
export const EmojiFoodBeverageRoundedIcon = svg(svg("path", {
...
export const EmojiFoodBeverageSharpIcon = svg(svg("path", {
...
export const EmojiFoodBeverageTwoToneIcon = svg([svg("path", {
...
export const EmojiNatureIcon = svg(svg("path", {
...
export const EmojiNatureOutlinedIcon = svg(svg("path", {
...
export const EmojiNatureRoundedIcon = svg(svg("path", {
...
export const EmojiNatureSharpIcon = svg(svg("path", {
  d: "M21.94 4.88c-.18-.53-.69-.88-1.26-.88H19.6l-.31-.97C19.15 2.43 18.61 2 18 2s-1.15.43-1.29 1.04L16.4 4h-1.07c-.57 0-1.08.35-1.26.88-.19.56.04 1.17.56 1.48l.87.52-.4 1.24c-.23.58-.04 1.25.45 1.62.23.17.51.26.78.26.31 0 .61-.11.86-.32l.81-.7.81.7c.25.21.55.32.86.32.27 0 .55-.09.78-.26.5-.37.68-1.04.45-1.62l-.39-1.24.87-.52c.51-.31.74-.92.56-1.48M18 7c-.55 0-1-.45-1-1s.45-1 1-1 1 .45 1 1-.45 1-1 1m-4.51 3.51c-.43-.43-.94-.73-1.49-.93V8h-1v1.38c-.11-.01-.23-.03-.34-.03-1.02 0-2.05.39-2.83 1.17-.16.16-.3.34-.43.53L6 10.52c-1.56-.55-3.28.27-3.83 1.82-.27.75-.23 1.57.12 2.29.23.48.58.87 1 1.16-.38 1.35-.06 2.85 1 3.91s2.57 1.38 3.91 1c.29.42.68.77 1.16 1q.63.3 1.29.3c.34 0 .68-.06 1.01-.17 1.56-.55 2.38-2.27 1.82-3.85l-.52-1.37c.18-.13.36-.27.53-.43.87-.87 1.24-2.04 1.14-3.17H16v-1h-1.59c-.19-.55-.49-1.06-.92-1.5m-8.82 3.78c-.25-.09-.45-.27-.57-.51s-.13-.51-.04-.76c.19-.52.76-.79 1.26-.61l3.16 1.19c-1.15.6-2.63 1.11-3.81.69m6.32 5.65c-.25.09-.52.08-.76-.04-.24-.11-.42-.32-.51-.57-.42-1.18.09-2.65.7-3.8l1.18 3.13c.18.52-.09 1.1-.61 1.28m1.21-5.34-.61-1.61c0-.01-.01-.02-.02-.03l-.06-.12c-.02-.04-.04-.07-.07-.11l-.09-.09-.09-.09c-.03-.03-.07-.05-.11-.07s-.07-.05-.12-.06c-.01 0-.02-.01-.03-.02l-1.6-.6c.36-.29.79-.46 1.26-.46.53 0 1.04.21 1.41.59.73.73.77 1.88.13 2.67"
}), 'EmojiNatureSharp');
export const EmojiNatureTwoToneIcon = svg([svg("circle", {
  cx: "18",
  cy: "6",
  r: "1",
  opacity: ".3"
...
export const EmojiObjectsIcon = svg(svg("path", {
...
export const EmojiObjectsOutlinedIcon = svg([svg("path", {
...
export const EmojiObjectsRoundedIcon = svg(svg("path", {
...
export const EmojiObjectsSharpIcon = svg(svg("path", {
...
export const EmojiObjectsTwoToneIcon = svg([svg("path", {
...
export const EmojiPeopleIcon = svg([svg("circle", {
  cx: "12",
  cy: "4",
  r: "2"
}, "0"), svg("path", {
...
export const EmojiPeopleOutlinedIcon = svg([svg("circle", {
  cx: "12",
  cy: "4",
  r: "2"
}, "0"), svg("path", {
...
export const EmojiPeopleRoundedIcon = svg([svg("circle", {
  cx: "12",
  cy: "4",
  r: "2"
}, "0"), svg("path", {
...
export const EmojiPeopleSharpIcon = svg([svg("circle", {
  cx: "12",
  cy: "4",
  r: "2"
}, "0"), svg("path", {
...
export const EmojiPeopleTwoToneIcon = svg([svg("circle", {
  cx: "12",
  cy: "4",
  r: "2"
}, "0"), svg("path", {
...
export const EmojiSymbolsIcon = svg([svg("path", {
...
export const EmojiSymbolsOutlinedIcon = svg([svg("path", {
  d: "M3 2h8v2H3zm3 9h2V7h3V5H3v2h3zm6.4036 9.1819 7.7782-7.7782 1.4142 1.4142-7.7782 7.7782z"
}, "0"), svg("circle", {
  cx: "14.5",
  cy: "14.5",
...
export const EmojiSymbolsRoundedIcon = svg([svg("path", {
...
export const EmojiSymbolsSharpIcon = svg([svg("path", {
  d: "M3 2h8v2H3zm3 9h2V7h3V5H3v2h3zm6.4036 9.1819 7.7782-7.7782 1.4142 1.4142-7.7782 7.7782z"
}, "0"), svg("circle", {
  cx: "14.5",
  cy: "14.5",
...
export const EmojiSymbolsTwoToneIcon = svg([svg("path", {
  d: "M3 2h8v2H3zm3 9h2V7h3V5H3v2h3zm6.4036 9.1819 7.7782-7.7782 1.4142 1.4142-7.7782 7.7782z"
}, "0"), svg("circle", {
  cx: "14.5",
  cy: "14.5",
...
export const EmojiTransportationIcon = svg([svg("path", {
...
export const EmojiTransportationOutlinedIcon = svg([svg("path", {
  d: "M20.57 10.66c-.14-.4-.52-.66-.97-.66h-7.19c-.46 0-.83.26-.98.66L10 14.77l.01 5.51c0 .38.31.72.69.72h.62c.38 0 .68-.38.68-.76V19h8v1.24c0 .38.31.76.69.76h.61c.38 0 .69-.34.69-.72l.01-1.37v-4.14zm-8.16.34h7.19l1.03 3h-9.25zM12 17c-.55 0-1-.45-1-1s.45-1 1-1 1 .45 1 1-.45 1-1 1m8 0c-.55 0-1-.45-1-1s.45-1 1-1 1 .45 1 1-.45 1-1 1"
}, "0"), svg("path", {
  d: "M14 9h1V3H7v5H2v13h1V9h5V4h6z"
}, "1"), svg("path", {
...
export const EmojiTransportationRoundedIcon = svg([svg("path", {
...
export const EmojiTransportationSharpIcon = svg([svg("path", {
  d: "M20.57 10.66c-.14-.4-.52-.66-.97-.66h-7.19c-.46 0-.83.26-.98.66L10 14.77l.01 5.51c0 .38.31.72.69.72h.62c.38 0 .68-.38.68-.76V19h8v1.24c0 .38.31.76.69.76h.61c.38 0 .69-.34.69-.72l.01-1.37v-4.14zm-8.16.34h7.19l1.03 3h-9.25zM12 17c-.55 0-1-.45-1-1s.45-1 1-1 1 .45 1 1-.45 1-1 1m8 0c-.55 0-1-.45-1-1s.45-1 1-1 1 .45 1 1-.45 1-1 1"
}, "0"), svg("path", {
  d: "M14 9h1V3H7v5H2v13h1V9h5V4h6z"
}, "1"), svg("path", {
...
export const EmojiTransportationTwoToneIcon = svg([svg("path", {
  d: "M20.57 10.66c-.14-.4-.52-.66-.97-.66h-7.19c-.46 0-.83.26-.98.66L10 14.77l.01 5.51c0 .38.31.72.69.72h.62c.38 0 .68-.38.68-.76V19h8v1.24c0 .38.31.76.69.76h.61c.38 0 .69-.34.69-.72l.01-1.37v-4.14zm-8.16.34h7.19l1.03 3h-9.25zM12 17c-.55 0-1-.45-1-1s.45-1 1-1 1 .45 1 1-.45 1-1 1m8 0c-.55 0-1-.45-1-1s.45-1 1-1 1 .45 1 1-.45 1-1 1"
}, "0"), svg("path", {
  d: "M14 9h1V3H7v5H2v13h1V9h5V4h6z"
}, "1"), svg("path", {
...
export const EnergySavingsLeafIcon = svg(svg("path", {
...
export const EnergySavingsLeafOutlinedIcon = svg([svg("path", {
...
export const EnergySavingsLeafRoundedIcon = svg(svg("path", {
...
export const EnergySavingsLeafSharpIcon = svg(svg("path", {
...
export const EnergySavingsLeafTwoToneIcon = svg([svg("path", {
...
export const EngineeringIcon = svg(svg("path", {
...
export const EngineeringOutlinedIcon = svg(svg("path", {
...
export const EngineeringRoundedIcon = svg(svg("path", {
...
export const EngineeringSharpIcon = svg(svg("path", {
...
export const EngineeringTwoToneIcon = svg([svg("path", {
...
export const EnhancedEncryptionIcon = svg(svg("path", {
...
export const EnhancedEncryptionOutlinedIcon = svg(svg("path", {
...
export const EnhancedEncryptionRoundedIcon = svg(svg("path", {
...
export const EnhancedEncryptionSharpIcon = svg(svg("path", {
...
export const EnhancedEncryptionTwoToneIcon = svg([svg("path", {
...
export const EqualizerIcon = svg(svg("path", {
  d: "M10 20h4V4h-4zm-6 0h4v-8H4zM16 9v11h4V9z"
}), 'Equalizer');
export const EqualizerOutlinedIcon = svg(svg("path", {
  d: "M10 20h4V4h-4zm-6 0h4v-8H4zM16 9v11h4V9z"
}), 'EqualizerOutlined');
export const EqualizerRoundedIcon = svg(svg("path", {
...
export const EqualizerSharpIcon = svg(svg("path", {
  d: "M10 20h4V4h-4zm-6 0h4v-8H4zM16 9v11h4V9z"
}), 'EqualizerSharp');
export const EqualizerTwoToneIcon = svg(svg("path", {
  d: "M16 9h4v11h-4zm-6-5h4v16h-4zm-6 8h4v8H4z"
}), 'EqualizerTwoTone');
export const ErrorIcon = svg(svg("path", {
  d: "M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2m1 15h-2v-2h2zm0-4h-2V7h2z"
}), 'Error');
export const ErrorOutlineIcon = svg(svg("path", {
  d: "M11 15h2v2h-2zm0-8h2v6h-2zm.99-5C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2M12 20c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8"
}), 'ErrorOutline');
export const ErrorOutlineOutlinedIcon = svg(svg("path", {
  d: "M11 15h2v2h-2zm0-8h2v6h-2zm.99-5C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2M12 20c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8"
}), 'ErrorOutlineOutlined');
export const ErrorOutlineRoundedIcon = svg(svg("path", {
...
export const ErrorOutlineSharpIcon = svg(svg("path", {
  d: "M11 15h2v2h-2zm0-8h2v6h-2zm.99-5C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2M12 20c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8"
}), 'ErrorOutlineSharp');
export const ErrorOutlineTwoToneIcon = svg(svg("path", {
...
export const ErrorOutlinedIcon = svg(svg("path", {
  d: "M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2m1 15h-2v-2h2zm0-4h-2V7h2z"
}), 'ErrorOutlined');
export const ErrorRoundedIcon = svg(svg("path", {
...
export const ErrorSharpIcon = svg(svg("path", {
  d: "M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2m1 15h-2v-2h2zm0-4h-2V7h2z"
}), 'ErrorSharp');
export const ErrorTwoToneIcon = svg([svg("path", {
  d: "M12 4c-4.42 0-8 3.58-8 8s3.58 8 8 8 8-3.58 8-8-3.58-8-8-8m1 13h-2v-2h2zm0-4h-2V7h2z",
  opacity: ".3"
}, "0"), svg("path", {
  d: "M11.99 2C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2M12 20c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8m-1-5h2v2h-2zm0-8h2v6h-2z"
}, "1")], 'ErrorTwoTone');
export const EscalatorIcon = svg(svg("path", {
...
export const EscalatorOutlinedIcon = svg(svg("path", {
...
export const EscalatorRoundedIcon = svg(svg("path", {
...
export const EscalatorWarningOutlinedIcon = svg(svg("path", {
  d: "M6.5 2c1.1 0 2 .9 2 2s-.9 2-2 2-2-.9-2-2 .9-2 2-2m9 7.5c0 .83.67 1.5 1.5 1.5s1.5-.67 1.5-1.5S17.83 8 17 8s-1.5.67-1.5 1.5m3 2.5h-2.84c-.58.01-1.14.32-1.45.86l-.92 1.32L9.72 8c-.37-.63-1.03-.99-1.71-1H5c-1.1 0-2 .9-2 2v6h1.5v7h5V11.61L12.03 16h2.2l.77-1.1V22h4v-5h1v-3.5c0-.82-.67-1.5-1.5-1.5"
}), 'EscalatorWarningOutlined');
export const EscalatorWarningRoundedIcon = svg(svg("path", {
...
export const EscalatorWarningSharpIcon = svg(svg("path", {
...
export const EscalatorWarningTwoToneIcon = svg(svg("path", {
  d: "M6.5 2c1.1 0 2 .9 2 2s-.9 2-2 2-2-.9-2-2 .9-2 2-2m9 7.5c0 .83.67 1.5 1.5 1.5s1.5-.67 1.5-1.5S17.83 8 17 8s-1.5.67-1.5 1.5m3 2.5h-2.84c-.58.01-1.14.32-1.45.86l-.92 1.32L9.72 8c-.37-.63-1.03-.99-1.71-1H5c-1.1 0-2 .9-2 2v6h1.5v7h5V11.61L12.03 16h2.2l.77-1.1V22h4v-5h1v-3.5c0-.82-.67-1.5-1.5-1.5"
}), 'EscalatorWarningTwoTone');
export const EuroIcon = svg(svg("path", {
...
export const EuroOutlinedIcon = svg(svg("path", {
  d: "M15 18.5c-2.51 0-4.68-1.42-5.76-3.5H15l1-2H8.58c-.05-.33-.08-.66-.08-1s.03-.67.08-1H15l1-2H9.24C10.32 6.92 12.5 5.5 15 5.5c1.61 0 3.09.59 4.23 1.57L21 5.3C19.41 3.87 17.3 3 15 3c-3.92 0-7.24 2.51-8.48 6H3l-1 2h4.06c-.04.33-.06.66-.06 1s.02.67.06 1H3l-1 2h4.52c1.24 3.49 4.56 6 8.48 6 2.31 0 4.41-.87 6-2.3l-1.78-1.77c-1.13.98-2.6 1.57-4.22 1.57"
}), 'EuroOutlined');
export const EuroRoundedIcon = svg(svg("path", {
...
export const EuroSharpIcon = svg(svg("path", {
  d: "M15 18.5c-2.51 0-4.68-1.42-5.76-3.5H15l1-2H8.58c-.05-.33-.08-.66-.08-1s.03-.67.08-1H15l1-2H9.24C10.32 6.92 12.5 5.5 15 5.5c1.61 0 3.09.59 4.23 1.57L21 5.3C19.41 3.87 17.3 3 15 3c-3.92 0-7.24 2.51-8.48 6H3l-1 2h4.06c-.04.33-.06.66-.06 1s.02.67.06 1H3l-1 2h4.52c1.24 3.49 4.56 6 8.48 6 2.31 0 4.41-.87 6-2.3l-1.78-1.77c-1.13.98-2.6 1.57-4.22 1.57"
}), 'EuroSharp');
export const EuroSymbolIcon = svg(svg("path", {
...
export const EuroSymbolOutlinedIcon = svg(svg("path", {
  d: "M15 18.5c-2.51 0-4.68-1.42-5.76-3.5H15v-2H8.58c-.05-.33-.08-.66-.08-1s.03-.67.08-1H15V9H9.24C10.32 6.92 12.5 5.5 15 5.5c1.61 0 3.09.59 4.23 1.57L21 5.3C19.41 3.87 17.3 3 15 3c-3.92 0-7.24 2.51-8.48 6H3v2h3.06c-.04.33-.06.66-.06 1s.02.67.06 1H3v2h3.52c1.24 3.49 4.56 6 8.48 6 2.31 0 4.41-.87 6-2.3l-1.78-1.77c-1.13.98-2.6 1.57-4.22 1.57"
}), 'EuroSymbolOutlined');
export const EuroSymbolRoundedIcon = svg(svg("path", {
...
export const EuroSymbolSharpIcon = svg(svg("path", {
  d: "M15 18.5c-2.51 0-4.68-1.42-5.76-3.5H15v-2H8.58c-.05-.33-.08-.66-.08-1s.03-.67.08-1H15V9H9.24C10.32 6.92 12.5 5.5 15 5.5c1.61 0 3.09.59 4.23 1.57L21 5.3C19.41 3.87 17.3 3 15 3c-3.92 0-7.24 2.51-8.48 6H3v2h3.06c-.04.33-.06.66-.06 1s.02.67.06 1H3v2h3.52c1.24 3.49 4.56 6 8.48 6 2.31 0 4.41-.87 6-2.3l-1.78-1.77c-1.13.98-2.6 1.57-4.22 1.57"
}), 'EuroSymbolSharp');
export const EuroSymbolTwoToneIcon = svg(svg("path", {
  d: "M15 18.5c-2.51 0-4.68-1.42-5.76-3.5H15v-2H8.58c-.05-.33-.08-.66-.08-1s.03-.67.08-1H15V9H9.24C10.32 6.92 12.5 5.5 15 5.5c1.61 0 3.09.59 4.23 1.57L21 5.3C19.41 3.87 17.3 3 15 3c-3.92 0-7.24 2.51-8.48 6H3v2h3.06c-.04.33-.06.66-.06 1s.02.67.06 1H3v2h3.52c1.24 3.49 4.56 6 8.48 6 2.31 0 4.41-.87 6-2.3l-1.78-1.77c-1.13.98-2.6 1.57-4.22 1.57"
}), 'EuroSymbolTwoTone');
export const EuroTwoToneIcon = svg(svg("path", {
  d: "M15 18.5c-2.51 0-4.68-1.42-5.76-3.5H15l1-2H8.58c-.05-.33-.08-.66-.08-1s.03-.67.08-1H15l1-2H9.24C10.32 6.92 12.5 5.5 15 5.5c1.61 0 3.09.59 4.23 1.57L21 5.3C19.41 3.87 17.3 3 15 3c-3.92 0-7.24 2.51-8.48 6H3l-1 2h4.06c-.04.33-.06.66-.06 1s.02.67.06 1H3l-1 2h4.52c1.24 3.49 4.56 6 8.48 6 2.31 0 4.41-.87 6-2.3l-1.78-1.77c-1.13.98-2.6 1.57-4.22 1.57"
}), 'EuroTwoTone');
export const EvStationIcon = svg(svg("path", {
...
export const EvStationOutlinedIcon = svg(svg("path", {
  d: "m19.77 7.23.01-.01-3.72-3.72L15 4.56l2.11 2.11c-.94.36-1.61 1.26-1.61 2.33 0 1.38 1.12 2.5 2.5 2.5.36 0 .69-.08 1-.21v7.21c0 .55-.45 1-1 1s-1-.45-1-1V14c0-1.1-.9-2-2-2h-1V5c0-1.1-.9-2-2-2H6c-1.1 0-2 .9-2 2v16h10v-7.5h1.5v5c0 1.38 1.12 2.5 2.5 2.5s2.5-1.12 2.5-2.5V9c0-.69-.28-1.32-.73-1.77M12 11v8H6V5h6zm6-1c-.55 0-1-.45-1-1s.45-1 1-1 1 .45 1 1-.45 1-1 1m-8-4-4 7.5h2V18l4-7h-2z"
}), 'EvStationOutlined');
export const EvStationRoundedIcon = svg(svg("path", {
...
export const EvStationSharpIcon = svg(svg("path", {
...
export const EvStationTwoToneIcon = svg([svg("path", {
...
export const EventIcon = svg(svg("path", {
...
export const EventAvailableIcon = svg(svg("path", {
...
export const EventAvailableOutlinedIcon = svg(svg("path", {
...
export const EventAvailableRoundedIcon = svg(svg("path", {
...
export const EventBusyIcon = svg(svg("path", {
...
export const EventBusyOutlinedIcon = svg(svg("path", {
...
export const EventBusyRoundedIcon = svg(svg("path", {
...
export const EventBusySharpIcon = svg(svg("path", {
...
export const EventBusyTwoToneIcon = svg([svg("path", {
  d: "M5 5h14v2H5z",
  opacity: ".3"
}, "0"), svg("path", {
...
export const EventNoteIcon = svg(svg("path", {
...
export const EventNoteOutlinedIcon = svg(svg("path", {
...
export const EventNoteRoundedIcon = svg(svg("path", {
...
export const EventNoteSharpIcon = svg(svg("path", {
  d: "M17 10H7v2h10zm4-7h-3V1h-2v2H8V1H6v2H3v18h18zm-2 16H5V8h14zm-5-5H7v2h7z"
}), 'EventNoteSharp');
export const EventNoteTwoToneIcon = svg([svg("path", {
  d: "M5 5h14v2H5z",
  opacity: ".3"
}, "0"), svg("path", {
...
export const EventOutlinedIcon = svg(svg("path", {
...
export const EventRepeatIcon = svg(svg("path", {
...
export const EventRepeatOutlinedIcon = svg(svg("path", {
...
export const EventRepeatRoundedIcon = svg(svg("path", {
...
export const EventRepeatSharpIcon = svg(svg("path", {
...
export const EventRepeatTwoToneIcon = svg([svg("path", {
  d: "M5 6h14v2H5z",
  opacity: ".3"
}, "0"), svg("path", {
  d: "M21 12V6c0-1.1-.9-2-2-2h-1V2h-2v2H8V2H6v2H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h7v-2H5V10h14v2zm-2-4H5V6h14zm-3.36 12c.43 1.45 1.77 2.5 3.36 2.5 1.93 0 3.5-1.57 3.5-3.5s-1.57-3.5-3.5-3.5c-.95 0-1.82.38-2.45 1H18V18h-4v-4h1.5v1.43c.9-.88 2.14-1.43 3.5-1.43 2.76 0 5 2.24 5 5s-2.24 5-5 5c-2.42 0-4.44-1.72-4.9-4z"
}, "1")], 'EventRepeatTwoTone');
export const EventRoundedIcon = svg(svg("path", {
...
export const ExitToAppOutlinedIcon = svg(svg("path", {
  d: "M10.09 15.59 11.5 17l5-5-5-5-1.41 1.41L12.67 11H3v2h9.67zM19 3H5c-1.11 0-2 .9-2 2v4h2V5h14v14H5v-4H3v4c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2"
}), 'ExitToAppOutlined');
export const ExitToAppRoundedIcon = svg(svg("path", {
...
export const ExpandCircleDownRoundedIcon = svg(svg("path", {
...
export const ExpandCircleDownSharpIcon = svg(svg("path", {
  d: "M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2m0 13.5L7.5 11l1.42-1.41L12 12.67l3.08-3.08L16.5 11z"
}), 'ExpandCircleDownSharp');
export const ExpandCircleDownTwoToneIcon = svg([svg("path", {
...
export const ExpandLessIcon = svg(svg("path", {
  d: "m12 8-6 6 1.41 1.41L12 10.83l4.59 4.58L18 14z"
}), 'ExpandLess');
export const ExpandLessOutlinedIcon = svg(svg("path", {
  d: "m12 8-6 6 1.41 1.41L12 10.83l4.59 4.58L18 14z"
}), 'ExpandLessOutlined');
export const ExpandLessRoundedIcon = svg(svg("path", {
...
export const ExpandLessSharpIcon = svg(svg("path", {
  d: "m12 8-6 6 1.41 1.41L12 10.83l4.59 4.58L18 14z"
}), 'ExpandLessSharp');
export const ExpandLessTwoToneIcon = svg(svg("path", {
  d: "m12 8-6 6 1.41 1.41L12 10.83l4.59 4.58L18 14z"
}), 'ExpandLessTwoTone');
export const ExpandMoreIcon = svg(svg("path", {
  d: "M16.59 8.59 12 13.17 7.41 8.59 6 10l6 6 6-6z"
}), 'ExpandMore');
export const ExpandMoreOutlinedIcon = svg(svg("path", {
  d: "M16.59 8.59 12 13.17 7.41 8.59 6 10l6 6 6-6z"
}), 'ExpandMoreOutlined');
export const ExpandMoreRoundedIcon = svg(svg("path", {
...
export const ExpandMoreSharpIcon = svg(svg("path", {
  d: "M16.59 8.59 12 13.17 7.41 8.59 6 10l6 6 6-6z"
}), 'ExpandMoreSharp');
export const ExpandMoreTwoToneIcon = svg(svg("path", {
  d: "M16.59 8.59 12 13.17 7.41 8.59 6 10l6 6 6-6z"
}), 'ExpandMoreTwoTone');
export const ExpandOutlinedIcon = svg(svg("path", {
...
export const ExpandRoundedIcon = svg(svg("path", {
...
export const ExplicitSharpIcon = svg(svg("path", {
  d: "M21 3H3v18h18zm-6 6h-4v2h4v2h-4v2h4v2H9V7h6z"
}), 'ExplicitSharp');
export const ExplicitTwoToneIcon = svg([svg("path", {
...
export const ExploreIcon = svg(svg("path", {
...
export const ExploreOffIcon = svg(svg("path", {
...
export const ExploreOffOutlinedIcon = svg(svg("path", {
...
export const ExploreOffRoundedIcon = svg(svg("path", {
...
export const ExploreOffSharpIcon = svg(svg("path", {
...
export const ExploreOffTwoToneIcon = svg([svg("path", {
...
export const ExploreOutlinedIcon = svg(svg("path", {
...
export const ExploreRoundedIcon = svg(svg("path", {
  d: "M12 10.9c-.61 0-1.1.49-1.1 1.1s.49 1.1 1.1 1.1 1.1-.49 1.1-1.1-.49-1.1-1.1-1.1M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2m2.19 12.19L6 18l3.81-8.19L18 6z"
}), 'ExploreRounded');
export const ExploreSharpIcon = svg(svg("path", {
  d: "M12 10.9c-.61 0-1.1.49-1.1 1.1s.49 1.1 1.1 1.1 1.1-.49 1.1-1.1-.49-1.1-1.1-1.1M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2m2.19 12.19L6 18l3.81-8.19L18 6z"
}), 'ExploreSharp');
export const ExploreTwoToneIcon = svg([svg("path", {
  d: "M12 4c-4.41 0-8 3.59-8 8s3.59 8 8 8 8-3.59 8-8-3.59-8-8-8m2.01 10.01L6.5 17.5l3.49-7.51L17.5 6.5z",
  opacity: ".3"
}, "0"), svg("path", {
  d: "M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2m0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8m-5.5-2.5 7.51-3.49L17.5 6.5 9.99 9.99zm5.5-6.6c.61 0 1.1.49 1.1 1.1s-.49 1.1-1.1 1.1-1.1-.49-1.1-1.1.49-1.1 1.1-1.1"
}, "1")], 'ExploreTwoTone');
export const ExposureIcon = svg(svg("path", {
...
export const ExposureOutlinedIcon = svg(svg("path", {
...
export const ExposureRoundedIcon = svg(svg("path", {
...
export const ExtensionOffIcon = svg(svg("path", {
...
export const ExtensionOffOutlinedIcon = svg(svg("path", {
...
export const ExtensionOffRoundedIcon = svg(svg("path", {
...
export const ExtensionOffSharpIcon = svg(svg("path", {
...
export const ExtensionOffTwoToneIcon = svg([svg("path", {
...
export const ExtensionOutlinedIcon = svg(svg("path", {
...
export const ExtensionRoundedIcon = svg(svg("path", {
  d: "M20.5 11H19V7c0-1.1-.9-2-2-2h-4V3.5C13 2.12 11.88 1 10.5 1S8 2.12 8 3.5V5H4c-1.1 0-1.99.9-1.99 2v3.8H3.5c1.49 0 2.7 1.21 2.7 2.7s-1.21 2.7-2.7 2.7H2V20c0 1.1.9 2 2 2h3.8v-1.5c0-1.49 1.21-2.7 2.7-2.7s2.7 1.21 2.7 2.7V22H17c1.1 0 2-.9 2-2v-4h1.5c1.38 0 2.5-1.12 2.5-2.5S21.88 11 20.5 11"
}), 'ExtensionRounded');
export const ExtensionSharpIcon = svg(svg("path", {
...
export const ExtensionTwoToneIcon = svg([svg("path", {
