...
export const YardIcon = (props?: KTRawAttr) => {
  const s = _YardIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _YardIcon = svg(
  [
    svg(
      'path',
      {
    ...
    svg('circle', { cx: '12', cy: '9.62', r: '1.56' }, '1'),
  ],
  'Yard',
);
export const YardOutlinedIcon = (props?: KTRawAttr) => {
  const s = _YardOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _YardOutlinedIcon = svg(
  svg('path', {
...
export const YardRoundedIcon = (props?: KTRawAttr) => {
  const s = _YardRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _YardRoundedIcon = svg(
  [
    svg(
      'path',
      {
...
export const YardSharpIcon = (props?: KTRawAttr) => {
  const s = _YardSharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _YardSharpIcon = svg(
  [
    svg(
      'path',
      {
...
export const YardTwoToneIcon = (props?: KTRawAttr) => {
  const s = _YardTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _YardTwoToneIcon = svg(
  [
    svg(
      'path',
      {
    ...
    svg('path', { d: 'M20 2H4c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2m0 18H4V4h16z' }, '2'),
  ],
  'YardTwoTone',
);
export const YouTubeIcon = (props?: KTRawAttr) => {
  const s = _YouTubeIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _YouTubeIcon = svg(
  svg('path', {
    d: 'M10 15l5.19-3L10 9v6m11.56-7.83c.13.47.22 1.1.28 1.9.07.8.1 1.49.1 2.09L22 12c0 2.19-.16 3.8-.44 4.83-.25.9-.83 1.48-1.73 1.73-.47.13-1.33.22-2.65.28-1.3.07-2.49.1-3.59.1L12 19c-4.19 0-6.8-.16-7.83-.44-.9-.25-1.48-.83-1.73-1.73-.13-.47-.22-1.1-.28-1.9-.07-.8-.1-1.49-.1-2.09L2 12c0-2.19.16-3.8.44-4.83.25-.9.83-1.48 1.73-1.73.47-.13 1.33-.22 2.65-.28 1.3-.07 2.49-.1 3.59-.1L12 5c4.19 0 6.8.16 7.83.44.9.25 1.48.83 1.73 1.73z',
  }),
  'YouTube',
);
export const YoutubeSearchedForIcon = (props?: KTRawAttr) => {
  const s = _YoutubeSearchedForIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _YoutubeSearchedForIcon = svg(
  svg('path', {
...
export const YoutubeSearchedForOutlinedIcon = (props?: KTRawAttr) => {
  const s = _YoutubeSearchedForOutlinedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _YoutubeSearchedForOutlinedIcon = svg(
  svg('path', {
    d: 'M17.01 14h-.8l-.27-.27c.98-1.14 1.57-2.61 1.57-4.23 0-3.59-2.91-6.5-6.5-6.5s-6.5 3-6.5 6.5H2l3.84 4 4.16-4H6.51C6.51 7 8.53 5 11.01 5s4.5 2.01 4.5 4.5c0 2.48-2.02 4.5-4.5 4.5-.65 0-1.26-.14-1.82-.38L7.71 15.1c.97.57 2.09.9 3.3.9 1.61 0 3.08-.59 4.22-1.57l.27.27v.79l5.01 4.99L22 19z',
  }),
  'YoutubeSearchedForOutlined',
);
export const YoutubeSearchedForRoundedIcon = (props?: KTRawAttr) => {
  const s = _YoutubeSearchedForRoundedIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _YoutubeSearchedForRoundedIcon = svg(
  svg('path', {
...
export const YoutubeSearchedForSharpIcon = (props?: KTRawAttr) => {
  const s = _YoutubeSearchedForSharpIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _YoutubeSearchedForSharpIcon = svg(
  svg('path', {
    d: 'M17.01 14h-.8l-.27-.27c.98-1.14 1.57-2.61 1.57-4.23 0-3.59-2.91-6.5-6.5-6.5s-6.5 3-6.5 6.5H2l3.84 4 4.16-4H6.51C6.51 7 8.53 5 11.01 5s4.5 2.01 4.5 4.5c0 2.48-2.02 4.5-4.5 4.5-.65 0-1.26-.14-1.82-.38L7.71 15.1c.97.57 2.09.9 3.3.9 1.61 0 3.08-.59 4.22-1.57l.27.27v.79l5.01 4.99L22 19z',
  }),
  'YoutubeSearchedForSharp',
);
export const YoutubeSearchedForTwoToneIcon = (props?: KTRawAttr) => {
  const s = _YoutubeSearchedForTwoToneIcon.cloneNode() as SVGElement;
  applyAttr(s, props);
  return s;
};
export const _YoutubeSearchedForTwoToneIcon = svg(
  svg('path', {
    d: 'M17.01 14h-.8l-.27-.27c.98-1.14 1.57-2.61 1.57-4.23 0-3.59-2.91-6.5-6.5-6.5s-6.5 3-6.5 6.5H2l3.84 4 4.16-4H6.51C6.51 7 8.53 5 11.01 5s4.5 2.01 4.5 4.5c0 2.48-2.02 4.5-4.5 4.5-.65 0-1.26-.14-1.82-.38L7.71 15.1c.97.57 2.09.9 3.3.9 1.61 0 3.08-.59 4.22-1.57l.27.27v.79l5.01 4.99L22 19z',
  }),
